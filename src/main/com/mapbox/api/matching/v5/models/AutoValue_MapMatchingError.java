...
final class AutoValue_MapMatchingError extends $AutoValue_MapMatchingError {
  AutoValue_MapMatchingError(@Nullable String code, @Nullable String message) {
    super(code, message);
  }
  ...
  public static final class GsonTypeAdapter extends TypeAdapter<MapMatchingError> {
    ...
    public void write(JsonWriter jsonWriter, MapMatchingError object) throws IOException {
      if (object == null) {
    ...
    public MapMatchingError read(JsonReader jsonReader) throws IOException {
      ...
      return new AutoValue_MapMatchingError(code, message);
    }
  }
}
