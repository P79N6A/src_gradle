...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    public final <E extends MaybeObserver<? super T>> E subscribeWith(E e2) {
        subscribe((MaybeObserver<? super T>) e2);
        return e2;
    }
    ...
    public static <T> Flowable<T> merge(Iterable<? extends MaybeSource<? extends T>> iterable) {
        return merge((b<? extends MaybeSource<? extends T>>) Flowable.fromIterable(iterable));
    }
    ...
    public final <U> Maybe<T> takeUntil(b<U> bVar) {
        ...
        return RxJavaPlugins.onAssembly((Maybe<T>) new MaybeTakeUntilPublisher<T>(this, bVar));
    }
    ...
    public final <U, V> Maybe<T> delay(b<U> bVar) {
        ...
        return RxJavaPlugins.onAssembly((Maybe<T>) new MaybeDelayOtherPublisher<T>(this, bVar));
    }
    ...
    public final <U> Maybe<T> delaySubscription(b<U> bVar) {
        ...
        return RxJavaPlugins.onAssembly((Maybe<T>) new MaybeDelaySubscriptionOtherPublisher<T>(this, bVar));
    }
    ...
    public final Maybe<T> doOnComplete(Action action) {
        ...
        MaybePeek maybePeek = new MaybePeek(this, Functions.emptyConsumer(), Functions.emptyConsumer(), Functions.emptyConsumer(), (Action) ObjectHelper.requireNonNull(action, "onComplete is null"), action2, action2);
        return RxJavaPlugins.onAssembly((Maybe<T>) maybePeek);
    }
    ...
    public final Maybe<T> doOnError(Consumer<? super Throwable> consumer) {
        ...
        MaybePeek maybePeek = new MaybePeek(this, Functions.emptyConsumer(), Functions.emptyConsumer(), (Consumer) ObjectHelper.requireNonNull(consumer, "onError is null"), action, action, Functions.EMPTY_ACTION);
        return RxJavaPlugins.onAssembly((Maybe<T>) maybePeek);
    }
    ...
    public final Maybe<T> doOnSubscribe(Consumer<? super Disposable> consumer) {
        ...
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        MaybePeek maybePeek = new MaybePeek(this, (Consumer) ObjectHelper.requireNonNull(consumer, "onSubscribe is null"), emptyConsumer, emptyConsumer2, action, action, Functions.EMPTY_ACTION);
        return RxJavaPlugins.onAssembly((Maybe<T>) maybePeek);
    }
    ...
    public final Maybe<T> doOnSuccess(Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
        MaybePeek maybePeek = new MaybePeek(this, Functions.emptyConsumer(), (Consumer) ObjectHelper.requireNonNull(consumer, "onSubscribe is null"), emptyConsumer, action, action, Functions.EMPTY_ACTION);
        return RxJavaPlugins.onAssembly((Maybe<T>) maybePeek);
    }
    ...
    public final <U> Maybe<T> timeout(b<U> bVar) {
        ...
        return RxJavaPlugins.onAssembly((Maybe<T>) new MaybeTimeoutPublisher<T>(this, bVar, null));
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> concat(b<? extends MaybeSource<? extends T>> bVar, int i) {
        ObjectHelper.requireNonNull(bVar, "sources is null");
        ObjectHelper.verifyPositive(i, "prefetch");
        return RxJavaPlugins.onAssembly((Flowable<T>) new FlowableConcatMapPublisher<T>(bVar, MaybeToPublisher.instance(), i, ErrorMode.IMMEDIATE));
    }

    @CheckReturnValue
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> merge(b<? extends MaybeSource<? extends T>> bVar, int i) {
        ObjectHelper.requireNonNull(bVar, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        FlowableFlatMapPublisher flowableFlatMapPublisher = new FlowableFlatMapPublisher(bVar, MaybeToPublisher.instance(), false, i, 1);
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport("none")
    public static <T> Flowable<T> mergeDelayError(b<? extends MaybeSource<? extends T>> bVar, int i) {
        ObjectHelper.requireNonNull(bVar, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        FlowableFlatMapPublisher flowableFlatMapPublisher = new FlowableFlatMapPublisher(bVar, MaybeToPublisher.instance(), true, i, 1);
        return RxJavaPlugins.onAssembly((Flowable<T>) flowableFlatMapPublisher);
    }
    ...
    public final <U> Maybe<T> timeout(b<U> bVar, MaybeSource<? extends T> maybeSource) {
        ...
        return RxJavaPlugins.onAssembly((Maybe<T>) new MaybeTimeoutPublisher<T>(this, bVar, maybeSource));
    }
