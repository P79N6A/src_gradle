...
public final class Flowables {
    ...
    public final <T1, T2, R> Flowable<R> combineLatest(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Function2<? super T1, ? super T2, ? extends R> function2) {
        ...
        Flowable<R> combineLatest = Flowable.combineLatest((b<? extends T1>) flowable, (b<? extends T2>) flowable2, (BiFunction<? super T1, ? super T2, ? extends R>) new Flowables$combineLatest$1<Object,Object,Object>(function2));
    ...
    public final <T1, T2, T3, R> Flowable<R> zip(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        ...
        Intrinsics.checkParameterIsNotNull(flowable3, "source3");
        Intrinsics.checkParameterIsNotNull(function3, "combineFunction");
        Flowable<R> zip = Flowable.zip((b<? extends T1>) flowable, (b<? extends T2>) flowable2, (b<? extends T3>) flowable3, (io.reactivex.functions.Function3<? super T1, ? super T2, ? super T3, ? extends R>) new Flowables$zip$3<Object,Object,Object,Object>(function3));
        if (zip == null) {
            Intrinsics.throwNpe();
        }
        return zip;
    ...
    public final <T1, T2> Flowable<Pair<T1, T2>> combineLatest(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2) {
        Intrinsics.checkParameterIsNotNull(flowable, "source1");
        Intrinsics.checkParameterIsNotNull(flowable2, "source2");
        Flowable<Pair<T1, T2>> combineLatest = Flowable.combineLatest((b<? extends T1>) flowable, (b<? extends T2>) flowable2, (BiFunction<? super T1, ? super T2, ? extends R>) Flowables$combineLatest$2.INSTANCE);
        if (combineLatest == null) {
            Intrinsics.throwNpe();
        }
        return combineLatest;
    ...
    public final <T1, T2, T3> Flowable<Triple<T1, T2, T3>> zip(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3) {
        ...
        Intrinsics.checkParameterIsNotNull(flowable2, "source2");
        Intrinsics.checkParameterIsNotNull(flowable3, "source3");
        Flowable<Triple<T1, T2, T3>> zip = Flowable.zip((b<? extends T1>) flowable, (b<? extends T2>) flowable2, (b<? extends T3>) flowable3, (io.reactivex.functions.Function3<? super T1, ? super T2, ? super T3, ? extends R>) Flowables$zip$4.INSTANCE);
        if (zip == null) {
            Intrinsics.throwNpe();
        }
        return zip;
    ...
    public final <T1, T2, T3, T4, R> Flowable<R> zip(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> function4) {
        ...
        Intrinsics.checkParameterIsNotNull(flowable4, "source4");
        Intrinsics.checkParameterIsNotNull(function4, "combineFunction");
        Flowable<R> zip = Flowable.zip((b<? extends T1>) flowable, (b<? extends T2>) flowable2, (b<? extends T3>) flowable3, (b<? extends T4>) flowable4, (io.reactivex.functions.Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R>) new Flowables$zip$5<Object,Object,Object,Object,Object>(function4));
        if (zip == null) {
            Intrinsics.throwNpe();
        }
        return zip;
    ...
    @NotNull
    @SchedulerSupport("none")
    public final <T1, T2, T3, T4, T5, R> Flowable<R> combineLatest(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Flowable<T5> flowable5, @NotNull n<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> nVar) {
        Intrinsics.checkParameterIsNotNull(flowable, "source1");
        Intrinsics.checkParameterIsNotNull(flowable2, "source2");
        Intrinsics.checkParameterIsNotNull(flowable3, "source3");
        Intrinsics.checkParameterIsNotNull(flowable4, "source4");
        ...
        Flowable<R> combineLatest = Flowable.combineLatest(flowable, flowable2, flowable3, flowable4, flowable5, new Flowables$combineLatest$6(nVar));
        if (combineLatest == null) {
            Intrinsics.throwNpe();
        }
        return combineLatest;
    ...
    @NotNull
    @SchedulerSupport("none")
    public final <T1, T2, T3, T4, T5, R> Flowable<R> zip(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Flowable<T5> flowable5, @NotNull n<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> nVar) {
        Intrinsics.checkParameterIsNotNull(flowable, "source1");
        Intrinsics.checkParameterIsNotNull(flowable2, "source2");
        Intrinsics.checkParameterIsNotNull(flowable3, "source3");
        Intrinsics.checkParameterIsNotNull(flowable4, "source4");
        Intrinsics.checkParameterIsNotNull(flowable5, "source5");
        Intrinsics.checkParameterIsNotNull(nVar, "combineFunction");
        Flowable<R> zip = Flowable.zip(flowable, flowable2, flowable3, flowable4, flowable5, new Flowables$zip$6(nVar));
        if (zip == null) {
            Intrinsics.throwNpe();
        }
        return zip;
    ...
    public final <T1, T2, T3, T4, T5, T6, T7, T8, R> Flowable<R> combineLatest(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Flowable<T5> flowable5, @NotNull Flowable<T6> flowable6, @NotNull Flowable<T7> flowable7, @NotNull Flowable<T8> flowable8, @NotNull o<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> oVar) {
        ...
        Flowable<R> combineLatest = Flowable.combineLatest(flowable, flowable2, flowable3, flowable4, flowable5, flowable6, flowable7, flowable8, new Flowables$combineLatest$9(oVar));
        if (combineLatest == null) {
            Intrinsics.throwNpe();
        }
        return combineLatest;
    ...
    public final <T1, T2, T3, T4, T5, T6, T7, T8, R> Flowable<R> zip(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Flowable<T5> flowable5, @NotNull Flowable<T6> flowable6, @NotNull Flowable<T7> flowable7, @NotNull Flowable<T8> flowable8, @NotNull o<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> oVar) {
        ...
        Intrinsics.checkParameterIsNotNull(flowable8, "source8");
        Intrinsics.checkParameterIsNotNull(oVar, "combineFunction");
        Flowable<R> zip = Flowable.zip(flowable, flowable2, flowable3, flowable4, flowable5, flowable6, flowable7, flowable8, new Flowables$zip$9(oVar));
        if (zip == null) {
            Intrinsics.throwNpe();
        }
        return zip;
    ...
    public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Flowable<R> combineLatest(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Flowable<T5> flowable5, @NotNull Flowable<T6> flowable6, @NotNull Flowable<T7> flowable7, @NotNull Flowable<T8> flowable8, @NotNull Flowable<T9> flowable9, @NotNull p<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> pVar) {
        ...
        Flowable<R> combineLatest = Flowable.combineLatest(flowable, flowable2, flowable3, flowable4, flowable5, flowable6, flowable7, flowable8, flowable9, new Flowables$combineLatest$10(pVar));
        if (combineLatest == null) {
            Intrinsics.throwNpe();
        }
        return combineLatest;
    ...
    public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Flowable<R> zip(@NotNull Flowable<T1> flowable, @NotNull Flowable<T2> flowable2, @NotNull Flowable<T3> flowable3, @NotNull Flowable<T4> flowable4, @NotNull Flowable<T5> flowable5, @NotNull Flowable<T6> flowable6, @NotNull Flowable<T7> flowable7, @NotNull Flowable<T8> flowable8, @NotNull Flowable<T9> flowable9, @NotNull p<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> pVar) {
        ...
        Intrinsics.checkParameterIsNotNull(flowable9, "source9");
        Intrinsics.checkParameterIsNotNull(pVar, "combineFunction");
        Flowable<R> zip = Flowable.zip(flowable, flowable2, flowable3, flowable4, flowable5, flowable6, flowable7, flowable8, flowable9, new Flowables$zip$10(pVar));
        if (zip == null) {
            Intrinsics.throwNpe();
        }
        return zip;
