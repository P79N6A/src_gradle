...
public final class Singles {
    ...
    @NotNull
    @SchedulerSupport("none")
    public final <T1, T2, T3, T4, T5, R> Single<R> zip(@NotNull SingleSource<T1> singleSource, @NotNull SingleSource<T2> singleSource2, @NotNull SingleSource<T3> singleSource3, @NotNull SingleSource<T4> singleSource4, @NotNull SingleSource<T5> singleSource5, @NotNull n<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> nVar) {
        Intrinsics.checkParameterIsNotNull(singleSource, "s1");
        Intrinsics.checkParameterIsNotNull(singleSource2, "s2");
        Intrinsics.checkParameterIsNotNull(singleSource3, "s3");
        Intrinsics.checkParameterIsNotNull(singleSource4, "s4");
        ...
        Single<R> zip = Single.zip(singleSource, singleSource2, singleSource3, singleSource4, singleSource5, new Singles$zip$6(nVar));
    ...
    public final <T1, T2, T3, T4, T5, T6, T7, R> Single<R> zip(@NotNull SingleSource<T1> singleSource, @NotNull SingleSource<T2> singleSource2, @NotNull SingleSource<T3> singleSource3, @NotNull SingleSource<T4> singleSource4, @NotNull SingleSource<T5> singleSource5, @NotNull SingleSource<T6> singleSource6, @NotNull SingleSource<T7> singleSource7, @NotNull Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> function7) {
        ...
        Intrinsics.checkParameterIsNotNull(singleSource4, "s4");
        Intrinsics.checkParameterIsNotNull(singleSource5, "s5");
        SingleSource<T6> singleSource8 = singleSource6;
        Intrinsics.checkParameterIsNotNull(singleSource8, "s6");
        SingleSource<T7> singleSource9 = singleSource7;
        Intrinsics.checkParameterIsNotNull(singleSource9, "s7");
        Intrinsics.checkParameterIsNotNull(function72, "zipper");
        Single<R> zip = Single.zip(singleSource, singleSource2, singleSource3, singleSource4, singleSource5, singleSource8, singleSource9, new Singles$zip$8(function72));
    ...
    @NotNull
    @SchedulerSupport("none")
    public final <T1, T2, T3, T4, T5, T6, T7, T8, R> Single<R> zip(@NotNull SingleSource<T1> singleSource, @NotNull SingleSource<T2> singleSource2, @NotNull SingleSource<T3> singleSource3, @NotNull SingleSource<T4> singleSource4, @NotNull SingleSource<T5> singleSource5, @NotNull SingleSource<T6> singleSource6, @NotNull SingleSource<T7> singleSource7, @NotNull SingleSource<T8> singleSource8, @NotNull o<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> oVar) {
        o<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> oVar2 = oVar;
        Intrinsics.checkParameterIsNotNull(singleSource, "s1");
        Intrinsics.checkParameterIsNotNull(singleSource2, "s2");
        Intrinsics.checkParameterIsNotNull(singleSource3, "s3");
        Intrinsics.checkParameterIsNotNull(singleSource4, "s4");
        SingleSource<T5> singleSource9 = singleSource5;
        Intrinsics.checkParameterIsNotNull(singleSource9, "s5");
        SingleSource<T6> singleSource10 = singleSource6;
        Intrinsics.checkParameterIsNotNull(singleSource10, "s6");
        SingleSource<T7> singleSource11 = singleSource7;
        Intrinsics.checkParameterIsNotNull(singleSource11, "s7");
        SingleSource<T8> singleSource12 = singleSource8;
        Intrinsics.checkParameterIsNotNull(singleSource12, "s8");
        Intrinsics.checkParameterIsNotNull(oVar2, "zipper");
        Single<R> zip = Single.zip(singleSource, singleSource2, singleSource3, singleSource4, singleSource9, singleSource10, singleSource11, singleSource12, new Singles$zip$9(oVar2));
    ...
    @NotNull
    @SchedulerSupport("none")
    public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> Single<R> zip(@NotNull SingleSource<T1> singleSource, @NotNull SingleSource<T2> singleSource2, @NotNull SingleSource<T3> singleSource3, @NotNull SingleSource<T4> singleSource4, @NotNull SingleSource<T5> singleSource5, @NotNull SingleSource<T6> singleSource6, @NotNull SingleSource<T7> singleSource7, @NotNull SingleSource<T8> singleSource8, @NotNull SingleSource<T9> singleSource9, @NotNull p<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> pVar) {
        p<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> pVar2 = pVar;
        Intrinsics.checkParameterIsNotNull(singleSource, "s1");
        Intrinsics.checkParameterIsNotNull(singleSource2, "s2");
        Intrinsics.checkParameterIsNotNull(singleSource3, "s3");
        SingleSource<T4> singleSource10 = singleSource4;
        Intrinsics.checkParameterIsNotNull(singleSource10, "s4");
        SingleSource<T5> singleSource11 = singleSource5;
        Intrinsics.checkParameterIsNotNull(singleSource11, "s5");
        SingleSource<T6> singleSource12 = singleSource6;
        Intrinsics.checkParameterIsNotNull(singleSource12, "s6");
        SingleSource<T7> singleSource13 = singleSource7;
        Intrinsics.checkParameterIsNotNull(singleSource13, "s7");
        SingleSource<T8> singleSource14 = singleSource8;
        Intrinsics.checkParameterIsNotNull(singleSource14, "s8");
        SingleSource<T9> singleSource15 = singleSource9;
        Intrinsics.checkParameterIsNotNull(singleSource15, "s9");
        Intrinsics.checkParameterIsNotNull(pVar2, "zipper");
        Single<R> zip = Single.zip(singleSource, singleSource2, singleSource3, singleSource10, singleSource11, singleSource12, singleSource13, singleSource14, singleSource15, new Singles$zip$10(pVar2));
