...
public final class ObservableBufferTimed<T, U extends Collection<? super T>> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class BufferSkipBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Disposable, Runnable {
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            private final U f83377b;

            public final void run() {
                synchronized (BufferSkipBoundedObserver.this) {
                    BufferSkipBoundedObserver.this.buffers.remove(this.f83377b);
                }
                BufferSkipBoundedObserver.this.fastPathOrderedEmit(this.f83377b, false, BufferSkipBoundedObserver.this.w);
            }
