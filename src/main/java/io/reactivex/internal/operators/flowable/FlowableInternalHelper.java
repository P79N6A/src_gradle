...
public final class FlowableInternalHelper {
    ...
    static final class FlatMapIntoIterable<T, U> implements Function<T, b<U>> {
        ...
        public final b<U> apply(T t) throws Exception {
    ...
    static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, b<R>> {
        ...
        public final b<R> apply(T t) throws Exception {
    ...
    static final class ItemDelayFunction<T, U> implements Function<T, b<T>> {
        ...
        public final b<T> apply(T t) throws Exception {
            return new FlowableTakePublisher((b) ObjectHelper.requireNonNull(this.itemDelay.apply(t), "The itemDelay returned a null Publisher"), 1).map(Functions.justFunction(t)).defaultIfEmpty(t);
        }
    }
    ...
    static final class ReplayFunction<T, R> implements Function<Flowable<T>, b<R>> {
        ...
        public final b<R> apply(Flowable<T> flowable) throws Exception {
        ...
        ReplayFunction(Function<? super Flowable<T>, ? extends b<R>> function, Scheduler scheduler2) {
    ...
    static final class ZipIterableFunction<T, R> implements Function<List<b<? extends T>>, b<? extends R>> {
        ...
        public final b<? extends R> apply(List<b<? extends T>> list) {
