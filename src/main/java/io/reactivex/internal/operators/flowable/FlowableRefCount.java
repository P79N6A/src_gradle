...
public final class FlowableRefCount<T> extends Flowable<T> {
    ...
    public final void cancel(io.reactivex.internal.operators.flowable.FlowableRefCount.RefConnection r6) {
        /*
            r5 = this;
            monitor-enter(r5)
    ...
    public final void subscribeActual(c<? super T> cVar) {
        ...
        this.source.subscribe((FlowableSubscriber<? super T>) new RefCountSubscriber<Object>(cVar, this, refConnection));
        if (z) {
