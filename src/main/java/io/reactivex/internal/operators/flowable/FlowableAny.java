...
public final class FlowableAny<T> extends AbstractFlowableWithUpstream<T, Boolean> {
    ...
    static final class AnySubscriber<T> extends DeferredScalarSubscription<Boolean> implements FlowableSubscriber<T> {
        ...
        AnySubscriber(c<? super Boolean> cVar, Predicate<? super T> predicate2) {
            super(cVar);
    ...
    public final void subscribeActual(c<? super Boolean> cVar) {
        this.source.subscribe((FlowableSubscriber<? super T>) new AnySubscriber<Object>(cVar, this.predicate));
    }
