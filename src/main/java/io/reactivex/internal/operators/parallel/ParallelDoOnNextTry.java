        ...
        if (validate(cVarArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    cVarArr2[i] = new ParallelDoOnNextConditionalSubscriber(conditionalSubscriber, this.onNext, this.errorHandler);
                } else {
                    cVarArr2[i] = new ParallelDoOnNextSubscriber(conditionalSubscriber, this.onNext, this.errorHandler);
                }
            }
