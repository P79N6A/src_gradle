        ...
        public void onPageResult(int i, @NonNull PageResult<V> pageResult) {
            ...
            if (pageResult.isInvalid()) {
                ...
                if (ContiguousPagedList.this.mBoundaryCallback != null) {
                    boolean z3 = false;
                    if (ContiguousPagedList.this.mStorage.size() == 0) {
                        z = true;
                    } else {
                        z = false;
                    }
                    if (!z && i == 2 && pageResult.page.size() == 0) {
                        z2 = true;
                    } else {
                        z2 = false;
                    }
                    if (!z && i == 1 && pageResult.page.size() == 0) {
                        z3 = true;
                    }
                    ContiguousPagedList.this.deferBoundaryCallbacks(z, z2, z3);
                }
            }
        }
    };
