...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View findViewById = view.findViewById(C0906R.id.bnx);
    ...
    private float calculateTranslationY(View view, View view2, Positioning positioning) {
        ...
        calculateWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
        int i = positioning.gravity & SearchJediMixFeedAdapter.f42516e;
        if (i == 16) {
    ...
    private void createExpansionAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, float f2, float f3, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view4 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                if (z2) {
                    f4 = circularRevealWidget.getRevealInfo().radius;
                } else {
                    f4 = width;
                }
                ...
                createPreFillRadialExpansion(view2, timing.getDelay(), (int) calculateRevealCenterX, (int) calculateRevealCenterY, f4, list);
                motionTiming = timing;
            } else {
                float f5 = circularRevealWidget.getRevealInfo().radius;
                ...
                View view5 = view2;
                createPreFillRadialExpansion(view5, timing.getDelay(), i, i2, f5, list);
