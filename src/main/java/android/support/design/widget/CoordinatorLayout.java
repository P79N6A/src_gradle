...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public boolean dependsOn(CoordinatorLayout coordinatorLayout, View view, View view2) {
            if (view2 == this.mAnchorDirectChild || shouldDodge(view2, ViewCompat.getLayoutDirection(coordinatorLayout)) || (this.mBehavior != null && this.mBehavior.layoutDependsOn(coordinatorLayout, view, view2))) {
                return true;
            }
            return false;
        }
    ...
    private static int resolveGravity(int i) {
        ...
        return (i & SearchJediMixFeedAdapter.f42516e) == 0 ? i | 48 : i;
    }
    ...
    private int getKeyline(int i) {
        if (this.mKeylines != null && i >= 0 && i < this.mKeylines.length) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (i2 != 0 || view.getVisibility() != 8) {
                ...
                if (layoutParams.insetEdge != 0 && !acquireTempRect2.isEmpty()) {
                    ...
                    int i5 = absoluteGravity & SearchJediMixFeedAdapter.f42516e;
                    if (i5 == 48) {
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        int i4 = absoluteGravity & SearchJediMixFeedAdapter.f42516e;
        int width = getWidth();
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i9 = absoluteGravity2 & SearchJediMixFeedAdapter.f42516e;
        if (i8 == 1) {
