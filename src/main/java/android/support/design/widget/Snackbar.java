...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0906R.attr.a2w};
    ...
    @Deprecated
    @NonNull
    public final Snackbar setCallback(Callback callback2) {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            ...
            if (hasSnackbarButtonStyleAttr(findSuitableParent.getContext())) {
                i2 = C0906R.layout.aag;
            } else {
                i2 = C0906R.layout.i6;
            }
