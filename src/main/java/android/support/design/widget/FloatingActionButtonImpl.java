...
public class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C0906R.animator.f4393a);
        }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C0906R.animator.f4394b);
        }
    ...
    private void calculateImageMatrixFromScale(float f2, Matrix matrix) {
        ...
        if (drawable != null && this.maxImageSize != 0) {
            ...
            matrix.postScale(f2, f2, ((float) this.maxImageSize) / 2.0f, ((float) this.maxImageSize) / 2.0f);
        }
    }
    ...
    public CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(ContextCompat.getColor(context, C0906R.color.jc), ContextCompat.getColor(context, C0906R.color.jb), ContextCompat.getColor(context, C0906R.color.j_), ContextCompat.getColor(context, C0906R.color.ja));
    ...
    public void onElevationsChanged(float f2, float f3, float f4) {
        if (this.shadowDrawable != null) {
            this.shadowDrawable.setShadowSize(f2, this.pressedTranslationZ + f2);
            updatePadding();
        }
    }
    ...
    public void setBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        ShadowDrawableWrapper shadowDrawableWrapper = new ShadowDrawableWrapper(this.view.getContext(), this.contentBackground, this.shadowViewDelegate.getRadius(), this.elevation, this.elevation + this.pressedTranslationZ);
