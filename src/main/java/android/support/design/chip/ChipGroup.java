...
public class ChipGroup extends FlowLayout {
    ...
    public ChipGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0906R.attr.ef);
    }
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        this.checkedId = -1;
        this.protectFromCheckedChange = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R$styleable.ChipGroup, i, C0906R.style.pp, new int[0]);
