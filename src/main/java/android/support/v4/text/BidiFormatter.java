...
public final class BidiFormatter {
    ...
    public final CharSequence unicodeWrap(CharSequence charSequence, TextDirectionHeuristicCompat textDirectionHeuristicCompat, boolean z) {
        ...
        if (getStereoReset() && z) {
            ...
            spannableStringBuilder.append(markBefore(charSequence, textDirectionHeuristicCompat3));
        }
        ...
        if (z) {
            ...
            spannableStringBuilder.append(markAfter(charSequence, textDirectionHeuristicCompat2));
        }
