...
public final class LinkifyCompat {
    ...
    private static void gatherMapLinks(java.util.ArrayList<android.support.v4.text.util.LinkifyCompat.LinkSpec> r5, android.text.Spannable r6) {
        /*
            ...
            r0 = 0
        L_0x0005:
            java.lang.String r1 = findAddress(r6)     // Catch:{ UnsupportedOperationException -> 0x0040 }
            if (r1 == 0) goto L_0x003f
            int r2 = r6.indexOf(r1)     // Catch:{ UnsupportedOperationException -> 0x0040 }
            if (r2 < 0) goto L_0x003f
            android.support.v4.text.util.LinkifyCompat$LinkSpec r3 = new android.support.v4.text.util.LinkifyCompat$LinkSpec     // Catch:{ UnsupportedOperationException -> 0x0040 }
            r3.<init>()     // Catch:{ UnsupportedOperationException -> 0x0040 }
            int r4 = r1.length()     // Catch:{ UnsupportedOperationException -> 0x0040 }
            int r4 = r4 + r2
            int r2 = r2 + r0
            r3.start = r2     // Catch:{ UnsupportedOperationException -> 0x0040 }
            int r0 = r0 + r4
            r3.end = r0     // Catch:{ UnsupportedOperationException -> 0x0040 }
            java.lang.String r6 = r6.substring(r4)     // Catch:{ UnsupportedOperationException -> 0x0040 }
            java.lang.String r2 = "UTF-8"
            java.lang.String r1 = java.net.URLEncoder.encode(r1, r2)     // Catch:{ UnsupportedEncodingException -> 0x0005 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ UnsupportedOperationException -> 0x0040 }
            ...
            java.lang.String r1 = r2.toString()     // Catch:{ UnsupportedOperationException -> 0x0040 }
