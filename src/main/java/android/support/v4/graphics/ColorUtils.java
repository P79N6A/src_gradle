...
public final class ColorUtils {
    ...
    public static int XYZToColor(@FloatRange(from = 0.0d, to = 95.047d) double d2, @FloatRange(from = 0.0d, to = 100.0d) double d3, @FloatRange(from = 0.0d, to = 108.883d) double d4) {
        ...
        double d10 = (((d2 * 0.0557d) + (d3 * -0.204d)) + (1.057d * d4)) / 100.0d;
        if (d8 > 0.0031308d) {
        ...
        return Color.rgb(constrain((int) Math.round(d5 * 255.0d), 0, 255), constrain((int) Math.round(d6 * 255.0d), 0, 255), constrain((int) Math.round(d7 * 255.0d), 0, 255));
    }
    ...
    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, @NonNull double[] dArr) {
        ...
        if (dArr2.length == 3) {
            ...
            if (d10 < 0.04045d) {
                ...
                d2 = Math.pow((d10 + 0.055d) / 1.055d, 2.4d);
            }
            dArr2[0] = ((0.4124d * d5) + (0.3576d * d8) + (0.1805d * d2)) * 100.0d;
            dArr2[1] = ((0.2126d * d5) + (0.7152d * d8) + (0.0722d * d2)) * 100.0d;
            dArr2[2] = ((d5 * 0.0193d) + (d8 * 0.1192d) + (d2 * 0.9505d)) * 100.0d;
            return;
        }
