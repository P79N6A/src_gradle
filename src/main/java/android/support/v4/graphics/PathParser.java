    ...
    public static class PathDataNode {
        ...
        private static void arcToBezier(Path path, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10) {
            ...
            while (i < ceil) {
                ...
                float f2 = (float) (d20 + (d21 * sin4));
                float f3 = (float) (d27 - (sin4 * d29));
                path.cubicTo((float) (d23 + (d22 * sin4)), f2, f3, (float) (d28 - (sin4 * d30)), (float) d27, (float) d28);
                i++;
                d20 = d28;
                d23 = d27;
                d24 = d25;
        ...
        private static void drawArc(Path path, float f2, float f3, float f4, float f5, float f6, float f7, float f8, boolean z, boolean z2) {
            ...
            while (true) {
                ...
                Double.isNaN(d13);
                double d14 = ((d10 * sin) + (d7 * cos)) / d12;
                double d15 = (double) f5;
                Double.isNaN(d15);
                Double.isNaN(d8);
                double d16 = ((d13 * cos) + (d15 * sin)) / d8;
                ...
                if (d23 != 0.0d) {
                    ...
                    if (d24 < 0.0d) {
                        ...
                        double atan22 = Math.atan2(d18 - d2, d16 - d3) - atan2;
                        if (atan22 >= 0.0d) {
                            z3 = true;
                        } else {
                            z3 = false;
                        ...
                        Double.isNaN(d12);
                        double d30 = d2 * d12;
                        arcToBezier(path, (d29 * cos) - (d30 * d28), (d29 * d28) + (d30 * cos), d27, d12, d6, d11, radians, atan2, atan22);
                        return;
                    }
                } else {
                    return;
