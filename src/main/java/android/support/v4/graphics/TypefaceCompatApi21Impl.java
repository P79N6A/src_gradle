...
public class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r4, android.os.CancellationSignal r5, @android.support.annotation.NonNull android.support.v4.provider.FontsContractCompat.FontInfo[] r6, int r7) {
        ...
        L_0x0053:
            r6 = move-exception
            com.google.a.a.a.a.a.a.a((java.lang.Throwable) r7, (java.lang.Throwable) r6)     // Catch:{ Throwable -> 0x005f, all -> 0x005c }
            goto L_0x005b
        L_0x0058:
            r6.close()     // Catch:{ Throwable -> 0x005f, all -> 0x005c }
        L_0x005b:
        ...
        L_0x006d:
            r5 = move-exception
            com.google.a.a.a.a.a.a.a((java.lang.Throwable) r6, (java.lang.Throwable) r5)     // Catch:{ IOException -> 0x0076 }
            goto L_0x0075
        L_0x0072:
            r5.close()     // Catch:{ IOException -> 0x0076 }
        L_0x0075:
