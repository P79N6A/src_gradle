...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    public final boolean removeAll(@NonNull ArraySet<? extends E> arraySet) {
    ...
    public final boolean add(@Nullable E e2) {
        ...
        if (i3 < this.mSize) {
            ...
            int i5 = i3 + 1;
            System.arraycopy(iArr2, i3, iArr2, i5, this.mSize - i3);
            Object[] objArr2 = this.mArray;
            System.arraycopy(objArr2, i3, objArr2, i5, this.mSize - i3);
        }
        this.mHashes[i3] = i;
        this.mArray[i3] = e2;
        this.mSize++;
