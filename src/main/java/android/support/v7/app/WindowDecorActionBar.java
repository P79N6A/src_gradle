...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0906R.attr.k, typedValue, true);
    ...
    private void init(View view) {
        boolean z;
        boolean z2;
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0906R.id.a2v);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0906R.id.a2));
        this.mContextView = (ActionBarContextView) view.findViewById(C0906R.id.ab);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0906R.id.a4);
