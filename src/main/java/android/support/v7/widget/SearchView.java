...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0906R.attr.bh);
        }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0906R.dimen.as);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0906R.dimen.at);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                i = resources.getDimensionPixelSize(C0906R.dimen.ai) + resources.getDimensionPixelSize(C0906R.dimen.aj);
            } else {
                i = 0;
            }
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0906R.attr.a1v);
    }
    ...
    private android.content.Intent createIntentFromSuggestion(android.database.Cursor r10, int r11, java.lang.String r12) {
        /*
            ...
            java.lang.String r1 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r10, r1)     // Catch:{ RuntimeException -> 0x0061 }
        ...
        L_0x0022:
            ...
            java.lang.String r2 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r10, r2)     // Catch:{ RuntimeException -> 0x0061 }
        ...
        L_0x004d:
            ...
            java.lang.String r6 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r10, r1)     // Catch:{ RuntimeException -> 0x0061 }
            java.lang.String r1 = "suggest_intent_extra_data"
            java.lang.String r5 = android.support.v7.widget.SuggestionsAdapter.getColumnString(r10, r1)     // Catch:{ RuntimeException -> 0x0061 }
            r2 = r9
            r7 = r11
            r8 = r12
            android.content.Intent r11 = r2.createIntent(r3, r4, r5, r6, r7, r8)     // Catch:{ RuntimeException -> 0x0061 }
            return r11
        L_0x0061:
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(9, C0906R.layout.z), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0906R.id.cly);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0906R.id.cl_);
        this.mSearchPlate = findViewById(C0906R.id.cls);
        this.mSubmitArea = findViewById(C0906R.id.cx9);
        this.mSearchButton = (ImageView) findViewById(C0906R.id.cl2);
        this.mGoButton = (ImageView) findViewById(C0906R.id.clc);
        this.mCloseButton = (ImageView) findViewById(C0906R.id.cl5);
        this.mVoiceButton = (ImageView) findViewById(C0906R.id.clz);
        this.mCollapsedIcon = (ImageView) findViewById(C0906R.id.clh);
        ...
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0906R.string.b2));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(15, C0906R.layout.y);
