...
public class Toolbar extends ViewGroup {
    ...
    class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != Toolbar.this) {
                ...
                generateDefaultLayoutParams.gravity = 8388611 | (Toolbar.this.mButtonGravity & SearchJediMixFeedAdapter.f42516e);
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & SearchJediMixFeedAdapter.f42516e);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0906R.attr.a7s);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & SearchJediMixFeedAdapter.f42516e);
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0906R.attr.a7s);
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return this.mGravity & SearchJediMixFeedAdapter.f42516e;
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (!(savedState.expandedMenuItemId == 0 || this.mExpandedMenuPresenter == null || menuBuilder == null)) {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0906R.attr.a7t);
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mButtonGravity = obtainStyledAttributes.getInteger(6, 48);
        ...
        int dimensionPixelOffset6 = obtainStyledAttributes.getDimensionPixelOffset(2, Integer.MIN_VALUE);
        int dimensionPixelOffset7 = obtainStyledAttributes.getDimensionPixelOffset(3, Integer.MIN_VALUE);
        ...
        this.mContentInsetEndWithActions = obtainStyledAttributes.getDimensionPixelOffset(9, Integer.MIN_VALUE);
        this.mCollapseIcon = obtainStyledAttributes.getDrawable(8);
        this.mCollapseDescription = obtainStyledAttributes.getText(7);
