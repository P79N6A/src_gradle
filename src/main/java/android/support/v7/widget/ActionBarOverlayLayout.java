...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = {C0906R.attr.f4372d, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0906R.id.a3);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0906R.id.a4);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0906R.id.a2));
        }
    }
