...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0076, code lost:
            r5.this$0.select(null, 0);
            r5.this$0.mActivePointerId = -1;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x0080, code lost:
            return;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void onTouchEvent(@android.support.annotation.NonNull android.support.v7.widget.RecyclerView r6, @android.support.annotation.NonNull android.view.MotionEvent r7) {
            /*
                r5 = this;
                android.support.v7.widget.helper.ItemTouchHelper r6 = android.support.v7.widget.helper.ItemTouchHelper.this
                android.support.v4.view.GestureDetectorCompat r6 = r6.mGestureDetector
                r6.onTouchEvent(r7)
                android.support.v7.widget.helper.ItemTouchHelper r6 = android.support.v7.widget.helper.ItemTouchHelper.this
                android.view.VelocityTracker r6 = r6.mVelocityTracker
            ...
            L_0x002f:
                android.support.v7.widget.helper.ItemTouchHelper r2 = android.support.v7.widget.helper.ItemTouchHelper.this
                android.support.v7.widget.RecyclerView$ViewHolder r2 = r2.mSelected
            ...
            L_0x004c:
                ...
                java.lang.Runnable r7 = r7.mScrollRunnable
                r6.removeCallbacks(r7)
                android.support.v7.widget.helper.ItemTouchHelper r6 = android.support.v7.widget.helper.ItemTouchHelper.this
                java.lang.Runnable r6 = r6.mScrollRunnable
                r6.run()
                android.support.v7.widget.helper.ItemTouchHelper r6 = android.support.v7.widget.helper.ItemTouchHelper.this
                android.support.v7.widget.RecyclerView r6 = r6.mRecyclerView
                r6.invalidate()
    ...
    public static abstract class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0906R.dimen.ho);
            }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0906R.dimen.hq);
                this.mMaxSwipeVelocity = resources.getDimension(C0906R.dimen.hp);
                setupCallbacks();
            }
        }
    }
    ...
    private int checkHorizontalSwipe(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if ((i & 12) != 0) {
            ...
            if (this.mVelocityTracker != null && this.mActivePointerId >= 0) {
                this.mVelocityTracker.computeCurrentVelocity(PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE, this.mCallback.getSwipeVelocityThreshold(this.mMaxSwipeVelocity));
