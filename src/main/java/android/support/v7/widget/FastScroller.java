...
public class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public boolean isPointInsideHorizontalThumb(float f2, float f3) {
        if (f3 < ((float) (this.mRecyclerViewHeight - this.mHorizontalThumbHeight)) || f2 < ((float) (this.mHorizontalThumbCenterX - (this.mHorizontalThumbWidth / 2))) || f2 > ((float) (this.mHorizontalThumbCenterX + (this.mHorizontalThumbWidth / 2)))) {
            return false;
        }
        return true;
    }
    ...
    public boolean isPointInsideVerticalThumb(float f2, float f3) {
        if (!isLayoutRTL() ? f2 >= ((float) (this.mRecyclerViewWidth - this.mVerticalThumbWidth)) : f2 <= ((float) (this.mVerticalThumbWidth / 2))) {
            if (f3 >= ((float) (this.mVerticalThumbCenterY - (this.mVerticalThumbHeight / 2))) && f3 <= ((float) (this.mVerticalThumbCenterY + (this.mVerticalThumbHeight / 2)))) {
                return true;
            }
        }
        return false;
    ...
    public void updateScrollPosition(int i, int i2) {
        ...
        if (computeVerticalScrollRange - i3 <= 0 || this.mRecyclerViewHeight < this.mScrollbarMinimumRange) {
            z = false;
        } else {
            z = true;
        }
        ...
        if (computeHorizontalScrollRange - i4 <= 0 || this.mRecyclerViewWidth < this.mScrollbarMinimumRange) {
            z2 = false;
        } else {
            z2 = true;
        }
