...
public enum Native {
    ...
    private static String resourceName() {
        ...
        return "/" + replace + "/" + os.name + "/" + arch() + "/liblz4-java." + os.libExtension;
    }

    /* JADX WARNING: Can't wrap try/catch for region: R(9:24|25|26|27|28|(2:30|31)|(3:34|35|(4:37|(1:39)(1:40)|41|42))|43|44) */
    /* JADX WARNING: Code restructure failed: missing block: B:13:?, code lost:
        r3 = net.jpountz.util.Native.class.getResourceAsStream(resourceName());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x001d, code lost:
        if (r3 != null) goto L_0x001f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r2 = java.io.File.createTempFile("liblz4-java", com.taobao.android.dexposed.ClassUtils.PACKAGE_SEPARATOR + os().libExtension);
    ...
    public static synchronized void load() {
        ...
        L_0x0013:
            ...
            net.jpountz.util.Native$OS r5 = os()     // Catch:{ IOException -> 0x0092 }
        ...
        L_0x0053:
            ...
            java.lang.System.load(r3)     // Catch:{ all -> 0x0078 }
