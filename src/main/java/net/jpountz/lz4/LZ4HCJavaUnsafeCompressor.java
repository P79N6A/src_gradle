...
public final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
        ...
        public boolean insertAndFindWiderMatch(ByteBuffer byteBuffer, int i, int i2, int i3, int i4, LZ4Utils.Match match) {
            ...
            for (int i5 = 0; i5 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i - 65536) + 1) && hashPointer <= i; i5++) {
                if (LZ4ByteBufferUtils.readIntEquals(byteBuffer, hashPointer, i)) {
                    ...
                    int commonBytes = LZ4ByteBufferUtils.commonBytes(byteBuffer, hashPointer + 4, i + 4, i3) + 4 + commonBytesBackward;
                    if (commonBytes > match.len) {
                        match.len = commonBytes;
        ...
        public boolean insertAndFindWiderMatch(byte[] bArr, int i, int i2, int i3, int i4, LZ4Utils.Match match) {
            ...
            for (int i5 = 0; i5 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i - 65536) + 1) && hashPointer <= i; i5++) {
                if (LZ4UnsafeUtils.readIntEquals(bArr, hashPointer, i)) {
                    ...
                    int commonBytes = LZ4UnsafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i3) + 4 + commonBytesBackward;
                    if (commonBytes > match.len) {
                        match.len = commonBytes;
                        match.ref = hashPointer - commonBytesBackward;
                        match.start = i - commonBytesBackward;
    ...
    public final int compress(byte[] r24, int r25, int r26, byte[] r27, int r28, int r29) {
        ...
        L_0x0030:
            ...
            r5 = r24
            boolean r4 = r13.insertAndFindBestMatch((byte[]) r5, (int) r2, (int) r12, (net.jpountz.lz4.LZ4Utils.Match) r8)
