...
public final class LZ4JavaUnsafeCompressor extends LZ4Compressor {
    ...
    static int compress64k(java.nio.ByteBuffer r18, int r19, int r20, java.nio.ByteBuffer r21, int r22, int r23) {
        ...
        L_0x00a7:
            ...
            int r9 = r9 - r1
            net.jpountz.util.UnsafeUtils.writeShort((short[]) r2, (int) r11, (int) r9)
            int r9 = net.jpountz.util.ByteBufferUtils.readInt(r0, r8)
            int r9 = net.jpountz.lz4.LZ4Utils.hash64k(r9)
            int r11 = net.jpountz.util.UnsafeUtils.readShort((short[]) r2, (int) r9)
            int r15 = r1 + r11
            int r11 = r8 - r1
            net.jpountz.util.UnsafeUtils.writeShort((short[]) r2, (int) r9, (int) r11)
    ...
    public final int compress(java.nio.ByteBuffer r20, int r21, int r22, java.nio.ByteBuffer r23, int r24, int r25) {
        ...
        L_0x00f9:
            ...
            net.jpountz.util.UnsafeUtils.writeInt((int[]) r7, (int) r12, (int) r1)
            int r1 = net.jpountz.util.ByteBufferUtils.readInt(r5, r6)
            int r1 = net.jpountz.lz4.LZ4Utils.hash(r1)
            int r12 = net.jpountz.util.UnsafeUtils.readInt((int[]) r7, (int) r1)
            net.jpountz.util.UnsafeUtils.writeInt((int[]) r7, (int) r1, (int) r6)
            int r13 = r6 - r12
    ...
    static int compress64k(byte[] r18, int r19, int r20, byte[] r21, int r22, int r23) {
        ...
        L_0x0070:
            ...
            r11 = r11 | r13
            net.jpountz.util.UnsafeUtils.writeByte((byte[]) r3, (int) r10, (int) r11)
            int r9 = r9 + -15
        ...
        L_0x00a7:
            int r9 = r8 + -2
            int r11 = net.jpountz.util.UnsafeUtils.readInt((byte[]) r0, (int) r9)
            int r11 = net.jpountz.lz4.LZ4Utils.hash64k(r11)
            int r9 = r9 - r1
            net.jpountz.util.UnsafeUtils.writeShort((short[]) r2, (int) r11, (int) r9)
    ...
    public final int compress(byte[] r19, int r20, int r21, byte[] r22, int r23, int r24) {
        ...
        L_0x003a:
            ...
            r15 = r11
            int r11 = net.jpountz.util.UnsafeUtils.readInt((int[]) r8, (int) r14)
            r16 = r12
            int r12 = r7 - r11
            ...
            r1 = 240(0xf0, float:3.36E-43)
            net.jpountz.util.UnsafeUtils.writeByte((byte[]) r3, (int) r10, (int) r1)
            int r1 = r13 + -15
        ...
        L_0x00c3:
            int r1 = r7 + -2
            int r11 = net.jpountz.util.UnsafeUtils.readInt((byte[]) r0, (int) r1)
            int r11 = net.jpountz.lz4.LZ4Utils.hash(r11)
            net.jpountz.util.UnsafeUtils.writeInt((int[]) r8, (int) r11, (int) r1)
            int r1 = net.jpountz.util.UnsafeUtils.readInt((byte[]) r0, (int) r7)
            int r1 = net.jpountz.lz4.LZ4Utils.hash(r1)
            int r11 = net.jpountz.util.UnsafeUtils.readInt((int[]) r8, (int) r1)
            net.jpountz.util.UnsafeUtils.writeInt((int[]) r8, (int) r1, (int) r7)
            int r12 = r7 - r11
            r1 = 65536(0x10000, float:9.18355E-41)
