...
public final class LZ4JavaSafeCompressor extends LZ4Compressor {
    ...
    public final int compress(java.nio.ByteBuffer r20, int r21, int r22, java.nio.ByteBuffer r23, int r24, int r25) {
        ...
        L_0x0070:
            ...
            r16 = r12
            int r12 = net.jpountz.util.SafeUtils.readInt((int[]) r7, (int) r15)
            r17 = r13
            int r13 = r6 - r12
        ...
        L_0x00f9:
            ...
            int r12 = net.jpountz.util.SafeUtils.readInt((int[]) r7, (int) r1)
            net.jpountz.util.SafeUtils.writeInt(r7, r1, r6)
            int r13 = r6 - r12
    ...
    static int compress64k(byte[] r18, int r19, int r20, byte[] r21, int r22, int r23) {
        ...
        L_0x0022:
            ...
            int r11 = r11 >>> r14
            if (r12 > r7) goto L_0x00f4
            int r14 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r8)
            int r14 = net.jpountz.lz4.LZ4Utils.hash64k(r14)
            int r15 = net.jpountz.util.SafeUtils.readShort(r2, r14)
            int r15 = r15 + r1
            r16 = r11
        ...
        L_0x00a7:
            int r9 = r8 + -2
            int r11 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r9)
            int r11 = net.jpountz.lz4.LZ4Utils.hash64k(r11)
            int r9 = r9 - r1
            net.jpountz.util.SafeUtils.writeShort(r2, r11, r9)
            int r9 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r8)
            int r9 = net.jpountz.lz4.LZ4Utils.hash64k(r9)
            int r11 = net.jpountz.util.SafeUtils.readShort(r2, r9)
            int r15 = r1 + r11
            int r11 = r8 - r1
    ...
    public final int compress(byte[] r19, int r20, int r21, byte[] r22, int r23, int r24) {
        ...
        L_0x003a:
            ...
            int r14 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r7)
            int r14 = net.jpountz.lz4.LZ4Utils.hash(r14)
            r15 = r11
            int r11 = net.jpountz.util.SafeUtils.readInt((int[]) r8, (int) r14)
            r16 = r12
            int r12 = r7 - r11
        ...
        L_0x00c3:
            int r1 = r7 + -2
            int r11 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r1)
            int r11 = net.jpountz.lz4.LZ4Utils.hash(r11)
            net.jpountz.util.SafeUtils.writeInt(r8, r11, r1)
            int r1 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r7)
            int r1 = net.jpountz.lz4.LZ4Utils.hash(r1)
            int r11 = net.jpountz.util.SafeUtils.readInt((int[]) r8, (int) r1)
            net.jpountz.util.SafeUtils.writeInt(r8, r1, r7)
            int r12 = r7 - r11
            r1 = 65536(0x10000, float:9.18355E-41)
