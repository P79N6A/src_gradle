...
public final class LZ4JavaSafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    public final int decompress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        if (i4 != 0) {
            ...
            int i13 = i9;
            while (true) {
                byte readByte = SafeUtils.readByte(bArr3, i12) & 255;
                i5 = i12 + 1;
                i6 = readByte >>> 4;
                if (i6 == 15) {
                    byte b3 = -1;
                ...
                LZ4SafeUtils.wildArraycopy(bArr3, i5, bArr4, i13, i6);
                int readShortLE = SafeUtils.readShortLE(bArr3, i18);
                int i19 = i18 + 2;
                ...
                if (i20 >= i9) {
                    ...
                    if (i21 == 15) {
                        ...
                        while (true) {
                            ...
                            int i22 = i19 + 1;
                            b2 = SafeUtils.readByte(bArr3, i19);
                            if (b2 != -1) {
                                i19 = i22;
                                break;
                            }
                    ...
                    int i24 = i7 + i23;
                    if (i24 <= i17) {
                        LZ4SafeUtils.wildIncrementalCopy(bArr4, i20, i7, i24);
                    } else if (i24 <= i11) {
                        LZ4SafeUtils.safeIncrementalCopy(bArr4, i20, i7, i23);
                    } else {
            ...
            if (i7 > i11) {
                ...
                LZ4SafeUtils.safeArraycopy(bArr3, i5, bArr4, i13, i6);
                return i7 - i9;
            } else {
                throw new LZ4Exception("Malformed input at " + i5);
            }
        } else if (i8 == 1 && SafeUtils.readByte(bArr, i) == 0) {
            return 0;
        } else {
