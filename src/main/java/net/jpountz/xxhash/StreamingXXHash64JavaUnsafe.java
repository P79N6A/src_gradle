...
public final class StreamingXXHash64JavaUnsafe extends AbstractStreamingXXHash64Java {
    ...
    public final long getValue() {
        ...
        while (i <= this.memSize - 8) {
            j5 = (Long.rotateLeft(j5 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(this.memory, i) * -4417276706812531889L, 31) * -7046029288634856825L), 27) * -7046029288634856825L) - 8796714831421723037L;
            i += 8;
        }
        if (i <= this.memSize - 4) {
            j5 = (Long.rotateLeft(j5 ^ ((((long) UnsafeUtils.readIntLE(this.memory, i)) & 4294967295L) * -7046029288634856825L), 23) * -4417276706812531889L) + 1609587929392839161L;
            i += 4;
        }
