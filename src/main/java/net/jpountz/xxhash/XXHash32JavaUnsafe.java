...
public final class XXHash32JavaUnsafe extends XXHash32 {
    ...
    public final int hash(ByteBuffer byteBuffer, int i, int i2, int i3) {
        ...
        int i14 = i4 + i2;
        while (i <= i5 - 4) {
            i14 = Integer.rotateLeft(i14 + (ByteBufferUtils.readIntLE(inLittleEndianOrder, i) * -1028477379), 17) * 668265263;
            i += 4;
        }
        while (i < i5) {
            i14 = Integer.rotateLeft(i14 + ((ByteBufferUtils.readByte(inLittleEndianOrder, i) & 255) * 374761393), 11) * -1640531535;
            i++;
        }
