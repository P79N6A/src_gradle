    ...
    public final long hash(byte[] bArr, int i, int i2, long j) {
        ...
        if (i4 >= 32) {
            ...
            while (true) {
                ...
                int i7 = i3 + 8;
                rotateLeft2 = Long.rotateLeft(j6 + (SafeUtils.readLongLE(bArr2, i7) * j4), 31) * -7046029288634856825L;
                int i8 = i7 + 8;
                rotateLeft3 = Long.rotateLeft(j7 + (SafeUtils.readLongLE(bArr2, i8) * j4), 31) * -7046029288634856825L;
                int i9 = i8 + 8;
                j8 = Long.rotateLeft(j8 + (SafeUtils.readLongLE(bArr2, i9) * -4417276706812531889L), 31) * -7046029288634856825L;
                i3 = i9 + 8;
                if (i3 > i6) {
                    break;
                }
