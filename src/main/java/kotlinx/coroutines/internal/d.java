...
public abstract class d<T> extends p {
    ...
    private static final AtomicReferenceFieldUpdater f83920a = AtomicReferenceFieldUpdater.newUpdater(d.class, Object.class, "_consensus");
    private volatile Object _consensus = c.f83919a;
    ...
    public final Object b(@Nullable Object obj) {
        ...
        if (obj2 == c.f83919a) {
            ...
            } else if (!f83920a.compareAndSet(this, c.f83919a, obj2)) {
