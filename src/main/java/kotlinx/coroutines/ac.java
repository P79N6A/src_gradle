...
public final class ac {
    ...
    public static final void a(@NotNull e eVar, @NotNull Throwable th) {
        Intrinsics.checkParameterIsNotNull(eVar, "context");
        Intrinsics.checkParameterIsNotNull(th, "exception");
        try {
            CoroutineExceptionHandler coroutineExceptionHandler = (CoroutineExceptionHandler) eVar.get(CoroutineExceptionHandler.f83784a);
    ...
    @InternalCoroutinesApi
    public static final void a(@NotNull e eVar, @NotNull Throwable th, @Nullable bk bkVar) {
        Intrinsics.checkParameterIsNotNull(eVar, "context");
        Intrinsics.checkParameterIsNotNull(th, "exception");
        if (!(th instanceof CancellationException)) {
            bk bkVar2 = (bk) eVar.get(bk.f4367c);
            if (bkVar2 == null || bkVar2 == bkVar || !bkVar2.b(th)) {
                a(eVar, th);
            }
        }
    }
