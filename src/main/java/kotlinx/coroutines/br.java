...
public final class br extends cb {
    ...
    private Function2<? super af, ? super c<? super Unit>, ? extends Object> f83897b;

    /* access modifiers changed from: protected */
    public final void d() {
        Function2<? super af, ? super c<? super Unit>, ? extends Object> function2 = this.f83897b;
        if (function2 != null) {
            this.f83897b = null;
    ...
    public br(@NotNull e eVar, @NotNull Function2<? super af, ? super c<? super Unit>, ? extends Object> function2) {
        super(eVar, false);
        Intrinsics.checkParameterIsNotNull(eVar, "parentContext");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        this.f83897b = function2;
    }
}
