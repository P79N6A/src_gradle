...
public final class bj extends bn<bk> {

    /* renamed from: a  reason: collision with root package name */
    private final Function1<Throwable, Unit> f83882a;

    @NotNull
    public final String toString() {
        return "InvokeOnCompletion[" + ai.b(this) + '@' + ai.a((Object) this) + ']';
    }

    public final void a(@Nullable Throwable th) {
        this.f83882a.invoke(th);
    }
    ...
    public bj(@NotNull bk bkVar, @NotNull Function1<? super Throwable, Unit> function1) {
        super(bkVar);
        Intrinsics.checkParameterIsNotNull(bkVar, "job");
        Intrinsics.checkParameterIsNotNull(function1, "handler");
        this.f83882a = function1;
    }
}
