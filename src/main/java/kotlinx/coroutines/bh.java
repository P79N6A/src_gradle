...
public final class bh extends i {
    ...
    private final Function1<Throwable, Unit> f83879a;

    @NotNull
    public final String toString() {
        return "InvokeOnCancel[" + ai.b(this.f83879a) + '@' + ai.a((Object) this) + ']';
    }

    public final void a(@Nullable Throwable th) {
        this.f83879a.invoke(th);
    }
    ...
    public bh(@NotNull Function1<? super Throwable, Unit> function1) {
        Intrinsics.checkParameterIsNotNull(function1, "handler");
        this.f83879a = function1;
    }
}
