...
public final class Delegates {
    ...
    public static final class a extends ObservableProperty<T> {
        ...
        final /* synthetic */ Function3 f83611a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Object f83612b;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public a(Function3 function3, Object obj, Object obj2) {
            super(obj2);
            this.f83611a = function3;
            this.f83612b = obj;
        }

        /* access modifiers changed from: protected */
        public final void afterChange(@NotNull KProperty<?> kProperty, T t, T t2) {
            Intrinsics.checkParameterIsNotNull(kProperty, "property");
            this.f83611a.invoke(kProperty, t, t2);
        }
    }
    ...
    public static final class b extends ObservableProperty<T> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Function3 f83613a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Object f83614b;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public b(Function3 function3, Object obj, Object obj2) {
            super(obj2);
            this.f83613a = function3;
            this.f83614b = obj;
        }

        /* access modifiers changed from: protected */
        public final boolean beforeChange(@NotNull KProperty<?> kProperty, T t, T t2) {
            Intrinsics.checkParameterIsNotNull(kProperty, "property");
            return ((Boolean) this.f83613a.invoke(kProperty, t, t2)).booleanValue();
        }
    }
