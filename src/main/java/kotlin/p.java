...
public final class p implements Comparable<p> {
    ...
    public static final a f83609a = new a((byte) 0);

    /* renamed from: b  reason: collision with root package name */
    private final byte f83610b;
    ...
    public final String toString() {
        return String.valueOf(this.f83610b & 255);
    }
    ...
    public final /* synthetic */ int compareTo(Object obj) {
        return Intrinsics.compare((int) this.f83610b & 255, (int) ((p) obj).a() & 255);
    }

    public final boolean equals(Object obj) {
        boolean z;
        byte b2 = this.f83610b;
        if (obj instanceof p) {
            if (b2 == ((p) obj).a()) {
                z = true;
            } else {
