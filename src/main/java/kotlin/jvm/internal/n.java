...
public final class n implements m, KClass<Object> {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    private final Class<?> f83594a;
    ...
    @NotNull
    public final Collection<d<Object>> getConstructors() {
        b();
        throw null;
    }
    ...
    @NotNull
    public final List<i> getSupertypes() {
        b();
        throw null;
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        if (!(obj instanceof n) || !Intrinsics.areEqual((Object) a.b(this), (Object) a.b((KClass) obj))) {
            return false;
        }
        return true;
    }
