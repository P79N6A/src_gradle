...
public class o {
    ...
    public static final class a implements Sequence<T> {
        ...
        final /* synthetic */ Function2 f83714a;

        @NotNull
        public final Iterator<T> iterator() {
            return SequencesKt.iterator(this.f83714a);
        }

        public a(Function2 function2) {
            this.f83714a = function2;
        }
    }
    ...
    public static final class b implements Sequence<T> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Function2 f83715a;

        @NotNull
        public final Iterator<T> iterator() {
            return SequencesKt.iterator(this.f83715a);
        }

        public b(Function2 function2) {
            this.f83715a = function2;
        }
    }
    ...
    @InlineOnly
    private static final <T> Iterator<T> buildIterator(@BuilderInference Function2<? super n<? super T>, ? super c<? super Unit>, ? extends Object> function2) {
    ...
    @InlineOnly
    private static final <T> Sequence<T> buildSequence(@BuilderInference Function2<? super n<? super T>, ? super c<? super Unit>, ? extends Object> function2) {
        return new a<>(function2);
    }

    @NotNull
    @SinceKotlin
    public static final <T> Sequence<T> sequence(@NotNull @BuilderInference Function2<? super n<? super T>, ? super c<? super Unit>, ? extends Object> function2) {
    ...
    @NotNull
    @SinceKotlin
    public static final <T> Iterator<T> iterator(@NotNull @BuilderInference Function2<? super n<? super T>, ? super c<? super Unit>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(function2, "block");
        m mVar = new m();
        mVar.f83710a = kotlin.coroutines.a.b.a(function2, mVar, mVar);
        return mVar;
    }
}
