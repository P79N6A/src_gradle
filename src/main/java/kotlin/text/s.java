...
public class s extends r {
    ...
    private static final byte toByte(@NotNull String str, int i) {
        return Byte.parseByte(str, a.a(i));
    }
    ...
    private static final String toString(byte b2, int i) {
        String num = Integer.toString(b2, a.a(a.a(i)));
        Intrinsics.checkExpressionValueIsNotNull(num, "java.lang.Integer.toStri…(this, checkRadix(radix))");
        return num;
    }
    ...
    private static final String toString(short s, int i) {
        String num = Integer.toString(s, a.a(a.a(i)));
        Intrinsics.checkExpressionValueIsNotNull(num, "java.lang.Integer.toStri…(this, checkRadix(radix))");
        return num;
    }
}
