...
public class p extends o {
    ...
    @InlineOnly
    private static final Regex toRegex(@NotNull String str, Set<? extends l> set) {
        return new Regex(str, set);
    }

    @InlineOnly
    private static final Regex toRegex(@NotNull String str, l lVar) {
        return new Regex(str, lVar);
    }
}
