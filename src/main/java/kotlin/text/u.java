...
public class u extends t {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:14:0x0041 A[RETURN] */
    ...
    public static final boolean isBlank(@org.jetbrains.annotations.NotNull java.lang.CharSequence r4) {
        ...
        L_0x0024:
            ...
            boolean r2 = kotlin.text.a.a((char) r2)
        ...
        L_0x0042:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.u.isBlank(java.lang.CharSequence):boolean");
    }
    ...
    @InlineOnly
    private static final int nativeIndexOf(@NotNull String str, char c2, int i) {
        if (str != null) {
    ...
    @InlineOnly
    private static final int nativeLastIndexOf(@NotNull String str, char c2, int i) {
        if (str != null) {
    ...
    public static final String replace(@NotNull String str, char c2, char c3, boolean z) {
        ...
        return SequencesKt.joinToString$default(StringsKt.splitToSequence$default((CharSequence) str2, new char[]{c2}, z, 0, 4, (Object) null), String.valueOf(c3), null, null, 0, null, null, 62, null);
    }
    ...
    public static final String replaceFirst(@NotNull String str, char c2, char c3, boolean z) {
        ...
        int indexOf$default = StringsKt.indexOf$default(charSequence, c2, 0, z, 2, (Object) null);
        if (indexOf$default < 0) {
            return str;
        }
        return StringsKt.replaceRange(charSequence, indexOf$default, indexOf$default + 1, (CharSequence) String.valueOf(c3)).toString();
    }
    ...
    public static final String replaceFirst(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        ...
        return StringsKt.replaceRange(charSequence, indexOf$default, str2.length() + indexOf$default, (CharSequence) str3).toString();
    }
