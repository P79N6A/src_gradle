...
public class h {
    ...
    public static final kotlin.io.c toComponents(@org.jetbrains.annotations.NotNull java.io.File r9) {
        /*
        ...
        L_0x0072:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.io.h.toComponents(java.io.File):kotlin.io.c");
    }

    @NotNull
    public static final File subPath(@NotNull File file, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(file, "$this$subPath");
        return FilesKt.toComponents(file).a(i, i2);
    }
}
