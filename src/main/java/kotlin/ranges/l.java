...
public class l extends k {
    ...
    @SinceKotlin
    @InlineOnly
    private static final <T, R extends Iterable<? extends T> & g<T>> boolean contains(@NotNull R r, T t) {
        Intrinsics.checkParameterIsNotNull(r, "$this$contains");
        if (t == null || !((g) r).contains((Comparable) t)) {
            return false;
        }
        return true;
    }
    ...
    @NotNull
    public static final <T extends Comparable<? super T>> g<T> rangeTo(@NotNull T t, @NotNull T t2) {
