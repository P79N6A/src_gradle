...
public final class c extends a implements g<Character> {
    ...
    public static final c f83630e = new c(1, 0);

    /* renamed from: f  reason: collision with root package name */
    public static final a f83631f = new a((byte) 0);
    ...
    public final /* synthetic */ Comparable getEndInclusive() {
        return Character.valueOf(this.f83624b);
    }

    public final /* synthetic */ Comparable getStart() {
        return Character.valueOf(this.f83623a);
    }
    ...
    public final int hashCode() {
        ...
        return (this.f83623a * 31) + this.f83624b;
    }
    ...
    public final String toString() {
        return this.f83623a + ".." + this.f83624b;
    }

    public final boolean a(char c2) {
        if (this.f83623a > c2 || c2 > this.f83624b) {
            return false;
        }
        return true;
    }
    ...
    public final boolean equals(@org.jetbrains.annotations.Nullable java.lang.Object r3) {
        ...
        L_0x0013:
            char r0 = r2.f83623a
            kotlin.ranges.c r3 = (kotlin.ranges.c) r3
            char r1 = r3.f83623a
