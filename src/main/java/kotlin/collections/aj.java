...
public final class aj<K, V> implements ai<K, V> {
    @NotNull

    /* renamed from: a  reason: collision with root package name */
    private final Map<K, V> f83426a;

    /* renamed from: b  reason: collision with root package name */
    private final Function1<K, V> f83427b;
    ...
    public final V a(K k) {
        ...
        return this.f83427b.invoke(k);
    }

    public aj(@NotNull Map<K, ? extends V> map, @NotNull Function1<? super K, ? extends V> function1) {
        Intrinsics.checkParameterIsNotNull(map, "map");
        Intrinsics.checkParameterIsNotNull(function1, "default");
        this.f83426a = map;
        this.f83427b = function1;
    }
}
