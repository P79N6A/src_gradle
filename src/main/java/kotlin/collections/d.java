...
public abstract class d<E> extends a<E> implements List<E>, kotlin.jvm.internal.a.a {
    ...
    public static final a f83450a = new a((byte) 0);
    ...
    class c extends b implements ListIterator<E>, kotlin.jvm.internal.a.a {
        ...
        public final int previousIndex() {
            return this.f83451a - 1;
        }

        public final E previous() {
            if (hasPrevious()) {
                this.f83451a--;
                return d.this.get(this.f83451a);
            }
            throw new NoSuchElementException();
        }
    ...
    static final class C0886d<E> extends d<E> implements RandomAccess {

        /* renamed from: b  reason: collision with root package name */
        private int f83454b;

        /* renamed from: c  reason: collision with root package name */
        private final d<E> f83455c;

        /* renamed from: d  reason: collision with root package name */
        private final int f83456d;
        ...
        public final E get(int i) {
            a.a(i, this.f83454b);
            return this.f83455c.get(this.f83456d + i);
        }

        public C0886d(@NotNull d<? extends E> dVar, int i, int i2) {
            Intrinsics.checkParameterIsNotNull(dVar, "list");
            this.f83455c = dVar;
            this.f83456d = i;
            a.a(this.f83456d, i2, this.f83455c.size());
            this.f83454b = i2 - this.f83456d;
        }
    }
