...
public class t extends s {
    ...
    @Deprecated(level = a.ERROR, message = "Use removeAt(index) instead.", replaceWith = @ReplaceWith(expression = "removeAt(index)", imports = {}))
    @InlineOnly
    ...
    public static final <T> boolean removeAll(@NotNull Collection<? super T> collection, @NotNull Sequence<? extends T> sequence) {
        ...
        if (!(!hashSet.isEmpty()) || !collection.removeAll(hashSet)) {
            return false;
        }
        return true;
    }
    ...
    public static final <T> boolean removeAll(@NotNull Collection<? super T> collection, @NotNull T[] tArr) {
        ...
        if (!(!z) || !collection.removeAll(ArraysKt.toHashSet(tArr))) {
            return false;
        }
        return true;
    }
