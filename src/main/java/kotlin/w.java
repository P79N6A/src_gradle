...
public final class w implements Comparable<w> {
    ...
    public static final a f83659a = new a((byte) 0);

    /* renamed from: b  reason: collision with root package name */
    private final short f83660b;
    ...
    public final String toString() {
        return String.valueOf(this.f83660b & 65535);
    }
    ...
    public final /* synthetic */ int compareTo(Object obj) {
        return Intrinsics.compare((int) this.f83660b & 65535, (int) ((w) obj).a() & 65535);
    }

    public final boolean equals(Object obj) {
        boolean z;
        short s = this.f83660b;
        if (obj instanceof w) {
            if (s == ((w) obj).a()) {
                z = true;
            } else {
