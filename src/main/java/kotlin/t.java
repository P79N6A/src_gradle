...
public final class t implements Comparable<t> {
    ...
    public static final a f83653a = new a((byte) 0);

    /* renamed from: b  reason: collision with root package name */
    private final long f83654b;
    ...
    public final String toString() {
        long j = this.f83654b;
        if (j >= 0) {
            String l = Long.toString(j, kotlin.text.a.a(10));
        ...
        String l2 = Long.toString(j2, kotlin.text.a.a(10));
        Intrinsics.checkExpressionValueIsNotNull(l2, "java.lang.Long.toString(this, checkRadix(radix))");
        sb.append(l2);
        String l3 = Long.toString(j3, kotlin.text.a.a(10));
    ...
    public final /* synthetic */ int compareTo(Object obj) {
        return ((this.f83654b ^ Long.MIN_VALUE) > (((t) obj).a() ^ Long.MIN_VALUE) ? 1 : ((this.f83654b ^ Long.MIN_VALUE) == (((t) obj).a() ^ Long.MIN_VALUE) ? 0 : -1));
    }
