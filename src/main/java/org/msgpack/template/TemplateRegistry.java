...
public class TemplateRegistry {
    ...
    private Template<Type> lookupCache(Type type) {
        ...
        Template<Type> template2 = this.cache.get(type);
        if (template2 != null) {
            return template2;
        }
        try {
    ...
    private <T> Template<T> lookupInterfaceTypes(Class<T> cls) {
        ...
        while (i < length) {
            ...
            Template<Type> template2 = this.cache.get(cls2);
            if (template2 != null) {
    ...
    private <T> Template<T> lookupSuperclassInterfaceTypes(Class<T> cls) {
        ...
        Template<? super T> template = null;
        if (superclass != null) {
            while (superclass != Object.class) {
                ...
                try {
                    Template<Type> lookupCache = this.parent.lookupCache(superclass);
                    if (lookupCache != null) {
                        try {
    ...
    private static String toJvmPrimitiveTypeName(String str) {
        ...
        throw new c(String.format("fatal error: type=%s", new Object[]{str}));
    }
    ...
    private org.msgpack.template.Template lookupGenericArrayTypeImpl(java.lang.reflect.GenericArrayType r8) {
        ...
        L_0x0087:
            ...
            return r0
        L_0x0092:
            org.msgpack.c r0 = new org.msgpack.c
        ...
        L_0x00a2:
            ...
            throw r8
        L_0x00b2:
            org.msgpack.c r8 = new org.msgpack.c
            java.lang.Object[] r1 = new java.lang.Object[r2]
            r1[r3] = r0
    ...
    public synchronized Template lookup(Type type) {
        ...
        Template<Type> lookupGenericArrayType = lookupGenericArrayType(type);
        ...
        if (!(type instanceof WildcardType)) {
            if (!(type instanceof TypeVariable)) {
                ...
                if (b.class.isAssignableFrom(cls)) {
                    ...
                    throw new c("Cannot find template for " + cls + " class.  Try to add @Message annotation to the class or call MessagePack.register(Type).");
                }
            }
        }
    ...
    private synchronized org.msgpack.template.Template buildAndRegister(org.msgpack.template.builder.TemplateBuilder r5, java.lang.Class r6, boolean r7, org.msgpack.template.FieldList r8) {
        ...
        L_0x0054:
            boolean r7 = r5 instanceof org.msgpack.c     // Catch:{ all -> 0x003f }
            if (r7 == 0) goto L_0x005b
            org.msgpack.c r5 = (org.msgpack.c) r5     // Catch:{ all -> 0x003f }
            throw r5     // Catch:{ all -> 0x003f }
        L_0x005b:
            org.msgpack.c r7 = new org.msgpack.c     // Catch:{ all -> 0x003f }
            r7.<init>((java.lang.Throwable) r5)     // Catch:{ all -> 0x003f }
