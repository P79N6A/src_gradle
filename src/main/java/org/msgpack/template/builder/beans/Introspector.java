...
public class Introspector {
    ...
    private static Map<Class<?>, StandardBeanInfo> theCache = Collections.synchronizedMap(new WeakHashMap(SearchJediMixFeedAdapter.f42517f));
    ...
    private static BeanInfo getExplicitBeanInfo(Class<?> cls) {
        ...
        try {
            ...
            for (int i = 0; i < searchPath.length; i++) {
                try {
                    BeanInfo loadBeanInfo = loadBeanInfo(searchPath[i] + ClassUtils.PACKAGE_SEPARATOR + str, cls);
