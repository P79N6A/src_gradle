...
public final class d {
    ...
    private Reader f84176b;

    /* renamed from: c  reason: collision with root package name */
    private char f84177c;

    /* renamed from: d  reason: collision with root package name */
    private boolean f84178d;

    private d(Reader reader) {
        this.f84176b = !reader.markSupported() ? new BufferedReader(reader) : reader;
        this.f84178d = false;
        this.f84175a = 0;
    }
    ...
    private String a(int i) {
        ...
        while (i2 < i) {
            try {
                int read = this.f84176b.read(cArr, i2, i - i2);
                if (read == -1) {
                    break;
                }
                i2 += read;
    ...
    public final void a() {
        if (this.f84178d || this.f84175a <= 0) {
    ...
    public final char b() {
        ...
        try {
            int read = this.f84176b.read();
            if (read <= 0) {
                this.f84177c = 0;
                return 0;
            }
            this.f84175a++;
            this.f84177c = (char) read;
            return this.f84177c;
        } catch (IOException e2) {
            throw new a((Throwable) e2);
        }
    ...
    public final java.lang.Object d() {
        ...
        L_0x005d:
            ...
            java.lang.Object r0 = org.json.a.c.f84173b
            return r0
        L_0x0068:
            r6 = 48
        ...
        L_0x00c0:
            ...
            org.json.a.a r0 = r10.a((java.lang.String) r0)
            throw r0
        L_0x00c7:
            r10.a()
            org.json.a.c r0 = new org.json.a.c
            r0.<init>((org.json.a.d) r10)
            return r0
        L_0x00d0:
            r10.a()
            org.json.a.b r0 = new org.json.a.b
            r0.<init>((org.json.a.d) r10)
            return r0
        L_0x00d9:
            java.lang.StringBuffer r1 = new java.lang.StringBuffer
        ...
        L_0x0137:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.json.a.d.d():java.lang.Object");
    }

    public final String toString() {
        return " at character " + this.f84175a;
    }
}
