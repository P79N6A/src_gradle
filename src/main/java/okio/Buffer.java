...
public final class Buffer implements Cloneable, ByteChannel, BufferedSink, BufferedSource {
    ...
    public final long readDecimalLong() {
        ...
        L_0x0049:
            ...
            r2.<init>()
            okio.Buffer r2 = r2.writeDecimalLong((long) r6)
    ...
    public final Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 6) | 192);
            writeByte((i & 63) | SearchJediMixFeedAdapter.f42517f);
        } else if (i < 65536) {
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | 224);
                writeByte(((i >> 6) & 63) | SearchJediMixFeedAdapter.f42517f);
                writeByte((i & 63) | SearchJediMixFeedAdapter.f42517f);
            } else {
                writeByte(63);
            }
            ...
            writeByte((i >> 18) | 240);
            writeByte(((i >> 12) & 63) | SearchJediMixFeedAdapter.f42517f);
            writeByte(((i >> 6) & 63) | SearchJediMixFeedAdapter.f42517f);
            writeByte((i & 63) | SearchJediMixFeedAdapter.f42517f);
        } else {
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    writeByte(((charAt >> 6) & 63) | SearchJediMixFeedAdapter.f42517f);
                    writeByte((int) (charAt & '?') | 128);
                    i++;
                } else {
                    int i6 = i + 1;
                    ...
                    if (charAt > 56319 || c2 < 56320 || c2 > 57343) {
                        ...
                        writeByte((i7 >> 18) | 240);
                        writeByte(((i7 >> 12) & 63) | SearchJediMixFeedAdapter.f42517f);
                        writeByte(((i7 >> 6) & 63) | SearchJediMixFeedAdapter.f42517f);
                        writeByte((i7 & 63) | SearchJediMixFeedAdapter.f42517f);
                        i += 2;
                    }
                }
            }
