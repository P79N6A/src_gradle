...
public class ThreadUtils {
    ...
    public static <V> V invokeAtFrontUninterruptibly(Handler handler, final Callable<V> callable) {
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            RuntimeException runtimeException = new RuntimeException(r1.f78268e);
            runtimeException.setStackTrace(concatStackTraces(r1.f78268e.getStackTrace(), runtimeException.getStackTrace()));
