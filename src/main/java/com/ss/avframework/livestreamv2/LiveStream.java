...
import com.ss.avframework.livestreamv2.filter.AudioFilterManager;
...
public class LiveStream implements AudioCapturer.AudioCaptureObserver, AudioSource.PowerObserver, MediaEncodeStream.Observer, Transport.EventObserver, ILiveStream, LiveStreamVideoCapture.Observer {
                ...
                switch (i) {
                    ...
                    case 10:
                        if (!new File(this.mFile).canRead()) {
                            ...
                            iRecorderListener.onRecorderError(i2, new Exception("Unknown record error event(" + i + "," + i2 + "," + j + "," + str + ")"));
                            return;
                        }
    ...
    public EGLContext getSharedEGLContext() {
        Handler handler;
        if (this.mVideoCapturer != null) {
            handler = this.mVideoCapturer.getHandler();
        } else {
    ...
    public List<String> getUrls() {
        ...
        if (this.mUri != null) {
            ...
            return arrayList;
        } else if (this.mUris == null || this.mUri.isEmpty()) {
            return arrayList;
        } else {
            return this.mUris;
        }
    ...
    private void invalidateOptimizedUrl() {
        if (this.mDns != null && this.mOptUrlMap != null && !this.mOptUrlMap.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(originUrl) && this.mOptUrlMap.containsKey(originUrl)) {
                ...
                AVLog.i("LiveStream", "optimized url is invalid");
            }
        }
    }
    ...
    public void doBackgroundPause() {
        if (!(this.mVideoCapturer == null || this.mLiveStreamBuilder.getBgMode() == 1)) {
    ...
    public void onVideoCaptureStarted() {
        if (this.mRecorderManager != null) {
            VideoSink sharedSink = this.mRecorderManager.getSharedSink();
    ...
    private void createEncoderStream() {
        ...
        if (this.mMediaEncodeStream == null) {
            ...
            this.mMediaEncodeStream.getAudioMixer().setEnable(this.mAudioMixer);
            this.mMediaEncodeStream.getVideoMixer().setEnable(this.mVideoMixer);
    ...
    private String chooseVideoEncode() {
        ...
        while (true) {
            ...
            if (this.mLiveStreamBuilder.getVideoEncoder() == 1) {
                if (this.mLiveStreamBuilder.isEnableVideoEncodeAccelera()) {
                    ...
                    if (str2 == null) {
                        AVLog.w("LiveStream", "Hardware video encoder not found");
                    }
                    str = str2;
                }
                if (str != null) {
        ...
        if (isEnableVideoEncodeAccelera2 && !z) {
            AVLog.w("LiveStream", "Hardware h265 encoder not found, try software h265 encoder instead.");
            this.mLiveStreamBuilder.setEnableVideoEncodeAccelera(false);
            return "video/hevc";
        } else if (isEnableVideoEncodeAccelera2 || z2) {
            return "video/hevc";
        } else {
            AVLog.w("LiveStream", "Software h265 encoder not found, try hardware h265 encoder instead.");
    ...
    private void creatVideoTrack() {
        ...
        if (videoCaptureDevice != 0) {
            this.mVideoCapturer = new LiveStreamVideoCapture(videoCaptureDevice, this.mVideoCaptureHandler, this, this.mLiveStreamBuilder.getContext());
    ...
    private void destroyEncodeStream() {
        ...
        this.mReportFence.writeLock().unlock();
        if (this.mAudioFilterManager instanceof AudioFilterManager) {
            ((AudioFilterManager) this.mAudioFilterManager).stop();
        }
    ...
    public void addTrackToEncodeStream() {
        ...
        if (this.mAudioFilterManager instanceof AudioFilterManager) {
            ((AudioFilterManager) this.mAudioFilterManager).start();
        }
    }
    ...
    public void doStartAudioSource() {
        if (this.mStatus.get() == 8) {
            ...
            AVLog.d("LiveStream", "Already start audio capture");
        }
    }
    ...
    public void doStartVideoSource() {
        if (this.mStatus.get() == 8) {
            ...
            AVLog.d("LiveStream", "Already start video capture");
        }
    }
    ...
    public synchronized void release() {
        /*
            r7 = this;
            monitor-enter(r7)
            r7.stopCaptureSource()     // Catch:{ all -> 0x007f }
            r7.stopRecord()     // Catch:{ all -> 0x007f }
            r7.stop()     // Catch:{ all -> 0x007f }
            r0 = 1
            boolean[] r1 = new boolean[r0]     // Catch:{ all -> 0x007f }
            r2 = 0
            r1[r2] = r0     // Catch:{ all -> 0x007f }
            java.util.concurrent.atomic.AtomicInteger r0 = r7.mStatus     // Catch:{ all -> 0x007f }
            int r0 = r0.get()     // Catch:{ all -> 0x007f }
            r3 = 7
            if (r0 == r3) goto L_0x0034
            android.os.Handler r0 = r7.mWorkThreadHandler     // Catch:{ all -> 0x007f }
            com.ss.avframework.livestreamv2.LiveStream$13 r4 = new com.ss.avframework.livestreamv2.LiveStream$13     // Catch:{ all -> 0x007f }
            r4.<init>(r1)     // Catch:{ all -> 0x007f }
            r0.post(r4)     // Catch:{ all -> 0x007f }
            java.lang.Object r0 = r7.mReleaseFence     // Catch:{ all -> 0x007f }
            monitor-enter(r0)     // Catch:{ all -> 0x007f }
            java.lang.Object r4 = r7.mReleaseFence     // Catch:{ Throwable -> 0x0030 }
            r5 = 3000(0xbb8, double:1.482E-320)
            r4.wait(r5)     // Catch:{ Throwable -> 0x0030 }
            goto L_0x0030
        L_0x002e:
            r1 = move-exception
            goto L_0x0032
        ...
        L_0x0034:
            java.util.concurrent.atomic.AtomicInteger r0 = r7.mStatus     // Catch:{ all -> 0x007f }
            r0.set(r3)     // Catch:{ all -> 0x007f }
            boolean r0 = r1[r2]     // Catch:{ all -> 0x007f }
            if (r0 == 0) goto L_0x004f
            com.ss.avframework.capture.audio.AudioCapturer r0 = r7.mAudioCapture     // Catch:{ all -> 0x007f }
            if (r0 == 0) goto L_0x0046
            com.ss.avframework.capture.audio.AudioCapturer r0 = r7.mAudioCapture     // Catch:{ all -> 0x007f }
            r0.stop()     // Catch:{ all -> 0x007f }
        L_0x0046:
            com.ss.avframework.livestreamv2.capture.LiveStreamVideoCapture r0 = r7.mVideoCapturer     // Catch:{ all -> 0x007f }
            if (r0 == 0) goto L_0x004f
            com.ss.avframework.livestreamv2.capture.LiveStreamVideoCapture r0 = r7.mVideoCapturer     // Catch:{ all -> 0x007f }
            r0.stop()     // Catch:{ all -> 0x007f }
        L_0x004f:
            com.ss.avframework.livestreamv2.log.LiveStreamLogService r0 = r7.mStreamLogService     // Catch:{ all -> 0x007f }
            r0.close()     // Catch:{ all -> 0x007f }
            int r0 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x007f }
            r1 = 18
            if (r0 < r1) goto L_0x006a
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ all -> 0x007f }
            if (r0 == 0) goto L_0x0073
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ Throwable -> 0x0064 }
            r0.quitSafely()     // Catch:{ Throwable -> 0x0064 }
            goto L_0x0073
        L_0x0064:
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ all -> 0x007f }
            r0.quit()     // Catch:{ all -> 0x007f }
            goto L_0x0073
        L_0x006a:
            com.ss.avframework.opengl.GLThread r0 = r7.workThread     // Catch:{ all -> 0x007f }
            if (r0 == 0) goto L_0x0073
        ...
        L_0x0073:
            r0 = 0
            r7.workThread = r0     // Catch:{ all -> 0x007f }
            android.os.HandlerThread r1 = r7.dataNotifyThread     // Catch:{ all -> 0x007f }
            r1.quit()     // Catch:{ all -> 0x007f }
            r7.dataNotifyThread = r0     // Catch:{ all -> 0x007f }
            monitor-exit(r7)
            return
        L_0x007f:
            r0 = move-exception
    ...
    private void createAudioTrack() {
        ...
        if (this.mLiveStreamBuilder.isUsingLiveStreamAudioCapture()) {
            LiveStreamAudioCapture liveStreamAudioCapture = new LiveStreamAudioCapture(audioCaptureDevice, this.mLiveStreamBuilder.getAudioCaptureSampleHZ(), this.mLiveStreamBuilder.getAudioCaptureChannel(), this.mLiveStreamBuilder.getAudioCaptureBitwidth(), null, this, this.mMediaEngineFactory);
            this.mAudioCapture = liveStreamAudioCapture;
        } else if (audioCaptureDevice != 0) {
            if (audioCaptureDevice == 2) {
                this.mAudioCapture = new AudioCapturerOpensles(this.mLiveStreamBuilder.getAudioCaptureSampleHZ(), this.mLiveStreamBuilder.getAudioCaptureChannel(), this.mLiveStreamBuilder.getAudioCaptureBitwidth(), this);
            } else if (audioCaptureDevice == 4) {
                LiveStreamAudioCapture liveStreamAudioCapture2 = new LiveStreamAudioCapture(audioCaptureDevice, this.mLiveStreamBuilder.getAudioCaptureSampleHZ(), this.mLiveStreamBuilder.getAudioCaptureChannel(), this.mLiveStreamBuilder.getAudioCaptureBitwidth(), null, this, this.mMediaEngineFactory);
                this.mAudioCapture = liveStreamAudioCapture2;
            } else if (audioCaptureDevice == 1) {
                this.mAudioCapture = new AudioCapturerAudioRecord(this.mLiveStreamBuilder.getAudioCaptureSampleHZ(), this.mLiveStreamBuilder.getAudioCaptureChannel(), this.mLiveStreamBuilder.getAudioCaptureBitwidth(), this);
            }
        }
        if (this.mAudioCapture != null) {
            if (this.mAudioDeviceModule != null) {
            ...
            if (this.mAudioFilterManager != null && (this.mAudioFilterManager instanceof AudioFilterManager)) {
    ...
    private void setupParameter() {
        ...
        if (this.mRTMPTransport != null) {
            ...
            if (this.mLiveStreamBuilder.getKcpParams() != null) {
                ...
                try {
                    ...
                    if (!kcpParams.isNull("band")) {
                        tEBundle.setInt("band", kcpParams.getInt("band"));
                    }
        ...
        if (this.mEncodeStreamOpt != null) {
            ...
            this.mEncodeStreamOpt.setInt("roi_on", this.mLiveStreamBuilder.getRoiOn());
            ...
            tEBundle2.setInt("video_is_cbr", i);
            ...
            AVLog.d("LiveStream", "Dump all encodeStream config:");
    ...
    public void setDns(final d dVar) {
        if (this.mWorkThreadHandler != null) {
            this.mWorkThreadHandler.post(new Runnable() {
                public void run() {
                    boolean z;
        ...
        if (this.mStatus.get() != 7) {
            this.mWorkThreadHandler.post(new Runnable() {
                public void run() {
                    ...
                    LiveStream.this.mErrorListener.onError(2, 0, new Exception("Maybe video capture already to stoped."));
                }
            });
        }
    }
    ...
    private String getStackTrack(String str) {
        ...
        for (StackTraceElement stackTraceElement : Thread.currentThread().getStackTrace()) {
            str2 = str2 + str + "    at " + stackTraceElement.getClassName() + ClassUtils.PACKAGE_SEPARATOR + stackTraceElement.getMethodName() + "(" + stackTraceElement.getFileName() + " :" + stackTraceElement.getLineNumber() + ")\n";
        }
        return str2;
    }
        ...
        if (mediaEncodeStream != null) {
            if (z) {
                synchronized (this.mInputStreamListFence) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (next instanceof InputVideoStream) {
                            videoTrack = ((InputVideoStream) next).getVideoTrack();
                        } else {
                            videoTrack = null;
                        }
                        if (videoTrack != null) {
            ...
            synchronized (this.mInputStreamListFence) {
                ...
                while (it3.hasNext()) {
                    ...
                    if (next2 instanceof InputAudioStream) {
                        audioTrack = ((InputAudioStream) next2).getAudioTrack();
                    } else if (next2 instanceof FilterManager.EffectInputAudioStream) {
                        audioTrack = ((FilterManager.EffectInputAudioStream) next2).getAudioTrack();
                    } else {
                        audioTrack = null;
                    }
                    if (audioTrack != null) {
    ...
    public void startRecorder(final String str) {
        ...
        if (!z && this.mRecorderManager != null) {
            IRecorderManager externRecordMgr = this.mRecorderManager.getExternRecordMgr();
            if (externRecordMgr instanceof SharedEncoderRecorder) {
    ...
    private void adjustParameters(LiveStreamBuilder liveStreamBuilder) {
        ...
        if (this.mLiveStreamBuilder.getVsyncModuleMaxIntevalOnFrameMs() < 300) {
            this.mLiveStreamBuilder.setVsyncModuleMaxIntevalOnFrameMs(c.f69428f);
        }
        if (vsyncModuleMaxIntevalOnNowMs < 300) {
            this.mLiveStreamBuilder.setVsyncModuleMaxIntevalOnNowMs(c.f69428f);
        }
    ...
    private void disableVideoEncoder(String str, boolean z) {
        if (this.mAvailableVideoEncoders != null) {
            for (int i = 0; i < this.mAvailableVideoEncoders.length; i++) {
                ...
                if (str2.contains("video_type=" + str) && z == this.mAvailableVideoEncoders[i].contains("video_enable_accelera=true")) {
    ...
    public void enableMixer(boolean z, boolean z2) {
        if (this.mMediaEncodeStream != null) {
            if (z) {
                this.mMediaEncodeStream.getAudioMixer().setEnable(z2);
            } else {
                this.mMediaEncodeStream.getVideoMixer().setEnable(z2);
            }
        }
        if (z) {
            this.mAudioMixer = z2;
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.lang.String[] getOptUrlAndEvaluateSymbol(com.ss.optimizer.live.sdk.dns.d r13, java.lang.String r14) {
        /*
            r12 = this;
        ...
        L_0x0040:
            ...
            java.lang.String r3 = com.ss.optimizer.live.sdk.dns.b.a(r2, r13)
        ...
        L_0x0093:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.avframework.livestreamv2.LiveStream.getOptUrlAndEvaluateSymbol(com.ss.optimizer.live.sdk.dns.d, java.lang.String):java.lang.String[]");
    }

    protected LiveStream(LiveStreamBuilder liveStreamBuilder, Handler handler, Handler handler2) {
        this(liveStreamBuilder, handler, handler2, null);
    }

    public void onAVFrameSyncError(int i, int i2, long j) {
        if (i == 8) {
            AVLog.e("LiveStream", "avSync error before encoding: audio timestamp " + (((long) i2) + j) + ", video timestamp " + j);
        }
    }
    ...
    public void onEncodeCreateEvent(int i, int i2, long j) {
        ...
        if (i == 4) {
            ...
            iLiveStreamErrorListener.onError(6, 0, new Exception("Audio encoder(" + string + ") created failed"));
            return;
        }
        if (i == 2) {
            String str = "";
            if (this.mMediaEncodeStream != null) {
                str = this.mEncodeStreamOpt.getString("video_type");
                int i3 = 1;
                if (this.mLiveStreamBuilder.getVideoEncoder() == 1) {
                    ...
                    if (bool) {
                        ...
                        if (videoProfile == 1) {
                            ...
                            z = bool;
                            i4 = 1;
                            this.mEncodeStreamOpt.setString("video_type", str);
                            ...
                            this.mLiveStreamBuilder.setVideoProfile(i4);
                            if (!(this.mRTMPTransport == null || this.mTransportOpt == null)) {
                                this.mTransportOpt.setString("video_type", str);
                                this.mTransportOpt.setBool("video_enable_accelera", z);
                                this.mTransportOpt.setInt("video_profileLevel", i3);
                                this.mRTMPTransport.setParameter(this.mTransportOpt);
                            }
                    ...
                    if (this.mLiveStreamBuilder.getVideoProfile() == 1) {
                        disableVideoEncoder(str, this.mLiveStreamBuilder.isEnableVideoEncodeAccelera());
                        str = chooseVideoEncode();
                    } else {
                        this.mLiveStreamBuilder.setVideoProfile(1);
                    }
            ...
            ILiveStream.ILiveStreamErrorListener iLiveStreamErrorListener2 = this.mErrorListener;
            iLiveStreamErrorListener2.onError(5, 0, new Exception("Video encoder(" + str + ") created failed"));
        }
    }
            ...
            if (this.mUri == null) {
                if (this.mUris != null) {
                    if (isUsingOptimizedUrl()) {
                        ...
                        this.mWorkThreadHandler.postDelayed(this.rtmpReconnectRunnable, (long) (this.mLiveStreamBuilder.getRtmpReconnectIntervalSeconds() * PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE));
                    } else if (this.mUriReachable != 0 && this.mRtmpReConnectCounts < this.mLiveStreamBuilder.getRtmpReconnectCounts()) {
                        this.mWorkThreadHandler.postDelayed(this.rtmpReconnectRunnable, (long) (this.mLiveStreamBuilder.getRtmpReconnectIntervalSeconds() * PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE));
                    } else if (this.mUris.size() <= 1) {
                        this.mErrorListener.onError(4, i, new Exception("Rtmp connection fail"));
                        AVLog.i("LiveStream", "All urls are used up!");
                        doStop();
                    } else {
                        this.mUris.remove(0);
                        this.mUriReachable = -1;
                        ...
                        this.mEvaluatorSymbol = "";
                        this.mWorkThreadHandler.postDelayed(this.rtmpReconnectRunnable, (long) (this.mLiveStreamBuilder.getRtmpReconnectIntervalSeconds() * PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE));
                        AVLog.i("LiveStream", "Switched to next url: " + getLiveStreamUrl());
                    }
                }
                ...
                this.mWorkThreadHandler.postDelayed(this.rtmpReconnectRunnable, (long) (this.mLiveStreamBuilder.getRtmpReconnectIntervalSeconds() * PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE));
            } else if (this.mRtmpReConnectCounts < this.mLiveStreamBuilder.getRtmpReconnectCounts()) {
                this.mWorkThreadHandler.postDelayed(this.rtmpReconnectRunnable, (long) (this.mLiveStreamBuilder.getRtmpReconnectIntervalSeconds() * PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE));
            } else {
                this.mErrorListener.onError(4, i, new Exception("Rtmp connection fail"));
                doStop();
                    ...
                    switch (i3) {
                        ...
                        case 3:
                            if (LiveStream.this.mRtmpReConnectCounts >= LiveStream.this.mLiveStreamBuilder.getRtmpReconnectCounts()) {
                                LiveStream.this.mStreamLogService.onRTMPEnd(i4, LiveStream.this.mRtmpReConnectCounts, LiveStream.this.mFirstConnect, null, 0);
                            }
                        ...
                        case 4:
                            ...
                            LiveStream.this.mStreamLogService.onPushStreamFail(i4, "avSync error: audio pts " + j5 + ", video pts " + r5 + " last vpts " + j6 + " video maxFI " + j + " bgm " + z + " CurrTimeMs " + nowNanos + " vFirst " + j3 + " aFirst " + j2);
                            LiveStream.this.onRtmpFailed(i3, i4, j2);
                            return;
                        case 5:
    ...
    protected LiveStream(LiveStreamBuilder liveStreamBuilder, Handler handler, Handler handler2, AudioDeviceModule audioDeviceModule) {
        ...
        if (this.mLiveStreamBuilder.getEffectModePath() == null) {
            this.mFilterManager = FilterManager.createDummy();
        } else {
            this.mFilterManager = FilterManager.create(new FilterManager.InputAudioStreamObserver() {
            ...
            }, this.mLiveStreamBuilder.getContext(), handler2);
        }
        this.mAudioFilterManager = AudioFilterManager.createDummy();
    ...
    public void vsyncEvent(VsyncModule vsyncModule, int i, int i2, long j, String str) {
        switch (i) {
            case 100:
                AVLog.e("LiveStream", "Timestamp exception(diff:" + i2 + ") at track(" + str + ") with reset stream");
                vsyncModule.reset(str);
                break;
            case BaseLoginOrRegisterActivity.o:
                AVLog.e("LiveStream", "Timestamp exception(diff:" + i2 + ") at track(" + str + ")");
                return;
        }
    }
