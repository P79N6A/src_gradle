...
public class FrameRender {
    ...
    private native int nativeDraw(long j, int i, long j2, int i2, double d2, boolean z, boolean z2);
    ...
    public int drawFrame(int i, long j, EffectRender.Rotation rotation, int i2, boolean z, boolean z2) {
        if (!this.mInited) {
            return -1;
        }
        if (i <= 0) {
        ...
        double d2 = (double) i2;
        Double.isNaN(d2);
        return nativeDraw(j2, i, j, i3, (d2 * 3.141592653589793d) / 180.0d, z, z2);
    }

    public void onNativeCallBack_OnFrameAvailable(int i, long j, int i2, int i3, int i4, int i5) {
        if (this.mGLCallback != null) {
