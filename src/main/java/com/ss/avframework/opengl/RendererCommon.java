...
public class RendererCommon {
    ...
    public static float[] getLayoutMatrix(boolean z, float f2, float f3) {
        ...
        android.opengl.Matrix.scaleM(fArr, 0, f5, f4, 1.0f);
        adjustOrigin(fArr);
        return fArr;
    }
    ...
    public static void calcWindRatio(boolean r0, boolean r1, boolean r2, int r3, int r4, int r5, int r6, float[] r7) {
        ...
        L_0x0037:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.avframework.opengl.RendererCommon.calcWindRatio(boolean, boolean, boolean, int, int, int, int, float[]):void");
    }
}
