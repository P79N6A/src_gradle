...
public final class d {
    ...
    public static java.util.List<com.ss.android.chooser.f> a(android.content.Context r11) {
        /*
        ...
        L_0x0034:
            ...
            r3.i = r4     // Catch:{ Throwable -> 0x006f, all -> 0x0069 }
            int r4 = r2.getIntrinsicHeight()     // Catch:{ Throwable -> 0x006f, all -> 0x0069 }
            r3.j = r4     // Catch:{ Throwable -> 0x006f, all -> 0x0069 }
            int r4 = r2.c()     // Catch:{ Throwable -> 0x006f, all -> 0x0069 }
        ...
        L_0x0060:
            r4 = 0
        L_0x0061:
            r2.a()     // Catch:{ Throwable -> 0x0070, all -> 0x0067 }
        ...
        L_0x0073:
            ...
            r3.f27990b = r1     // Catch:{ all -> 0x0087 }
            r3.f27991c = r4     // Catch:{ all -> 0x0087 }
            r3.f27992d = r9     // Catch:{ all -> 0x0087 }
        ...
        L_0x0090:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.chooser.d.a(android.content.Context):java.util.List");
    }

    /* JADX WARNING: Removed duplicated region for block: B:26:0x00a4  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.List<com.ss.android.chooser.f> b(android.content.Context r18) {
        /*
            java.util.ArrayList r0 = new java.util.ArrayList
            r0.<init>()
            java.lang.String r6 = "datetaken DESC"
        ...
        L_0x0042:
            ...
            boolean r15 = com.bytedance.common.utility.StringUtils.isEmpty(r4)     // Catch:{ all -> 0x009e }
            ...
            r12.f27990b = r4     // Catch:{ all -> 0x009e }
            r12.f27991c = r5     // Catch:{ all -> 0x009e }
            r12.g = r14     // Catch:{ all -> 0x009e }
            r12.f27993e = r9     // Catch:{ all -> 0x009e }
            r12.f27994f = r7     // Catch:{ all -> 0x009e }
            r2 = 1
            r12.f27992d = r2     // Catch:{ all -> 0x009e }
            r12.h = r11     // Catch:{ all -> 0x009e }
        ...
        L_0x00a7:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.chooser.d.b(android.content.Context):java.util.List");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.List<com.ss.android.chooser.f> a(android.content.Context r19, boolean r20) {
        /*
        ...
        L_0x004d:
            ...
            r12.f27990b = r0     // Catch:{ all -> 0x00e2 }
            r12.f27991c = r5     // Catch:{ all -> 0x00e2 }
            r12.f27994f = r14     // Catch:{ all -> 0x00e2 }
            r12.h = r11     // Catch:{ all -> 0x00e2 }
            if (r7 == 0) goto L_0x00b6
            java.lang.String r3 = "gif"
            boolean r3 = r7.contains(r3)     // Catch:{ all -> 0x00e2 }
            if (r3 == 0) goto L_0x00b6
            r12.f27992d = r10     // Catch:{ all -> 0x00e2 }
            ...
            r12.i = r0     // Catch:{ Throwable -> 0x00b2, all -> 0x00ac }
            int r0 = r3.getIntrinsicHeight()     // Catch:{ Throwable -> 0x00b2, all -> 0x00ac }
            r12.j = r0     // Catch:{ Throwable -> 0x00b2, all -> 0x00ac }
            int r0 = r3.c()     // Catch:{ Throwable -> 0x00b2, all -> 0x00ac }
        ...
        L_0x00a3:
            r4 = 0
        L_0x00a4:
            r3.a()     // Catch:{ Throwable -> 0x00b3, all -> 0x00aa }
        ...
        L_0x00b3:
            ...
            goto L_0x00d5
        L_0x00b6:
            r12.f27992d = r8     // Catch:{ all -> 0x00e2 }
            android.util.Pair r0 = a((java.lang.String) r0)     // Catch:{ all -> 0x00e2 }
        ...
        L_0x00eb:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.chooser.d.a(android.content.Context, boolean):java.util.List");
    }
}
