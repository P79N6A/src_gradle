...
public final class i {
    ...
    private static List<String> f27923a = new ArrayList();
    ...
    public static synchronized boolean a(android.content.Context r8, java.lang.String r9) {
        /*
            java.lang.Class<com.ss.android.agilelogger.f.i> r0 = com.ss.android.agilelogger.f.i.class
            monitor-enter(r0)
            java.util.List<java.lang.String> r1 = f27923a     // Catch:{ all -> 0x0073 }
        ...
        L_0x000e:
            ...
            java.util.List<java.lang.String> r3 = f27923a     // Catch:{ UnsatisfiedLinkError -> 0x001a, Throwable -> 0x0018 }
        ...
        L_0x0063:
            ...
            java.util.List<java.lang.String> r8 = f27923a     // Catch:{ Throwable -> 0x0071 }
        ...
        L_0x0073:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.agilelogger.f.i.a(android.content.Context, java.lang.String):boolean");
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (read > 0) {
                            ...
                            d.a("android.os.FileUtils", "setPermissions", file.getAbsolutePath(), 493, -1, -1);
