...
public class VEVideoCompileEncodeSettings implements Parcelable {
    ...
    public String toString() {
        return "VEVideoCompileEncodeSettings{useHWEncoder=" + this.useHWEncoder + ", mHWEncodeSetting=" + this.mHWEncodeSetting + ", mSWEncodeSetting=" + this.mSWEncodeSetting + '}';
    }
    ...
    protected VEVideoCompileEncodeSettings(Parcel parcel) {
        ...
        this.useHWEncoder = z;
        this.isSupportHWEncoder = parcel.readByte() != 0 ? true : z2;
