...
public final class Frame extends Message<Frame, Builder> implements Parcelable, a {
    ...
    public static final class Builder extends Message.Builder<Frame, Builder> {
        ...
        public final Frame build() {
            if (this.seqid == null || this.logid == null || this.service == null || this.method == null) {
                throw Internal.missingRequiredFields(this.seqid, "seqid", this.logid, "logid", this.service, "service", this.method, PushConstants.MZ_PUSH_MESSAGE_METHOD);
            }
    ...
    public final Map<String, String> getMsgHeaders() {
        ...
        for (ExtendedEntry next : this.headers) {
            if (next != null) {
