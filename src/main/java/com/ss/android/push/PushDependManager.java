...
public class PushDependManager implements IPushDepend {
    ...
    private java.lang.String getCurProcessNameFromProc() {
        ...
        L_0x0070:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.push.PushDependManager.getCurProcessNameFromProc():java.lang.String");
    }
    ...
    public String getCurProcessName(Context context) {
        ...
        try {
            ...
            for (ActivityManager.RunningAppProcessInfo next : ((ActivityManager) context.getSystemService(PushConstants.INTENT_ACTIVITY_NAME)).getRunningAppProcesses()) {
                if (next.pid == myPid) {
                    if (loggerDebug()) {
                        loggerD("Process", "processName = " + next.processName);
                    }
