...
public final class UserStateInsFollowVideoViewHolderPlanB extends InsFollowVideoViewHolderPlanB {
    ...
    public final String g() {
        if (PatchProxy.isSupport(new Object[0], this, f57379b, false, 61853, new Class[0], String.class)) {
            return (String) PatchProxy.accessDispatch(new Object[0], this, f57379b, false, 61853, new Class[0], String.class);
        }
        Aweme aweme = this.j;
    ...
    public UserStateInsFollowVideoViewHolderPlanB(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull l lVar, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar2, @NotNull d dVar, boolean z) {
