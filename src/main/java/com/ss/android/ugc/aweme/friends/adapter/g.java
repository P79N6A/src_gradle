...
public final class g implements l {
    ...
    public final View a(Context context, int i) {
        ...
        if (PatchProxy.isSupport(new Object[]{context2, Integer.valueOf(i)}, this, f48800a, false, 46307, new Class[]{Context.class, Integer.TYPE}, View.class)) {
            return (View) PatchProxy.accessDispatch(new Object[]{context2, Integer.valueOf(i)}, this, f48800a, false, 46307, new Class[]{Context.class, Integer.TYPE}, View.class);
        }
    ...
    public final View a(Context context, ViewGroup viewGroup, PagerAdapter pagerAdapter, int i, int i2, View.OnClickListener onClickListener) {
        ...
        if (PatchProxy.isSupport(new Object[]{context2, viewGroup, pagerAdapter, Integer.valueOf(i), Integer.valueOf(i2), onClickListener2}, this, f48800a, false, 46306, new Class[]{Context.class, ViewGroup.class, PagerAdapter.class, Integer.TYPE, Integer.TYPE, View.OnClickListener.class}, View.class)) {
            Object[] objArr = {context2, viewGroup, pagerAdapter, Integer.valueOf(i), Integer.valueOf(i2), onClickListener2};
            return (View) PatchProxy.accessDispatch(objArr, this, f48800a, false, 46306, new Class[]{Context.class, ViewGroup.class, PagerAdapter.class, Integer.TYPE, Integer.TYPE, View.OnClickListener.class}, View.class);
        }
