...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u0015\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0016\u0018\u00002\u00020\u0001B%\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\u0006\u0010\b\u001a\u00020\t¢\u0006\u0002\u0010\nJ\u0018\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000eH\u0016J \u0010\u0010\u001a\u00020\f2\u0006\u0010\u0011\u001a\u00020\u000e2\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u0015H\u0002J\"\u0010\u0016\u001a\u00020\f2\b\u0010\u0002\u001a\u0004\u0018\u00010\u00172\u0006\u0010\u0018\u001a\u00020\u000e2\u0006\u0010\u0019\u001a\u00020\u000eH\u0014¨\u0006\u001a"}, d2 = {"Lcom/ss/android/ugc/aweme/newfollow/vh/InsFollowImageViewHolderPlanC;", "Lcom/ss/android/ugc/aweme/newfollow/vh/InsFollowImageViewHolder;", "view", "Lcom/ss/android/ugc/aweme/newfollow/ui/FollowFeedLayout;", "provider", "Lcom/ss/android/ugc/aweme/forward/callback/IContainerStatusProvider;", "scrollStateManager", "Lcom/ss/android/ugc/aweme/newfollow/util/RecyclerViewScrollStateManager;", "diggAwemeListener", "Lcom/ss/android/ugc/aweme/newfollow/callback/DiggAwemeListener;", "(Lcom/ss/android/ugc/aweme/newfollow/ui/FollowFeedLayout;Lcom/ss/android/ugc/aweme/forward/callback/IContainerStatusProvider;Lcom/ss/android/ugc/aweme/newfollow/util/RecyclerViewScrollStateManager;Lcom/ss/android/ugc/aweme/newfollow/callback/DiggAwemeListener;)V", "adjustImageViewRegion", "", "layoutWidth", "", "layoutHeight", "calNewMediaItemSize", "screenWidth", "ratioHW", "", "dstSize", "", "updateMediaItemLayoutParams", "Landroid/view/View;", "mediaWidth", "mediaHeight", "main_douyinCnRelease"}, k = 1, mv = {1, 1, 15})
public class InsFollowImageViewHolderPlanC extends InsFollowImageViewHolder {
    ...
    public final void a(@Nullable View view, int i, int i2) {
        ...
        View view2 = view;
        if (PatchProxy.isSupport(new Object[]{view2, Integer.valueOf(i), Integer.valueOf(i2)}, this, V, false, 62430, new Class[]{View.class, Integer.TYPE, Integer.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view2, Integer.valueOf(i), Integer.valueOf(i2)}, this, V, false, 62430, new Class[]{View.class, Integer.TYPE, Integer.TYPE}, Void.TYPE);
            return;
        }
        if (view2 != null) {
        ...
        if (layoutParams != null) {
            ...
            int i3 = iArr[0];
            int i4 = iArr[1];
            if (PatchProxy.isSupport(new Object[]{Integer.valueOf(i3), Integer.valueOf(i4)}, this, V, false, 62431, new Class[]{Integer.TYPE, Integer.TYPE}, Void.TYPE)) {
                PatchProxy.accessDispatch(new Object[]{Integer.valueOf(i3), Integer.valueOf(i4)}, this, V, false, 62431, new Class[]{Integer.TYPE, Integer.TYPE}, Void.TYPE);
            } else {
                Aweme aweme = this.j;
                Intrinsics.checkExpressionValueIsNotNull(aweme, "mAweme");
                ImageInfo imageInfo = aweme.getImageInfos().get(0);
                Intrinsics.checkExpressionValueIsNotNull(imageInfo, "mAweme.imageInfos[0]");
                int width = imageInfo.getWidth();
                Aweme aweme2 = this.j;
                Intrinsics.checkExpressionValueIsNotNull(aweme2, "mAweme");
                ImageInfo imageInfo2 = aweme2.getImageInfos().get(0);
                Intrinsics.checkExpressionValueIsNotNull(imageInfo2, "mAweme.imageInfos[0]");
                if (((float) imageInfo2.getHeight()) / ((float) width) > 1.5933334f) {
                    ...
                    viewGroup.setBackgroundColor(X.getResources().getColor(C0906R.color.a25));
    ...
    public InsFollowImageViewHolderPlanC(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull l lVar, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar2) {
