...
public final class UserStateInsForwardImageViewHolderPlanB extends InsForwardImageViewHolderPlanB {
    ...
    public final String q() {
        if (PatchProxy.isSupport(new Object[0], this, u, false, 61858, new Class[0], String.class)) {
            return (String) PatchProxy.accessDispatch(new Object[0], this, u, false, 61858, new Class[0], String.class);
        }
    ...
    public UserStateInsForwardImageViewHolderPlanB(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull l lVar, @NotNull BaseFollowViewHolder.a aVar2, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar3, boolean z) {
