...
import com.ss.android.ugc.aweme.newfollow.adapter.FollowFlowItemImageForwardViewHolder;
...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\b\n\u0002\b\u0002\b\u0016\u0018\u00002\u00020\u0001B-\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007\u0012\u0006\u0010\b\u001a\u00020\t\u0012\u0006\u0010\n\u001a\u00020\u000b¢\u0006\u0002\u0010\fJ\u001a\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0014H\u0014J\b\u0010\u0015\u001a\u00020\u0010H\u0014J\b\u0010\u0016\u001a\u00020\u0010H\u0016J\u001a\u0010\u0017\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0014H\u0014J\b\u0010\u0018\u001a\u00020\u0010H\u0014J\b\u0010\u0019\u001a\u00020\u0010H\u0016J\b\u0010\u001a\u001a\u00020\u0010H\u0014J\u000e\u0010\u001b\u001a\b\u0012\u0004\u0012\u00020\u001d0\u001cH\u0014J\b\u0010\u001e\u001a\u00020\u0010H\u0014J\u0010\u0010\u001f\u001a\u00020\u00102\u0006\u0010 \u001a\u00020!H\u0014J\b\u0010\"\u001a\u00020#H\u0016J\b\u0010$\u001a\u00020\u0010H\u0014J\b\u0010%\u001a\u00020\u0010H\u0014J\b\u0010&\u001a\u00020\u0010H\u0014J\"\u0010'\u001a\u00020\u00102\b\u0010(\u001a\u0004\u0018\u00010!2\u0006\u0010)\u001a\u00020*2\u0006\u0010+\u001a\u00020*H\u0014R\u000e\u0010\r\u001a\u00020\u000eX\u0004¢\u0006\u0002\n\u0000¨\u0006,"}, d2 = {"Lcom/ss/android/ugc/aweme/newfollow/vh/InsForwardImageViewHolder;", "Lcom/ss/android/ugc/aweme/newfollow/adapter/FollowFlowItemImageForwardViewHolder;", "itemView", "Lcom/ss/android/ugc/aweme/newfollow/ui/FollowFeedLayout;", "provider", "Lcom/ss/android/ugc/aweme/forward/callback/IContainerStatusProvider;", "scrollStateManager", "Lcom/ss/android/ugc/aweme/newfollow/util/RecyclerViewScrollStateManager;", "itemViewInteractListener", "Lcom/ss/android/ugc/aweme/newfollow/vh/BaseFollowViewHolder$ItemViewInteractListener;", "diggAwemeListener", "Lcom/ss/android/ugc/aweme/newfollow/callback/DiggAwemeListener;", "(Lcom/ss/android/ugc/aweme/newfollow/ui/FollowFeedLayout;Lcom/ss/android/ugc/aweme/forward/callback/IContainerStatusProvider;Lcom/ss/android/ugc/aweme/newfollow/util/RecyclerViewScrollStateManager;Lcom/ss/android/ugc/aweme/newfollow/vh/BaseFollowViewHolder$ItemViewInteractListener;Lcom/ss/android/ugc/aweme/newfollow/callback/DiggAwemeListener;)V", "liveContentLayout", "Lcom/bytedance/ies/dmt/ui/widget/DmtTextView;", "bindDescView", "", "descView", "Lcom/ss/android/ugc/aweme/views/MentionTextView;", "aweme", "Lcom/ss/android/ugc/aweme/feed/model/Aweme;", "bindExtraView", "bindForwardView", "bindOriginDescView", "bindShareView", "bindStatisticsView", "expandImage", "getExtraDialogString", "", "", "handleOriginHeaderClick", "inflateStub", "root", "Landroid/view/View;", "isMomentStyle", "", "setOriginContentRoundCorner", "showTimeText", "updateDividerLine", "updateOriginContentLayoutParams", "contentView", "mediaWidth", "", "mediaHeight", "main_douyinCnRelease"}, k = 1, mv = {1, 1, 15})
public class InsForwardImageViewHolder extends FollowFlowItemImageForwardViewHolder {
    ...
    static final class a implements MentionTextView.e {
        ...
        final /* synthetic */ InsForwardImageViewHolder f57637b;

        a(InsForwardImageViewHolder insForwardImageViewHolder) {
            this.f57637b = insForwardImageViewHolder;
        }

        public final void a(View view, TextExtraStruct textExtraStruct) {
            if (PatchProxy.isSupport(new Object[]{view, textExtraStruct}, this, f57636a, false, 62553, new Class[]{View.class, TextExtraStruct.class}, Void.TYPE)) {
                PatchProxy.accessDispatch(new Object[]{view, textExtraStruct}, this, f57636a, false, 62553, new Class[]{View.class, TextExtraStruct.class}, Void.TYPE);
                return;
            }
            if (this.f57637b.f48318c != null) {
                this.f57637b.f48318c.a(view, textExtraStruct, this.f57637b.itemView, this.f57637b.f48319d);
            }
        }
    }
    ...
    static final class b implements MentionTextView.e {
        ...
        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ InsForwardImageViewHolder f57639b;

        b(InsForwardImageViewHolder insForwardImageViewHolder) {
            this.f57639b = insForwardImageViewHolder;
        }

        public final void a(View view, TextExtraStruct textExtraStruct) {
            if (PatchProxy.isSupport(new Object[]{view, textExtraStruct}, this, f57638a, false, 62554, new Class[]{View.class, TextExtraStruct.class}, Void.TYPE)) {
                PatchProxy.accessDispatch(new Object[]{view, textExtraStruct}, this, f57638a, false, 62554, new Class[]{View.class, TextExtraStruct.class}, Void.TYPE);
                return;
            }
            if (this.f57639b.f48318c != null) {
                this.f57639b.f48318c.a(view, textExtraStruct, this.f57639b.itemView, this.f57639b.f48319d);
            }
        }
    }
    ...
    public final void P() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62551, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62551, new Class[0], Void.TYPE);
            return;
        }
    ...
    public final void o() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62550, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62550, new Class[0], Void.TYPE);
            return;
        }
        AbTestManager a2 = AbTestManager.a();
        Intrinsics.checkExpressionValueIsNotNull(a2, "AbTestManager.getInstance()");
    ...
    public final void x() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62540, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62540, new Class[0], Void.TYPE);
            return;
        }
        C();
        E();
    ...
    public final void z() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62545, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62545, new Class[0], Void.TYPE);
            return;
        }
    ...
    public final void D() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62547, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62547, new Class[0], Void.TYPE);
            return;
        }
    ...
    public final void E() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62541, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62541, new Class[0], Void.TYPE);
            return;
        }
        Aweme aweme = this.f48319d;
        Intrinsics.checkExpressionValueIsNotNull(aweme, "mAweme");
    ...
    public final List<String> K() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62543, new Class[0], List.class)) {
            return (List) PatchProxy.accessDispatch(new Object[0], this, w, false, 62543, new Class[0], List.class);
        }
    ...
    public final void v() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62542, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62542, new Class[0], Void.TYPE);
            return;
        }
    ...
    public final void w() {
        if (PatchProxy.isSupport(new Object[0], this, w, false, 62549, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, w, false, 62549, new Class[0], Void.TYPE);
            return;
        }
        Context c2 = c();
        Aweme aweme = this.f48319d;
    ...
    public void b(@NotNull View view) {
        if (PatchProxy.isSupport(new Object[]{view}, this, w, false, 62539, new Class[]{View.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view}, this, w, false, 62539, new Class[]{View.class}, Void.TYPE);
            return;
        }
    ...
    public final void a(@NotNull MentionTextView mentionTextView, @Nullable Aweme aweme) {
        ...
        if (PatchProxy.isSupport(new Object[]{mentionTextView2, aweme}, this, w, false, 62546, new Class[]{MentionTextView.class, Aweme.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{mentionTextView2, aweme}, this, w, false, 62546, new Class[]{MentionTextView.class, Aweme.class}, Void.TYPE);
            return;
        }
    ...
    public final void b(@NotNull MentionTextView mentionTextView, @Nullable Aweme aweme) {
        if (PatchProxy.isSupport(new Object[]{mentionTextView, aweme}, this, w, false, 62544, new Class[]{MentionTextView.class, Aweme.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{mentionTextView, aweme}, this, w, false, 62544, new Class[]{MentionTextView.class, Aweme.class}, Void.TYPE);
            return;
        }
    ...
    public void a(@Nullable View view, int i, int i2) {
        ...
        View view2 = view;
        if (PatchProxy.isSupport(new Object[]{view2, Integer.valueOf(i), Integer.valueOf(i2)}, this, w, false, 62548, new Class[]{View.class, Integer.TYPE, Integer.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view2, Integer.valueOf(i), Integer.valueOf(i2)}, this, w, false, 62548, new Class[]{View.class, Integer.TYPE, Integer.TYPE}, Void.TYPE);
            return;
        }
        int[] iArr = new int[2];
    ...
    public InsForwardImageViewHolder(@NotNull FollowFeedLayout followFeedLayout, @NotNull com.ss.android.ugc.aweme.forward.a.a aVar, @NotNull l lVar, @NotNull BaseFollowViewHolder.a aVar2, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar3) {
        super(followFeedLayout, aVar, lVar, aVar2, aVar3, true);
        ...
        this.u.setOnClickListener(new View.OnClickListener(this) {
            ...
            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ InsForwardImageViewHolder f57635b;
            ...
            public final void onClick(View view) {
                if (PatchProxy.isSupport(new Object[]{view}, this, f57634a, false, 62552, new Class[]{View.class}, Void.TYPE)) {
                    PatchProxy.accessDispatch(new Object[]{view}, this, f57634a, false, 62552, new Class[]{View.class}, Void.TYPE);
                    return;
                }
