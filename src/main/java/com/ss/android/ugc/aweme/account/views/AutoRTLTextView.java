...
public class AutoRTLTextView extends DmtTextView {
    ...
    public AutoRTLTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (PatchProxy.isSupport(new Object[]{context}, this, f33165a, false, 21514, new Class[]{Context.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{context}, this, f33165a, false, 21514, new Class[]{Context.class}, Void.TYPE);
            return;
        }
