...
public class RemoteRoundImageView extends AnimatedImageView {
    ...
    public static ChangeQuickRedirect f58131f;

    public final void a() {
        if (PatchProxy.isSupport(new Object[0], this, f58131f, false, 63295, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, f58131f, false, 63295, new Class[0], Void.TYPE);
            return;
        }
        super.a();
