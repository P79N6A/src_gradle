...
public class InsForwardVideoViewHolderPlanA extends InsForwardVideoViewHolder {
    ...
    public final void b(@NotNull View view) {
        if (PatchProxy.isSupport(new Object[]{view}, this, x, false, 62581, new Class[]{View.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view}, this, x, false, 62581, new Class[]{View.class}, Void.TYPE);
            return;
        }
    ...
    public void a(@Nullable View view, int i, int i2) {
        ...
        View view2 = view;
        if (PatchProxy.isSupport(new Object[]{view2, Integer.valueOf(i), Integer.valueOf(i2)}, this, x, false, 62584, new Class[]{View.class, Integer.TYPE, Integer.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view2, Integer.valueOf(i), Integer.valueOf(i2)}, this, x, false, 62584, new Class[]{View.class, Integer.TYPE, Integer.TYPE}, Void.TYPE);
            return;
        }
        if (view2 != null) {
    ...
    public void a(int r25, int r26, float r27, float r28, @org.jetbrains.annotations.NotNull int[] r29) {
        /*
            ...
            r8 = 0
            r9 = 62585(0xf479, float:8.77E-41)
            r6 = r24
            ...
            r20 = 0
            r21 = 62585(0xf479, float:8.77E-41)
        ...
        L_0x00e3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.android.ugc.aweme.newfollow.vh.InsForwardVideoViewHolderPlanA.a(int, int, float, float, int[]):void");
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InsForwardVideoViewHolderPlanA(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull d dVar, @NotNull l lVar, @NotNull BaseFollowViewHolder.a aVar2, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar3) {
