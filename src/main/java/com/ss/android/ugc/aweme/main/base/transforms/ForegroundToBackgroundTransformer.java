...
public class ForegroundToBackgroundTransformer extends ABaseTransformer {
    ...
    public static ChangeQuickRedirect f54568b;
    ...
    public final void a(View view, float f2) {
        View view2 = view;
        boolean z = false;
        if (PatchProxy.isSupport(new Object[]{view2, Float.valueOf(f2)}, this, f54568b, false, 57949, new Class[]{View.class, Float.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view2, Float.valueOf(f2)}, this, f54568b, false, 57949, new Class[]{View.class, Float.TYPE}, Void.TYPE);
            return;
        }
        if (f2 < 0.0f) {
            z = true;
