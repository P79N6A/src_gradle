...
public class EllipsizeLayout extends LinearLayout {
    ...
    public void onMeasure(int i, int i2) {
        boolean z;
        boolean z2 = true;
        if (PatchProxy.isSupport(new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}, this, f49865a, false, 49839, new Class[]{Integer.TYPE, Integer.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}, this, f49865a, false, 49839, new Class[]{Integer.TYPE, Integer.TYPE}, Void.TYPE);
            return;
        }
