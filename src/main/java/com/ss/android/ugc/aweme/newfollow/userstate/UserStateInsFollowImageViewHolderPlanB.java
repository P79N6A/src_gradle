...
public final class UserStateInsFollowImageViewHolderPlanB extends InsFollowImageViewHolderPlanB {
    ...
    public final String g() {
        if (PatchProxy.isSupport(new Object[0], this, f57369b, false, 61848, new Class[0], String.class)) {
            return (String) PatchProxy.accessDispatch(new Object[0], this, f57369b, false, 61848, new Class[0], String.class);
        }
        Aweme aweme = this.j;
    ...
    public UserStateInsFollowImageViewHolderPlanB(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull l lVar, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar2, boolean z) {
