...
public final class c extends k {
    ...
    public final void a(long j) {
        if (PatchProxy.isSupport(new Object[]{new Long(j)}, this, r, false, 61139, new Class[]{Long.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{new Long(j)}, this, r, false, 61139, new Class[]{Long.TYPE}, Void.TYPE);
        } else if (this.f3282c == null || this.f3282c.getAuthor() == null || !TextUtils.equals(this.f3282c.getAuthor().getUid(), d.a().getCurUserId())) {
            super.a(j);
        }
    }

    public c(f fVar, com.ss.android.ugc.aweme.feed.d dVar, l lVar, int i) {
