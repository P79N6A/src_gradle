...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u001e\u0010\u0005\u001a\u0010\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\b\u0018\u00010\u00062\u0006\u0010\t\u001a\u00020\nH\u0016J \u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u00072\u0006\u0010\u000e\u001a\u00020\u00072\u0006\u0010\u000f\u001a\u00020\u0007H\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lcom/ss/android/ugc/aweme/commerce/pay/MiniAppPayImpl;", "Lcom/ss/android/ugc/aweme/commerce/pay/IPaymentDepend;", "payCallback", "Lcom/ss/android/ugc/aweme/commerce/service/callbacks/PayResultCallback;", "(Lcom/ss/android/ugc/aweme/commerce/service/callbacks/PayResultCallback;)V", "getOrderInfo", "Landroid/util/Pair;", "", "Lcom/ss/android/ugc/aweme/commerce/pay/OrderInfo;", "params", "Lorg/json/JSONObject;", "sendPayResult", "", "code", "channel", "status", "main_douyinCnRelease"}, k = 1, mv = {1, 1, 15})
public final class c implements b {
    ...
    private final com.ss.android.ugc.aweme.commerce.service.a.c f36768b;

    public c(@NotNull com.ss.android.ugc.aweme.commerce.service.a.c cVar) {
        Intrinsics.checkParameterIsNotNull(cVar, "payCallback");
        this.f36768b = cVar;
    }
    ...
    public final Pair<Integer, d> a(@NotNull JSONObject jSONObject) throws NullPointerException {
        ...
        int i = 1;
        if (PatchProxy.isSupport(new Object[]{jSONObject2}, this, f36767a, false, 28289, new Class[]{JSONObject.class}, Pair.class)) {
            return (Pair) PatchProxy.accessDispatch(new Object[]{jSONObject2}, this, f36767a, false, 28289, new Class[]{JSONObject.class}, Pair.class);
        }
    ...
    public final void a(int i, int i2, int i3) {
        if (PatchProxy.isSupport(new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)}, this, f36767a, false, 28290, new Class[]{Integer.TYPE, Integer.TYPE, Integer.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)}, this, f36767a, false, 28290, new Class[]{Integer.TYPE, Integer.TYPE, Integer.TYPE}, Void.TYPE);
            return;
        }
        this.f36768b.a(i, i2, i3);
    }
}
