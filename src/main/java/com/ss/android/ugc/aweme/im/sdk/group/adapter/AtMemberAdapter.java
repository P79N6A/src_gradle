...
public final class AtMemberAdapter extends BaseSelectListAdapter<IMContact> {
    ...
    public static final class a extends Lambda implements Function0<GroupMemberListViewModel> {
        ...
        public final GroupMemberListViewModel invoke() {
            ...
            if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 52230, new Class[0], ViewModel.class)) {
                return (ViewModel) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 52230, new Class[0], ViewModel.class);
            }
            ViewModelProvider.Factory r0 = new ViewModelProvider.Factory(this) {
                ...
                public final <T extends ViewModel> T create(@NotNull Class<T> cls) {
                    Class<T> cls2 = cls;
                    if (PatchProxy.isSupport(new Object[]{cls2}, this, f51565a, false, 52231, new Class[]{Class.class}, ViewModel.class)) {
                        return (ViewModel) PatchProxy.accessDispatch(new Object[]{cls2}, this, f51565a, false, 52231, new Class[]{Class.class}, ViewModel.class);
                    }
                    Intrinsics.checkParameterIsNotNull(cls2, "modelClass");
                    throw new IllegalStateException(this.f51566b.$viewModelClass.getClass().getSimpleName() + " should be created in the host before being used.");
                }
            };
    ...
    static final class b extends Lambda implements Function3<Integer, Integer, View, Unit> {
        public static ChangeQuickRedirect changeQuickRedirect;
        final /* synthetic */ AtMemberAdapter this$0;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        b(AtMemberAdapter atMemberAdapter) {
            super(3);
            this.this$0 = atMemberAdapter;
        }
        ...
        public final void invoke(int i, int i2, @NotNull View view) {
            Object value;
            View view2 = view;
            if (PatchProxy.isSupport(new Object[]{Integer.valueOf(i), Integer.valueOf(i2), view2}, this, changeQuickRedirect, false, 52232, new Class[]{Integer.TYPE, Integer.TYPE, View.class}, Void.TYPE)) {
                PatchProxy.accessDispatch(new Object[]{Integer.valueOf(i), Integer.valueOf(i2), view2}, this, changeQuickRedirect, false, 52232, new Class[]{Integer.TYPE, Integer.TYPE, View.class}, Void.TYPE);
                return;
            }
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    if (iMContact != null) {
                        AtMemberAdapter atMemberAdapter = this.this$0;
                        if (PatchProxy.isSupport(new Object[0], atMemberAdapter, AtMemberAdapter.f51562b, false, 52228, new Class[0], GroupMemberListViewModel.class)) {
                            value = PatchProxy.accessDispatch(new Object[0], atMemberAdapter, AtMemberAdapter.f51562b, false, 52228, new Class[0], GroupMemberListViewModel.class);
                        } else {
                            value = atMemberAdapter.f51564d.getValue();
                        }
                        GroupMemberListViewModel groupMemberListViewModel = (GroupMemberListViewModel) value;
                        if (groupMemberListViewModel != null) {
                            groupMemberListViewModel.a(iMContact);
                            break;
                        } else {
                            return;
                        }
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AtMemberAdapter(@NotNull LifecycleOwner lifecycleOwner) {
        ...
        this.f51564d = LazyKt.lazy(new a(orCreateKotlinClass, lifecycleOwner, orCreateKotlinClass));
    }

    @NotNull
    public final BaseSelectViewHolder<IMContact> a(@NotNull ViewGroup viewGroup, int i2) {
        ViewGroup viewGroup2 = viewGroup;
        if (PatchProxy.isSupport(new Object[]{viewGroup2, Integer.valueOf(i2)}, this, f51562b, false, 52229, new Class[]{ViewGroup.class, Integer.TYPE}, BaseSelectViewHolder.class)) {
            return (BaseSelectViewHolder) PatchProxy.accessDispatch(new Object[]{viewGroup2, Integer.valueOf(i2)}, this, f51562b, false, 52229, new Class[]{ViewGroup.class, Integer.TYPE}, BaseSelectViewHolder.class);
        }
        Intrinsics.checkParameterIsNotNull(viewGroup2, "parent");
        return new AtMemberViewHolder<>(viewGroup2);
    }
}
