...
public final class c extends a {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (PatchProxy.isSupport(new Object[]{sensorEvent2}, this, f65670a, false, 75112, new Class[]{SensorEvent.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{sensorEvent2}, this, f65670a, false, 75112, new Class[]{SensorEvent.class}, Void.TYPE);
            return;
        }
        ...
        if (this.f69162d) {
            ...
            if (PatchProxy.isSupport(objArr, mediaRecordPresenter, MediaRecordPresenter.f29728a, false, 17662, new Class[]{Double.TYPE, Double.TYPE, Double.TYPE, Double.TYPE}, Integer.TYPE)) {
                ...
                ((Integer) PatchProxy.accessDispatch(objArr3, mediaRecordPresenter2, MediaRecordPresenter.f29728a, false, 17662, new Class[]{Double.TYPE, Double.TYPE, Double.TYPE, Double.TYPE}, Integer.TYPE)).intValue();
            } else {
                mediaRecordPresenter.j.slamProcessIngestGyr(d2, d3, d4, a2);
            }
        }
    }
