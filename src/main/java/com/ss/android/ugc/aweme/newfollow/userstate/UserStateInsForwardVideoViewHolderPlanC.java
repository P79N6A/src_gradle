...
public final class UserStateInsForwardVideoViewHolderPlanC extends InsForwardVideoViewHolderPlanC {
    ...
    public final String Q() {
        if (PatchProxy.isSupport(new Object[0], this, u, false, 61864, new Class[0], String.class)) {
            return (String) PatchProxy.accessDispatch(new Object[0], this, u, false, 61864, new Class[0], String.class);
        }
    ...
    public UserStateInsForwardVideoViewHolderPlanC(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull d dVar, @NotNull l lVar, @NotNull BaseFollowViewHolder.a aVar2, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar3, boolean z) {
