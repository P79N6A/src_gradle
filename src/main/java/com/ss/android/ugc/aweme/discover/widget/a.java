...
public final class a {
    ...
    public static final <T> Lazy<T> a(Function0<? extends T> function0) {
        ...
        if (!PatchProxy.isSupport(new Object[]{function02}, null, f43321a, true, 38248, new Class[]{Function0.class}, Lazy.class)) {
            return LazyKt.lazy(LazyThreadSafetyMode.NONE, function02);
        }
        return (Lazy) PatchProxy.accessDispatch(new Object[]{function02}, null, f43321a, true, 38248, new Class[]{Function0.class}, Lazy.class);
    }
}
