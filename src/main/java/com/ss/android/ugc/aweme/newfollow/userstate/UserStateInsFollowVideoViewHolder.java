...
public final class UserStateInsFollowVideoViewHolder extends InsFollowVideoViewHolder {
    ...
    public final String g() {
        if (PatchProxy.isSupport(new Object[0], this, f57375b, false, 61851, new Class[0], String.class)) {
            return (String) PatchProxy.accessDispatch(new Object[0], this, f57375b, false, 61851, new Class[0], String.class);
        }
        Aweme aweme = this.j;
    ...
    public UserStateInsFollowVideoViewHolder(@NotNull FollowFeedLayout followFeedLayout, @NotNull a aVar, @NotNull l lVar, @NotNull com.ss.android.ugc.aweme.newfollow.b.a aVar2, @NotNull d dVar, boolean z) {
