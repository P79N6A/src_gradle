...
public final class c implements d {
    ...
    public final void a(@NotNull Context context, boolean z) {
        ...
        if (PatchProxy.isSupport(new Object[]{context2, Byte.valueOf(z ? (byte) 1 : 0)}, this, f63624a, false, 70806, new Class[]{Context.class, Boolean.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{context2, Byte.valueOf(z)}, this, f63624a, false, 70806, new Class[]{Context.class, Boolean.TYPE}, Void.TYPE);
            return;
        }
