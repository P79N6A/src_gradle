...
import com.ss.android.ugc.aweme.music.h;
...
public class User implements Serializable, Cloneable {
    ...
    public DouplusToastStruct douplusToastStruct;
    ...
    public DouplusToastStruct getDouplusToastStruct() {
        return this.douplusToastStruct;
    }
    ...
    public User clone() {
        if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67517, new Class[0], User.class)) {
            return (User) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67517, new Class[0], User.class);
        }
        try {
    ...
    public long getCreateTime() {
        if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67511, new Class[0], Long.TYPE)) {
            return ((Long) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67511, new Class[0], Long.TYPE)).longValue();
    ...
    public UrlModel getDefaultAdCoverUrl() {
        if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67523, new Class[0], UrlModel.class)) {
            return (UrlModel) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67523, new Class[0], UrlModel.class);
        } else if (CollectionUtils.isEmpty(this.adCoverUrl)) {
            return null;
        } else {
    ...
    public long getLatestOrderTime() {
        if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67513, new Class[0], Long.TYPE)) {
            return ((Long) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67513, new Class[0], Long.TYPE)).longValue();
        } else if (this.latestOrderTime == null) {
            return 0;
        } else {
    ...
    public String getLiveUid() {
        if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67512, new Class[0], String.class)) {
            return (String) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67512, new Class[0], String.class);
        }
        return "live" + this.uid;
    }

    public boolean isFacebookExpire() {
        if (!PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67519, new Class[0], Boolean.TYPE)) {
            return checkExpire(this.fbExpireTime);
        }
        return ((Boolean) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67519, new Class[0], Boolean.TYPE)).booleanValue();
    }

    public boolean isTwitterExpire() {
        if (!PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67520, new Class[0], Boolean.TYPE)) {
            return checkExpire(this.twExpireTime);
        }
        return ((Boolean) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67520, new Class[0], Boolean.TYPE)).booleanValue();
    }

    public boolean isYoutubeExpire() {
        if (!PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67518, new Class[0], Boolean.TYPE)) {
            return checkExpire(this.youtubeExpireTime);
        }
        return ((Boolean) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67518, new Class[0], Boolean.TYPE)).booleanValue();
    }

    public boolean isMe() {
        if (!PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67516, new Class[0], Boolean.TYPE)) {
            return StringUtils.equal(this.uid, ((IUserService) ServiceManager.get().getService(IUserService.class)).getCurrentUserID());
        }
        return ((Boolean) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67516, new Class[0], Boolean.TYPE)).booleanValue();
    }
    ...
    public int hashCode() {
        ...
        int i20;
        int i21 = 0;
        if (PatchProxy.isSupport(new Object[0], this, changeQuickRedirect, false, 67515, new Class[0], Integer.TYPE)) {
            return ((Integer) PatchProxy.accessDispatch(new Object[0], this, changeQuickRedirect, false, 67515, new Class[0], Integer.TYPE)).intValue();
        }
        if (this.uid != null) {
            i = this.uid.hashCode();
        } else {
        ...
        int i30 = (((((((((((((((((((((((((i29 + i9) * 31) + (this.isVerified ? 1 : 0)) * 31) + this.allowStatus) * 31) + this.followStatus) * 31) + this.followerStatus) * 31) + this.watchStatus) * 31) + this.awemeCount) * 31) + this.followingCount) * 31) + this.followerCount) * 31) + this.collectCount) * 31) + this.totalFavorited) * 31) + this.favoritingCount) * 31) + this.registerStatus) * 31;
    ...
    public void setChallengeList(String str) {
        this.challengeList = str;
    }
    ...
    public void setDouplusToastStruct(DouplusToastStruct douplusToastStruct2) {
        this.douplusToastStruct = douplusToastStruct2;
    }
    ...
    public void setOriginalMusician(h hVar) {
        this.originalMusician = hVar;
    }
    ...
    private boolean checkExpire(long j) {
        long j2 = j;
        if (PatchProxy.isSupport(new Object[]{new Long(j2)}, this, changeQuickRedirect, false, 67521, new Class[]{Long.TYPE}, Boolean.TYPE)) {
            return ((Boolean) PatchProxy.accessDispatch(new Object[]{new Long(j2)}, this, changeQuickRedirect, false, 67521, new Class[]{Long.TYPE}, Boolean.TYPE)).booleanValue();
        } else if ((System.currentTimeMillis() / 1000) - j2 > 0) {
            return true;
        } else {
            return false;
        }
    ...
    public PlatformInfo getPlatformInfo(String str) {
        if (PatchProxy.isSupport(new Object[]{str}, this, changeQuickRedirect, false, 67522, new Class[]{String.class}, PlatformInfo.class)) {
            return (PlatformInfo) PatchProxy.accessDispatch(new Object[]{str}, this, changeQuickRedirect, false, 67522, new Class[]{String.class}, PlatformInfo.class);
        }
    ...
    public void setHasUnreadStory(boolean z) {
        if (PatchProxy.isSupport(new Object[]{Byte.valueOf(z ? (byte) 1 : 0)}, this, changeQuickRedirect, false, 67510, new Class[]{Boolean.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{Byte.valueOf(z)}, this, changeQuickRedirect, false, 67510, new Class[]{Boolean.TYPE}, Void.TYPE);
            return;
        }
    ...
    public boolean equals(Object obj) {
        if (PatchProxy.isSupport(new Object[]{obj}, this, changeQuickRedirect, false, 67514, new Class[]{Object.class}, Boolean.TYPE)) {
            return ((Boolean) PatchProxy.accessDispatch(new Object[]{obj}, this, changeQuickRedirect, false, 67514, new Class[]{Object.class}, Boolean.TYPE)).booleanValue();
        } else if (this == obj) {
            return true;
        } else {
