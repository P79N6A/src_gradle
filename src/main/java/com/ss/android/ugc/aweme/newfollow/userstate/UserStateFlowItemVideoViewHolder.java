...
public class UserStateFlowItemVideoViewHolder extends FollowVideoViewHolder {
    ...
    public final void E_() {
        if (PatchProxy.isSupport(new Object[0], this, f57358a, false, 61819, new Class[0], Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[0], this, f57358a, false, 61819, new Class[0], Void.TYPE);
        } else if (a.c()) {
    ...
    public final void a(long j) {
        if (PatchProxy.isSupport(new Object[]{new Long(j)}, this, f57358a, false, 61818, new Class[]{Long.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{new Long(j)}, this, f57358a, false, 61818, new Class[]{Long.TYPE}, Void.TYPE);
    ...
    public final void a(View view) {
        if (PatchProxy.isSupport(new Object[]{view}, this, f57358a, false, 61817, new Class[]{View.class}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{view}, this, f57358a, false, 61817, new Class[]{View.class}, Void.TYPE);
            return;
        }
    ...
    public UserStateFlowItemVideoViewHolder(FollowFeedLayout followFeedLayout, com.ss.android.ugc.aweme.forward.a.a aVar, l lVar, com.ss.android.ugc.aweme.newfollow.b.a aVar2, com.ss.android.ugc.aweme.feed.d dVar) {
