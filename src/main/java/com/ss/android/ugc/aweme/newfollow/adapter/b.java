...
public final class b extends f {
    ...
    public final void a(long j) {
        if (PatchProxy.isSupport(new Object[]{new Long(j)}, this, m, false, 61138, new Class[]{Long.TYPE}, Void.TYPE)) {
            PatchProxy.accessDispatch(new Object[]{new Long(j)}, this, m, false, 61138, new Class[]{Long.TYPE}, Void.TYPE);
