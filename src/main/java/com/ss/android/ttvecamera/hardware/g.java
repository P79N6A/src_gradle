...
public final class g extends b {
    ...
    public static final Map<String, String> f31459d = new HashMap<String, String>() {
        {
    ...
    public final boolean a(int i) {
        try {
            b a2 = b.a();
            String str = ((CameraManager) this.f31456b.getSystemService("camera")).getCameraIdList()[i];
            String b2 = a2.b(f31459d.get(this.f31456b.getPackageName()));
            ...
            ad.c("TEOppoCameraProxy", "AntiShake verify cause this exception");
        }
        return false;
    }
}
