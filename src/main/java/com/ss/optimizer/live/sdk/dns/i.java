...
public final class i implements Callable<h> {
    ...
    private static Pattern f78461a;

    /* renamed from: b  reason: collision with root package name */
    private final String f78462b;

    /* renamed from: c  reason: collision with root package name */
    private final int f78463c = 10;
    ...
    public com.ss.optimizer.live.sdk.dns.h call() throws java.lang.Exception {
        /*
            r13 = this;
            int r0 = r13.f78463c
            r1 = 0
            ...
            java.lang.String r2 = r13.f78462b
            int r3 = r13.f78463c
            r0.<init>(r2, r1, r3)
            return r0
        L_0x000f:
            ...
            r5 = 0
            int r6 = r13.f78463c     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
            ...
            java.lang.String r5 = r13.f78462b     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
            r6 = 1
            r4[r6] = r5     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
            java.lang.String r0 = java.lang.String.format(r0, r2, r4)     // Catch:{ Throwable -> 0x00a9, all -> 0x0098 }
        ...
        L_0x0043:
            ...
            java.util.regex.Pattern r8 = f78461a     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
        ...
        L_0x0077:
            ...
            java.lang.String r4 = r13.f78462b     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
            int r6 = r13.f78463c     // Catch:{ Throwable -> 0x008f, all -> 0x008d }
        ...
        L_0x00b7:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ss.optimizer.live.sdk.dns.i.call():com.ss.optimizer.live.sdk.dns.h");
    }

    i(String str, int i) {
        this.f78462b = str;
        if (f78461a == null) {
            f78461a = Pattern.compile(".*?icmp_seq=(\\d+).*?ttl=(\\d+).*?time=([\\d^\\.]+|[1-9]\\d*\\.\\d*|0\\.\\d*[1-9]\\d*).*?ms");
        }
    }
}
