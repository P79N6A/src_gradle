...
public class PreRender {
    ...
    public final void destroy() {
        ...
        destroyFrameBuffers();
        GLES20.glDeleteProgram(((Integer) this.mArrayPrograms.get(0).get("program")).intValue());
        this.mArrayPrograms.get(0).put("program", 0);
        GLES20.glDeleteProgram(((Integer) this.mArrayPrograms.get(1).get("program")).intValue());
        this.mArrayPrograms.get(1).put("program", 0);
    }
    ...
    public int onDrawFrame(int i) {
        ...
        GLES20.glUseProgram(((Integer) this.mArrayPrograms.get(1).get("program")).intValue());
        this.mVertexBuffer.position(0);
        int intValue = ((Integer) this.mArrayPrograms.get(1).get("position")).intValue();
        GLES20.glVertexAttribPointer(intValue, 2, 5126, false, 0, this.mVertexBuffer);
        GLES20.glEnableVertexAttribArray(intValue);
        this.mGLPreviewTextureBuffer.position(0);
        int intValue2 = ((Integer) this.mArrayPrograms.get(1).get("inputTextureCoordinate")).intValue();
        GLES20.glVertexAttribPointer(intValue2, 2, 5126, false, 0, this.mGLPreviewTextureBuffer);
        GLES20.glEnableVertexAttribArray(intValue2);
        if (i != -1) {
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(3553, i);
            GLES20.glUniform1i(((Integer) this.mArrayPrograms.get(1).get("inputImageTexture")).intValue(), 0);
        }
    ...
    public int preProcess(int i) {
        ...
        GLES20.glUseProgram(((Integer) this.mArrayPrograms.get(0).get("program")).intValue());
        OpenGLUtils.checkGlError("glUseProgram");
        this.mGLCubeBuffer.position(0);
        int intValue = ((Integer) this.mArrayPrograms.get(0).get("position")).intValue();
        GLES20.glVertexAttribPointer(intValue, 2, 5126, false, 0, this.mGLCubeBuffer);
        GLES20.glEnableVertexAttribArray(intValue);
        this.mTextureBuffer.position(0);
        int intValue2 = ((Integer) this.mArrayPrograms.get(0).get("inputTextureCoordinate")).intValue();
        GLES20.glVertexAttribPointer(intValue2, 2, 5126, false, 0, this.mTextureBuffer);
        GLES20.glEnableVertexAttribArray(intValue2);
        if (i != -1) {
            GLES20.glActiveTexture(33984);
            GLES20.glBindTexture(36197, i);
            GLES20.glUniform1i(((Integer) this.mArrayPrograms.get(0).get("inputImageTexture")).intValue(), 0);
        }
    ...
    public void calculateVertexBuffer(int i, int i2, int i3, int i4) {
        ...
        float round = ((float) Math.round(f3 * max)) / f2;
        float round2 = ((float) Math.round(f5 * max)) / f4;
