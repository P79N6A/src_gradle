...
public final class b extends a {
    ...
    private final BarrageLayout f78703a;

    /* renamed from: b  reason: collision with root package name */
    private final int f78704b;
    private final int k;
    ...
    public final void a(@NotNull com.ss.ugc.live.barrage.a aVar, float f2) {
        ...
        int width = this.f78703a.getWidth();
        int height = this.f78703a.getHeight();
        this.f78703a.postInvalidate();
        ...
        while (it2.hasNext()) {
            ...
            int height2 = (int) ((aVar2.k.bottom - aVar2.k.height()) / ((float) this.f78704b));
            if (aVar2.k.left < fArr[height2]) {
                fArr[height2] = aVar2.k.left;
            }
            aVar2.k.offset(f4, 0.0f);
        }
        int i = this.k;
        for (int i2 = 0; i2 < i; i2++) {
            if (this.f78704b * i2 <= height && fArr[i2] >= 0.0f) {
                a e2 = e();
                if (e2 != null) {
                    ...
                    e2.k.left = -width2;
                    e2.k.right = 0.0f;
                    e2.k.top = (float) (this.f78704b * i2);
                    e2.k.bottom = ((float) (this.f78704b * i2)) + height3;
                    aVar.add(e2);
                } else {
                    return;
                }
    ...
    public b(@NotNull BarrageLayout barrageLayout, int i, int i2, int i3) {
        super(barrageLayout);
        Intrinsics.checkParameterIsNotNull(barrageLayout, "barrageLayout");
        this.f78703a = barrageLayout;
        this.f78704b = i;
        this.k = i2;
    }
}
