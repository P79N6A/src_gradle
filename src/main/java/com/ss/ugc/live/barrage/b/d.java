...
public final class d extends a {
    ...
    public final void a(@NotNull com.ss.ugc.live.barrage.a aVar, float f2) {
        ...
        int width = this.f78707a.getWidth();
        int height = this.f78707a.getHeight();
        ...
        while (it2.hasNext()) {
            ...
            int height2 = (int) ((aVar2.k.bottom - aVar2.k.height()) / ((float) this.f78708b));
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (this.f78708b * i3 <= height && fArr[i3] < f3) {
                a e2 = e();
                if (e2 != null) {
                    ...
                    e2.k.top = (float) (this.f78708b * i3);
                    e2.k.bottom = ((float) (i3 * this.f78708b)) + height3;
                    aVar.add(e2);
                } else {
                    return;
                }
    ...
    public d(@NotNull BarrageLayout barrageLayout, int i, int i2, int i3) {
        super(barrageLayout);
        Intrinsics.checkParameterIsNotNull(barrageLayout, "barrageLayout");
        this.f78707a = barrageLayout;
        this.f78708b = i;
        this.k = i2;
    }
}
