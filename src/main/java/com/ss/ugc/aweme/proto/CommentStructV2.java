...
public final class CommentStructV2 extends Message<CommentStructV2, Builder> {
    @Keep
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.CommentStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 10)
    ...
    public String text;
    @WireField(adapter = "com.ss.ugc.aweme.proto.TextExtraStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 11)
    ...
    public static final class Builder extends Message.Builder<CommentStructV2, Builder> {
        public String aweme_id;
        public String cid;
        public Long create_time;
        public Integer digg_count;
