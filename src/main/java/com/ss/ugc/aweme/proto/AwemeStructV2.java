...
public final class AwemeStructV2 extends Message<AwemeStructV2, Builder> {
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.ChallengeStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 6)
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.CommentStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 43)
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.PromotionStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 56)
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.TextExtraStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 14)
    ...
    static final class ProtoAdapter_AwemeStructV2 extends ProtoAdapter<AwemeStructV2> {
        ...
        public final void encode(ProtoWriter protoWriter, AwemeStructV2 awemeStructV2) throws IOException {
            ...
            ProtoAdapter.STRING.asRepeated().encodeWithTag(protoWriter, BaseLoginOrRegisterActivity.o, awemeStructV2.origin_comment_ids);
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (((i97 + i5) * 37) + this.cha_list.hashCode()) * 37;
        if (this.video != null) {
            i6 = this.video.hashCode();
        } else {
            i6 = 0;
        }
        int i98 = (hashCode2 + i6) * 37;
