...
public final class RedPacketStructV2 extends Message<RedPacketStructV2, Builder> {
    @Keep
    ...
    public static final class Builder extends Message.Builder<RedPacketStructV2, Builder> {
        public UrlStructV2 default_voice;
        public Long seckill_time;
        public String star_name;
        public UrlStructV2 tag_icon;
