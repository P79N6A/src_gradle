...
public final class MusicStructV2 extends Message<MusicStructV2, Builder> {
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.PositionStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 18)
    ...
    public static final class Builder extends Message.Builder<MusicStructV2, Builder> {
        ...
        public final Builder preview_end_time(Double d2) {
            this.preview_end_time = d2;
            return this;
        }

        public final Builder preview_start_time(Double d2) {
        ...
        public final MusicStructV2 decode(ProtoReader protoReader) throws IOException {
            ...
            while (true) {
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        case 1:
                            builder.id((Long) ProtoAdapter.INT64.decode(protoReader));
                            break;
                        case 2:
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (((i74 + i17) * 37) + this.position.hashCode()) * 37;
        if (this.share_info != null) {
            i18 = this.share_info.hashCode();
        } else {
            i18 = 0;
        }
        int i75 = (hashCode2 + i18) * 37;
        ...
        int hashCode3 = (((i96 + i40) * 37) + this.author_position.hashCode()) * 37;
        if (this.prevent_download != null) {
            i41 = this.prevent_download.hashCode();
        } else {
            i41 = 0;
        }
        int i97 = (hashCode3 + i41) * 37;
        ...
        int hashCode4 = (((i102 + i47) * 37) + this.unshelve_countries.hashCode()) * 37;
