...
public final class UserStructV2 extends Message<UserStructV2, Builder> {
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.UrlStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 155)
    ...
    public static final class Builder extends Message.Builder<UserStructV2, Builder> {
        ...
        public final Builder recommend_score(Double d2) {
            this.recommend_score = d2;
            return this;
        }
  ...
  ?: SGET   com.ss.android.ugc.aweme.discover.jedi.adapter.SearchJediMixFeedAdapter.e int)*/:
                        ...
                        case 127:
                            ...
                            break;
                        case SearchJediMixFeedAdapter.f42517f /*?: ONE_ARG  (wrap: ?
  ?: SGET   com.ss.android.ugc.aweme.discover.jedi.adapter.SearchJediMixFeedAdapter.f int)*/:
                        ...
                        case 143:
                            ...
                            break;
                        case SearchJediMixFeedAdapter.g /*?: ONE_ARG  (wrap: ?
  ?: SGET   com.ss.android.ugc.aweme.discover.jedi.adapter.SearchJediMixFeedAdapter.g int)*/:
        ...
        public final void encode(ProtoWriter protoWriter, UserStructV2 userStructV2) throws IOException {
            ...
            ProtoAdapter.INT64.encodeWithTag(protoWriter, BaseLoginOrRegisterActivity.o, userStructV2.create_time);
            ...
            UrlStructV2.ADAPTER.encodeWithTag(protoWriter, SearchJediMixFeedAdapter.f42516e, userStructV2.room_cover);
            ...
            ProtoAdapter.STRING.encodeWithTag(protoWriter, SearchJediMixFeedAdapter.f42517f, userStructV2.room_type_tag);
            ...
            UrlStructV2.ADAPTER.encodeWithTag(protoWriter, SearchJediMixFeedAdapter.g, userStructV2.avatar_pendant_thumb);
            ...
            HotsearchSprintStructV2.ADAPTER.encodeWithTag(protoWriter, 180, userStructV2.sprint_support_user_info);
    ...
    public final int hashCode() {
        ...
        if (this.avatar_larger != null) {
            i6 = this.avatar_larger.hashCode();
        } else {
            i6 = 0;
        }
        int i204 = (i203 + i6) * 37;
        if (this.avatar_thumb != null) {
            i7 = this.avatar_thumb.hashCode();
        } else {
            i7 = 0;
        }
        int i205 = (i204 + i7) * 37;
        if (this.avatar_medium != null) {
            i8 = this.avatar_medium.hashCode();
        } else {
            i8 = 0;
        }
        int i206 = (i205 + i8) * 37;
        if (this.birthday != null) {
            i9 = this.birthday.hashCode();
        } else {
            i9 = 0;
        }
        int i207 = (i206 + i9) * 37;
        if (this.is_verified != null) {
            i10 = this.is_verified.hashCode();
        } else {
            i10 = 0;
        }
        int i208 = (i207 + i10) * 37;
        if (this.allow_status != null) {
            i11 = this.allow_status.hashCode();
        } else {
            i11 = 0;
        }
        int i209 = (i208 + i11) * 37;
        if (this.follow_status != null) {
            i12 = this.follow_status.hashCode();
        } else {
            i12 = 0;
        }
        int i210 = (i209 + i12) * 37;
        if (this.aweme_count != null) {
            i13 = this.aweme_count.hashCode();
        } else {
            i13 = 0;
        }
        int i211 = (i210 + i13) * 37;
        if (this.following_count != null) {
            i14 = this.following_count.hashCode();
        } else {
            i14 = 0;
        }
        int i212 = (i211 + i14) * 37;
        if (this.follower_count != null) {
            i15 = this.follower_count.hashCode();
        } else {
            i15 = 0;
        }
        int i213 = (i212 + i15) * 37;
        if (this.favoriting_count != null) {
            i16 = this.favoriting_count.hashCode();
        } else {
            i16 = 0;
        }
        int i214 = (i213 + i16) * 37;
        if (this.total_favorited != null) {
            i17 = this.total_favorited.hashCode();
        } else {
            i17 = 0;
        }
        int i215 = (i214 + i17) * 37;
        if (this.is_block != null) {
            i18 = this.is_block.hashCode();
        } else {
            i18 = 0;
        }
        int i216 = (i215 + i18) * 37;
        if (this.third_name != null) {
            i19 = this.third_name.hashCode();
        } else {
            i19 = 0;
        }
        int i217 = (i216 + i19) * 37;
        if (this.hide_search != null) {
            i20 = this.hide_search.hashCode();
        } else {
            i20 = 0;
        }
        int i218 = (i217 + i20) * 37;
        if (this.constellation != null) {
            i21 = this.constellation.hashCode();
        } else {
            i21 = 0;
        }
        int i219 = (i218 + i21) * 37;
        if (this.location != null) {
            i22 = this.location.hashCode();
        } else {
            i22 = 0;
        }
        int i220 = (i219 + i22) * 37;
        if (this.hide_location != null) {
            i23 = this.hide_location.hashCode();
        } else {
            i23 = 0;
        }
        int i221 = (i220 + i23) * 37;
        if (this.weibo_verify != null) {
            i24 = this.weibo_verify.hashCode();
        } else {
            i24 = 0;
        }
        int i222 = (i221 + i24) * 37;
        if (this.custom_verify != null) {
            i25 = this.custom_verify.hashCode();
        } else {
            i25 = 0;
        }
        int i223 = (i222 + i25) * 37;
        if (this.unique_id != null) {
            i26 = this.unique_id.hashCode();
        } else {
            i26 = 0;
        }
        int i224 = (i223 + i26) * 37;
        if (this.bind_phone != null) {
            i27 = this.bind_phone.hashCode();
        } else {
            i27 = 0;
        }
        int i225 = (i224 + i27) * 37;
        if (this.special_lock != null) {
            i28 = this.special_lock.hashCode();
        } else {
            i28 = 0;
        }
        int i226 = (i225 + i28) * 37;
        if (this.need_recommend != null) {
            i29 = this.need_recommend.hashCode();
        } else {
            i29 = 0;
        }
        int i227 = (i226 + i29) * 37;
        if (this.is_binded_weibo != null) {
            i30 = this.is_binded_weibo.hashCode();
        } else {
            i30 = 0;
        }
        int i228 = (i227 + i30) * 37;
        if (this.weibo_name != null) {
            i31 = this.weibo_name.hashCode();
        } else {
            i31 = 0;
        }
        int i229 = (i228 + i31) * 37;
        if (this.weibo_schema != null) {
            i32 = this.weibo_schema.hashCode();
        } else {
            i32 = 0;
        }
        int i230 = (i229 + i32) * 37;
        if (this.weibo_url != null) {
            i33 = this.weibo_url.hashCode();
        } else {
            i33 = 0;
        }
        int i231 = (i230 + i33) * 37;
        if (this.story_open != null) {
            i34 = this.story_open.hashCode();
        } else {
            i34 = 0;
        }
        int i232 = (i231 + i34) * 37;
        if (this.story_count != null) {
            i35 = this.story_count.hashCode();
        } else {
            i35 = 0;
        }
        int i233 = (i232 + i35) * 37;
        if (this.recommend_reason != null) {
            i36 = this.recommend_reason.hashCode();
        } else {
            i36 = 0;
        }
        int i234 = (i233 + i36) * 37;
        if (this.has_facebook_token != null) {
            i37 = this.has_facebook_token.hashCode();
        } else {
            i37 = 0;
        }
        int i235 = (i234 + i37) * 37;
        if (this.has_twitter_token != null) {
            i38 = this.has_twitter_token.hashCode();
        } else {
            i38 = 0;
        }
        int i236 = (i235 + i38) * 37;
        if (this.fb_expire_time != null) {
            i39 = this.fb_expire_time.hashCode();
        } else {
            i39 = 0;
        }
        int i237 = (i236 + i39) * 37;
        if (this.tw_expire_time != null) {
            i40 = this.tw_expire_time.hashCode();
        } else {
            i40 = 0;
        }
        int i238 = (i237 + i40) * 37;
        if (this.has_youtube_token != null) {
            i41 = this.has_youtube_token.hashCode();
        } else {
            i41 = 0;
        }
        int i239 = (i238 + i41) * 37;
        if (this.youtube_expire_time != null) {
            i42 = this.youtube_expire_time.hashCode();
        } else {
            i42 = 0;
        }
        int i240 = (i239 + i42) * 37;
        if (this.room_id != null) {
            i43 = this.room_id.hashCode();
        } else {
            i43 = 0;
        }
        int i241 = (i240 + i43) * 37;
        if (this.live_verify != null) {
            i44 = this.live_verify.hashCode();
        } else {
            i44 = 0;
        }
        int i242 = (i241 + i44) * 37;
        if (this.authority_status != null) {
            i45 = this.authority_status.hashCode();
        } else {
            i45 = 0;
        }
        int i243 = (i242 + i45) * 37;
        if (this.verify_info != null) {
            i46 = this.verify_info.hashCode();
        } else {
            i46 = 0;
        }
        int i244 = (i243 + i46) * 37;
        if (this.shield_follow_notice != null) {
            i47 = this.shield_follow_notice.hashCode();
        } else {
            i47 = 0;
        }
        int i245 = (i244 + i47) * 37;
        if (this.shield_digg_notice != null) {
            i48 = this.shield_digg_notice.hashCode();
        } else {
            i48 = 0;
        }
        int i246 = (i245 + i48) * 37;
        if (this.shield_comment_notice != null) {
            i49 = this.shield_comment_notice.hashCode();
        } else {
            i49 = 0;
        }
        int i247 = (i246 + i49) * 37;
        if (this.school_name != null) {
            i50 = this.school_name.hashCode();
        } else {
            i50 = 0;
        }
        int i248 = (i247 + i50) * 37;
        if (this.school_poi_id != null) {
            i51 = this.school_poi_id.hashCode();
        } else {
            i51 = 0;
        }
        int i249 = (i248 + i51) * 37;
        if (this.school_type != null) {
            i52 = this.school_type.hashCode();
        } else {
            i52 = 0;
        }
        int i250 = (i249 + i52) * 37;
        if (this.share_info != null) {
            i53 = this.share_info.hashCode();
        } else {
            i53 = 0;
        }
        int i251 = (i250 + i53) * 37;
        if (this.with_commerce_entry != null) {
            i54 = this.with_commerce_entry.hashCode();
        } else {
            i54 = 0;
        }
        int i252 = (i251 + i54) * 37;
        if (this.verification_type != null) {
            i55 = this.verification_type.hashCode();
        } else {
            i55 = 0;
        }
        int i253 = (i252 + i55) * 37;
        if (this.original_musician != null) {
            i56 = this.original_musician.hashCode();
        } else {
            i56 = 0;
        }
        int i254 = (i253 + i56) * 37;
        if (this.activity != null) {
            i57 = this.activity.hashCode();
        } else {
            i57 = 0;
        }
        int i255 = (i254 + i57) * 37;
        if (this.enterprise_verify_reason != null) {
            i58 = this.enterprise_verify_reason.hashCode();
        } else {
            i58 = 0;
        }
        int i256 = (i255 + i58) * 37;
        if (this.is_ad_fake != null) {
            i59 = this.is_ad_fake.hashCode();
        } else {
            i59 = 0;
        }
        int i257 = (i256 + i59) * 37;
        if (this.star_use_new_download != null) {
            i60 = this.star_use_new_download.hashCode();
        } else {
            i60 = 0;
        }
        int i258 = (i257 + i60) * 37;
        if (this.mplatform_followers_count != null) {
            i61 = this.mplatform_followers_count.hashCode();
        } else {
            i61 = 0;
        }
        int hashCode2 = (((i258 + i61) * 37) + this.followers_detail.hashCode()) * 37;
        if (this.has_activity_medal != null) {
            i62 = this.has_activity_medal.hashCode();
        } else {
            i62 = 0;
        }
        int i259 = (hashCode2 + i62) * 37;
        if (this.region != null) {
            i63 = this.region.hashCode();
        } else {
            i63 = 0;
        }
        int i260 = (i259 + i63) * 37;
        if (this.account_region != null) {
            i64 = this.account_region.hashCode();
        } else {
            i64 = 0;
        }
        int i261 = (i260 + i64) * 37;
        if (this.sync_to_toutiao != null) {
            i65 = this.sync_to_toutiao.hashCode();
        } else {
            i65 = 0;
        }
        int i262 = (i261 + i65) * 37;
        if (this.commerce_user_level != null) {
            i66 = this.commerce_user_level.hashCode();
        } else {
            i66 = 0;
        }
        int i263 = (i262 + i66) * 37;
        if (this.commerce_info != null) {
            i67 = this.commerce_info.hashCode();
        } else {
            i67 = 0;
        }
        int i264 = (i263 + i67) * 37;
        if (this.live_agreement != null) {
            i68 = this.live_agreement.hashCode();
        } else {
            i68 = 0;
        }
        int hashCode3 = (((i264 + i68) * 37) + this.platform_sync_info.hashCode()) * 37;
        if (this.with_shop_entry != null) {
            i69 = this.with_shop_entry.hashCode();
        } else {
            i69 = 0;
        }
        int i265 = (hashCode3 + i69) * 37;
        if (this.is_discipline_member != null) {
            i70 = this.is_discipline_member.hashCode();
        } else {
            i70 = 0;
        }
        int i266 = (i265 + i70) * 37;
        if (this.secret != null) {
            i71 = this.secret.hashCode();
        } else {
            i71 = 0;
        }
        int i267 = (i266 + i71) * 37;
        if (this.has_orders != null) {
            i72 = this.has_orders.hashCode();
        } else {
            i72 = 0;
        }
        int i268 = (i267 + i72) * 37;
        if (this.prevent_download != null) {
            i73 = this.prevent_download.hashCode();
        } else {
            i73 = 0;
        }
        int i269 = (i268 + i73) * 37;
        if (this.show_image_bubble != null) {
            i74 = this.show_image_bubble.hashCode();
        } else {
            i74 = 0;
        }
        int hashCode4 = (((i269 + i74) * 37) + this.geofencing.hashCode()) * 37;
        if (this.unique_id_modify_time != null) {
            i75 = this.unique_id_modify_time.hashCode();
        } else {
            i75 = 0;
        }
        int i270 = (hashCode4 + i75) * 37;
        if (this.video_icon != null) {
            i76 = this.video_icon.hashCode();
        } else {
            i76 = 0;
        }
        int i271 = (i270 + i76) * 37;
        if (this.ins_id != null) {
            i77 = this.ins_id.hashCode();
        } else {
            i77 = 0;
        }
        int i272 = (i271 + i77) * 37;
        if (this.google_account != null) {
            i78 = this.google_account.hashCode();
        } else {
            i78 = 0;
        }
        int i273 = (i272 + i78) * 37;
        if (this.youtube_channel_id != null) {
            i79 = this.youtube_channel_id.hashCode();
        } else {
            i79 = 0;
        }
        int i274 = (i273 + i79) * 37;
        if (this.youtube_channel_title != null) {
            i80 = this.youtube_channel_title.hashCode();
        } else {
            i80 = 0;
        }
        int i275 = (i274 + i80) * 37;
        if (this.apple_account != null) {
            i81 = this.apple_account.hashCode();
        } else {
            i81 = 0;
        }
        int i276 = (i275 + i81) * 37;
        if (this.with_dou_entry != null) {
            i82 = this.with_dou_entry.hashCode();
        } else {
            i82 = 0;
        }
        int i277 = (i276 + i82) * 37;
        if (this.with_fusion_shop_entry != null) {
            i83 = this.with_fusion_shop_entry.hashCode();
        } else {
            i83 = 0;
        }
        int i278 = (i277 + i83) * 37;
        if (this.is_phone_binded != null) {
            i84 = this.is_phone_binded.hashCode();
        } else {
            i84 = 0;
        }
        int i279 = (i278 + i84) * 37;
        if (this.login_platform != null) {
            i85 = this.login_platform.hashCode();
        } else {
            i85 = 0;
        }
        int i280 = (i279 + i85) * 37;
        if (this.accept_private_policy != null) {
            i86 = this.accept_private_policy.hashCode();
        } else {
            i86 = 0;
        }
        int i281 = (i280 + i86) * 37;
        if (this.realname_verify_status != null) {
            i87 = this.realname_verify_status.hashCode();
        } else {
            i87 = 0;
        }
        int i282 = (i281 + i87) * 37;
        if (this.twitter_id != null) {
            i88 = this.twitter_id.hashCode();
        } else {
            i88 = 0;
        }
        int i283 = (i282 + i88) * 37;
        if (this.twitter_name != null) {
            i89 = this.twitter_name.hashCode();
        } else {
            i89 = 0;
        }
        int i284 = (i283 + i89) * 37;
        if (this.user_canceled != null) {
            i90 = this.user_canceled.hashCode();
        } else {
            i90 = 0;
        }
        int i285 = (i284 + i90) * 37;
        if (this.has_email != null) {
            i91 = this.has_email.hashCode();
        } else {
            i91 = 0;
        }
        int i286 = (i285 + i91) * 37;
        if (this.is_gov_media_vip != null) {
            i92 = this.is_gov_media_vip.hashCode();
        } else {
            i92 = 0;
        }
        int i287 = (i286 + i92) * 37;
        if (this.dongtai_count != null) {
            i93 = this.dongtai_count.hashCode();
        } else {
            i93 = 0;
        }
        int i288 = (i287 + i93) * 37;
        if (this.live_agreement_time != null) {
            i94 = this.live_agreement_time.hashCode();
        } else {
            i94 = 0;
        }
        int i289 = (i288 + i94) * 37;
        if (this.register_time != null) {
            i95 = this.register_time.hashCode();
        } else {
            i95 = 0;
        }
        int i290 = (i289 + i95) * 37;
        if (this.status != null) {
            i96 = this.status.hashCode();
        } else {
            i96 = 0;
        }
        int i291 = (i290 + i96) * 37;
        if (this.with_douplus_entry != null) {
            i97 = this.with_douplus_entry.hashCode();
        } else {
            i97 = 0;
        }
        int i292 = (i291 + i97) * 37;
        if (this.create_time != null) {
            i98 = this.create_time.hashCode();
        } else {
            i98 = 0;
        }
        int i293 = (i292 + i98) * 37;
        if (this.avatar_uri != null) {
            i99 = this.avatar_uri.hashCode();
        } else {
            i99 = 0;
        }
        int i294 = (i293 + i99) * 37;
        if (this.follower_status != null) {
            i100 = this.follower_status.hashCode();
        } else {
            i100 = 0;
        }
        int i295 = (i294 + i100) * 37;
        if (this.neiguang_shield != null) {
            i101 = this.neiguang_shield.hashCode();
        } else {
            i101 = 0;
        }
        int i296 = (i295 + i101) * 37;
        if (this.comment_setting != null) {
            i102 = this.comment_setting.hashCode();
        } else {
            i102 = 0;
        }
        int i297 = (i296 + i102) * 37;
        if (this.duet_setting != null) {
            i103 = this.duet_setting.hashCode();
        } else {
            i103 = 0;
        }
        int i298 = (i297 + i103) * 37;
        if (this.reflow_page_gid != null) {
            i104 = this.reflow_page_gid.hashCode();
        } else {
            i104 = 0;
        }
        int i299 = (i298 + i104) * 37;
        if (this.reflow_page_uid != null) {
            i105 = this.reflow_page_uid.hashCode();
        } else {
            i105 = 0;
        }
        int i300 = (i299 + i105) * 37;
        if (this.user_rate != null) {
            i106 = this.user_rate.hashCode();
        } else {
            i106 = 0;
        }
        int i301 = (i300 + i106) * 37;
        if (this.with_new_goods != null) {
            i107 = this.with_new_goods.hashCode();
        } else {
            i107 = 0;
        }
        int i302 = (i301 + i107) * 37;
        if (this.is_flowcard_member != null) {
            i108 = this.is_flowcard_member.hashCode();
        } else {
            i108 = 0;
        }
        int i303 = (i302 + i108) * 37;
        if (this.room_cover != null) {
            i109 = this.room_cover.hashCode();
        } else {
            i109 = 0;
        }
        int i304 = (i303 + i109) * 37;
        if (this.download_setting != null) {
            i110 = this.download_setting.hashCode();
        } else {
            i110 = 0;
        }
        int i305 = (i304 + i110) * 37;
        if (this.download_prompt_ts != null) {
            i111 = this.download_prompt_ts.hashCode();
        } else {
            i111 = 0;
        }
        int i306 = (i305 + i111) * 37;
        if (this.react_setting != null) {
            i112 = this.react_setting.hashCode();
        } else {
            i112 = 0;
        }
        int i307 = (i306 + i112) * 37;
        if (this.live_commerce != null) {
            i113 = this.live_commerce.hashCode();
        } else {
            i113 = 0;
        }
        int i308 = (i307 + i113) * 37;
        if (this.college_name != null) {
            i114 = this.college_name.hashCode();
        } else {
            i114 = 0;
        }
        int i309 = (i308 + i114) * 37;
        if (this.enroll_year != null) {
            i115 = this.enroll_year.hashCode();
        } else {
            i115 = 0;
        }
        int i310 = (i309 + i115) * 37;
        if (this.country != null) {
            i116 = this.country.hashCode();
        } else {
            i116 = 0;
        }
        int i311 = (i310 + i116) * 37;
        if (this.province != null) {
            i117 = this.province.hashCode();
        } else {
            i117 = 0;
        }
        int i312 = (i311 + i117) * 37;
        if (this.city != null) {
            i118 = this.city.hashCode();
        } else {
            i118 = 0;
        }
        int hashCode5 = (((i312 + i118) * 37) + this.cover_url.hashCode()) * 37;
        if (this.recommend_reason_relation != null) {
            i119 = this.recommend_reason_relation.hashCode();
        } else {
            i119 = 0;
        }
        int i313 = (hashCode5 + i119) * 37;
        if (this.iso_country_code != null) {
            i120 = this.iso_country_code.hashCode();
        } else {
            i120 = 0;
        }
        int i314 = (i313 + i120) * 37;
        if (this.show_gender_strategy != null) {
            i121 = this.show_gender_strategy.hashCode();
        } else {
            i121 = 0;
        }
        int i315 = (i314 + i121) * 37;
        if (this.district != null) {
            i122 = this.district.hashCode();
        } else {
            i122 = 0;
        }
        int i316 = (i315 + i122) * 37;
        if (this.language != null) {
            i123 = this.language.hashCode();
        } else {
            i123 = 0;
        }
        int i317 = (i316 + i123) * 37;
        if (this.room_type_tag != null) {
            i124 = this.room_type_tag.hashCode();
        } else {
            i124 = 0;
        }
        int i318 = (i317 + i124) * 37;
        if (this.dou_plus_share_location != null) {
            i125 = this.dou_plus_share_location.hashCode();
        } else {
            i125 = 0;
        }
        int i319 = (i318 + i125) * 37;
        if (this.has_insights != null) {
            i126 = this.has_insights.hashCode();
        } else {
            i126 = 0;
        }
        int i320 = (i319 + i126) * 37;
        if (this.remark_name != null) {
            i127 = this.remark_name.hashCode();
        } else {
            i127 = 0;
        }
        int i321 = (i320 + i127) * 37;
        if (this.video_icon_virtual_URI != null) {
            i128 = this.video_icon_virtual_URI.hashCode();
        } else {
            i128 = 0;
        }
        int i322 = (i321 + i128) * 37;
        if (this.share_qrcode_uri != null) {
            i129 = this.share_qrcode_uri.hashCode();
        } else {
            i129 = 0;
        }
        int i323 = (i322 + i129) * 37;
        if (this.profile_tab_type != null) {
            i130 = this.profile_tab_type.hashCode();
        } else {
            i130 = 0;
        }
        int i324 = (i323 + i130) * 37;
        if (this.avatar_decoration != null) {
            i131 = this.avatar_decoration.hashCode();
        } else {
            i131 = 0;
        }
        int i325 = (i324 + i131) * 37;
        if (this.watch_status != null) {
            i132 = this.watch_status.hashCode();
        } else {
            i132 = 0;
        }
        int i326 = (i325 + i132) * 37;
        if (this.with_commerce_newbie_task != null) {
            i133 = this.with_commerce_newbie_task.hashCode();
        } else {
            i133 = 0;
        }
        int i327 = (i326 + i133) * 37;
        if (this.with_item_commerce_entry != null) {
            i134 = this.with_item_commerce_entry.hashCode();
        } else {
            i134 = 0;
        }
        int i328 = (i327 + i134) * 37;
        if (this.star_billboard_rank != null) {
            i135 = this.star_billboard_rank.hashCode();
        } else {
            i135 = 0;
        }
        int i329 = (i328 + i135) * 37;
        if (this.education != null) {
            i136 = this.education.hashCode();
        } else {
            i136 = 0;
        }
        int i330 = (i329 + i136) * 37;
        if (this.can_modify_school_info != null) {
            i137 = this.can_modify_school_info.hashCode();
        } else {
            i137 = 0;
        }
        int i331 = (i330 + i137) * 37;
        if (this.school_visible != null) {
            i138 = this.school_visible.hashCode();
        } else {
            i138 = 0;
        }
        int i332 = (i331 + i138) * 37;
        if (this.avatar_pendant_larger != null) {
            i139 = this.avatar_pendant_larger.hashCode();
        } else {
            i139 = 0;
        }
        int i333 = (i332 + i139) * 37;
        if (this.avatar_pendant_thumb != null) {
            i140 = this.avatar_pendant_thumb.hashCode();
        } else {
            i140 = 0;
        }
        int i334 = (i333 + i140) * 37;
        if (this.avatar_pendant_medium != null) {
            i141 = this.avatar_pendant_medium.hashCode();
        } else {
            i141 = 0;
        }
        int hashCode6 = (((i334 + i141) * 37) + this.item_list.hashCode()) * 37;
        if (this.user_mode != null) {
            i142 = this.user_mode.hashCode();
        } else {
            i142 = 0;
        }
        int i335 = (hashCode6 + i142) * 37;
        if (this.user_period != null) {
            i143 = this.user_period.hashCode();
        } else {
            i143 = 0;
        }
        int i336 = (i335 + i143) * 37;
        if (this.is_effect_artist != null) {
            i144 = this.is_effect_artist.hashCode();
        } else {
            i144 = 0;
        }
        int i337 = (i336 + i144) * 37;
        if (this.effect_detail != null) {
            i145 = this.effect_detail.hashCode();
        } else {
            i145 = 0;
        }
        int i338 = (i337 + i145) * 37;
        if (this.commerce_permissions != null) {
            i146 = this.commerce_permissions.hashCode();
        } else {
            i146 = 0;
        }
        int i339 = (i338 + i146) * 37;
        if (this.life_story_block != null) {
            i147 = this.life_story_block.hashCode();
        } else {
            i147 = 0;
        }
        int i340 = (i339 + i147) * 37;
        if (this.hide_following_follower_list != null) {
            i148 = this.hide_following_follower_list.hashCode();
        } else {
            i148 = 0;
        }
        int i341 = (i340 + i148) * 37;
        if (this.has_unread_story != null) {
            i149 = this.has_unread_story.hashCode();
        } else {
            i149 = 0;
        }
        int hashCode7 = (((i341 + i149) * 37) + this.new_story_cover.hashCode()) * 37;
        if (this.user_story_count != null) {
            i150 = this.user_story_count.hashCode();
        } else {
            i150 = 0;
        }
        int i342 = (hashCode7 + i150) * 37;
        if (this.has_story != null) {
            i151 = this.has_story.hashCode();
        } else {
            i151 = 0;
        }
        int i343 = (i342 + i151) * 37;
        if (this.is_star != null) {
            i152 = this.is_star.hashCode();
        } else {
            i152 = 0;
        }
        int i344 = (i343 + i152) * 37;
        if (this.douplus_toast != null) {
            i153 = this.douplus_toast.hashCode();
        } else {
            i153 = 0;
        }
        int i345 = (i344 + i153) * 37;
        if (this.cv_level != null) {
            i154 = this.cv_level.hashCode();
        } else {
            i154 = 0;
        }
        int i346 = (i345 + i154) * 37;
        if (this.creator_level != null) {
            i155 = this.creator_level.hashCode();
        } else {
            i155 = 0;
        }
        int i347 = (i346 + i155) * 37;
        if (this.is_mirror != null) {
            i156 = this.is_mirror.hashCode();
        } else {
            i156 = 0;
        }
        int i348 = (i347 + i156) * 37;
        if (this.pr_exempt != null) {
            i157 = this.pr_exempt.hashCode();
        } else {
            i157 = 0;
        }
        int hashCode8 = (((i348 + i157) * 37) + this.type_label.hashCode()) * 37;
        if (this.avatar_decoration_id != null) {
            i158 = this.avatar_decoration_id.hashCode();
        } else {
            i158 = 0;
        }
        int i349 = (hashCode8 + i158) * 37;
        if (this.with_luban_entry != null) {
            i159 = this.with_luban_entry.hashCode();
        } else {
            i159 = 0;
        }
        int hashCode9 = (((i349 + i159) * 37) + this.ad_cover_url.hashCode()) * 37;
        if (this.ad_cover_title != null) {
            i160 = this.ad_cover_title.hashCode();
        } else {
            i160 = 0;
        }
        int i350 = (hashCode9 + i160) * 37;
        if (this.ad_order_id != null) {
            i161 = this.ad_order_id.hashCode();
        } else {
            i161 = 0;
        }
        int i351 = (i350 + i161) * 37;
        if (this.r_fans_group_info != null) {
            i162 = this.r_fans_group_info.hashCode();
        } else {
            i162 = 0;
        }
        int i352 = (i351 + i162) * 37;
        if (this.with_commerce_enterprise_tab_entry != null) {
            i163 = this.with_commerce_enterprise_tab_entry.hashCode();
        } else {
            i163 = 0;
        }
        int i353 = (i352 + i163) * 37;
        if (this.honor_info != null) {
            i164 = this.honor_info.hashCode();
        } else {
            i164 = 0;
        }
        int i354 = (i353 + i164) * 37;
        if (this.comment_filter_status != null) {
            i165 = this.comment_filter_status.hashCode();
        } else {
            i165 = 0;
        }
        int i355 = (i354 + i165) * 37;
        if (this.notify_private_account != null) {
            i166 = this.notify_private_account.hashCode();
        } else {
            i166 = 0;
        }
        int i356 = (i355 + i166) * 37;
        if (this.avatar_168x168 != null) {
            i167 = this.avatar_168x168.hashCode();
        } else {
            i167 = 0;
        }
        int i357 = (i356 + i167) * 37;
        if (this.avatar_300x300 != null) {
            i168 = this.avatar_300x300.hashCode();
        } else {
            i168 = 0;
        }
        int i358 = (i357 + i168) * 37;
        if (this.is_blocked != null) {
            i169 = this.is_blocked.hashCode();
        } else {
            i169 = 0;
        }
        int i359 = (i358 + i169) * 37;
        if (this.force_private_account != null) {
            i170 = this.force_private_account.hashCode();
        } else {
            i170 = 0;
        }
        int i360 = (i359 + i170) * 37;
        if (this.with_star_atlas_entry != null) {
            i171 = this.with_star_atlas_entry.hashCode();
        } else {
            i171 = 0;
        }
        int i361 = (i360 + i171) * 37;
        if (this.sprint_support_user_info != null) {
            i172 = this.sprint_support_user_info.hashCode();
        } else {
            i172 = 0;
        }
        int i362 = (i361 + i172) * 37;
        if (this.signature_language != null) {
            i173 = this.signature_language.hashCode();
        } else {
            i173 = 0;
        }
        int i363 = (i362 + i173) * 37;
        if (this.brand_info != null) {
            i174 = this.brand_info.hashCode();
        } else {
            i174 = 0;
        }
        int i364 = (i363 + i174) * 37;
        if (this.display_wvalantine_activity_entry != null) {
            i175 = this.display_wvalantine_activity_entry.hashCode();
        } else {
            i175 = 0;
        }
        int i365 = (i364 + i175) * 37;
        if (this.shop_micro_app != null) {
            i176 = this.shop_micro_app.hashCode();
        } else {
            i176 = 0;
        }
        int i366 = (i365 + i176) * 37;
        if (this.commerce_user_info != null) {
            i177 = this.commerce_user_info.hashCode();
        } else {
            i177 = 0;
        }
        int hashCode10 = (((i366 + i177) * 37) + this.relative_users.hashCode()) * 37;
        if (this.quick_shop_info != null) {
            i178 = this.quick_shop_info.hashCode();
        } else {
            i178 = 0;
        }
        int i367 = (hashCode10 + i178) * 37;
        if (this.relation_label != null) {
            i179 = this.relation_label.hashCode();
        } else {
            i179 = 0;
        }
        int hashCode11 = (((i367 + i179) * 37) + this.cha_list.hashCode()) * 37;
        if (this.is_minor != null) {
            i180 = this.is_minor.hashCode();
        } else {
            i180 = 0;
        }
        int i368 = (hashCode11 + i180) * 37;
        if (this.sec_uid != null) {
            i181 = this.sec_uid.hashCode();
        } else {
            i181 = 0;
        }
        int i369 = (i368 + i181) * 37;
        if (this.recommend_score != null) {
            i182 = this.recommend_score.hashCode();
        } else {
            i182 = 0;
        }
        int i370 = (i369 + i182) * 37;
        if (this.wx_tag != null) {
            i183 = this.wx_tag.hashCode();
        } else {
            i183 = 0;
        }
        int i371 = (i370 + i183) * 37;
        if (this.open_insight_time != null) {
            i184 = this.open_insight_time.hashCode();
        } else {
            i184 = 0;
        }
        int i372 = (i371 + i184) * 37;
        if (this.general_permission != null) {
            i185 = this.general_permission.hashCode();
        } else {
            i185 = 0;
        }
        int i373 = (i372 + i185) * 37;
        if (this.birthday_hide_level != null) {
            i186 = this.birthday_hide_level.hashCode();
        } else {
            i186 = 0;
        }
        int i374 = (i373 + i186) * 37;
        if (this.bio_url != null) {
            i187 = this.bio_url.hashCode();
        } else {
            i187 = 0;
        }
        int i375 = (i374 + i187) * 37;
        if (this.bio_email != null) {
            i188 = this.bio_email.hashCode();
        } else {
            i188 = 0;
        }
        int i376 = (i375 + i188) * 37;
        if (this.latest_order_time != null) {
            i189 = this.latest_order_time.hashCode();
        } else {
            i189 = 0;
        }
        int i377 = (i376 + i189) * 37;
        if (this.is_pro_account != null) {
            i190 = this.is_pro_account.hashCode();
        } else {
            i190 = 0;
        }
        int i378 = (i377 + i190) * 37;
        if (this.with_stick_entry != null) {
            i191 = this.with_stick_entry.hashCode();
        } else {
            i191 = 0;
        }
        int i379 = (i378 + i191) * 37;
        if (this.email != null) {
            i192 = this.email.hashCode();
        } else {
            i192 = 0;
        }
        int i380 = (i379 + i192) * 37;
        if (this.is_email_verified != null) {
            i193 = this.is_email_verified.hashCode();
        } else {
            i193 = 0;
        }
        int i381 = (i380 + i193) * 37;
        if (this.bio_secure_url != null) {
            i194 = this.bio_secure_url.hashCode();
        } else {
            i194 = 0;
        }
        int i382 = (i381 + i194) * 37;
        if (this.collect_count != null) {
            i195 = this.collect_count.hashCode();
        } else {
            i195 = 0;
        }
        int i383 = (i382 + i195) * 37;
        if (this.nickname_update_reminder != null) {
            i196 = this.nickname_update_reminder.hashCode();
        } else {
            i196 = 0;
        }
        int i384 = (i383 + i196) * 37;
        if (this.avatar_update_reminder != null) {
            i198 = this.avatar_update_reminder.hashCode();
        }
        int i385 = i384 + i198;
        this.hashCode = i385;
        return i385;
