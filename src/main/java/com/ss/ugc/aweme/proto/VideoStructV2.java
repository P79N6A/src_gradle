...
public final class VideoStructV2 extends Message<VideoStructV2, Builder> {
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.BitRateStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 11)
    ...
    public static final class Builder extends Message.Builder<VideoStructV2, Builder> {
        ...
        public final VideoStructV2 build() {
            VideoStructV2 videoStructV2 = new VideoStructV2(this.play_addr, this.cover, this.height, this.width, this.dynamic_cover, this.origin_cover, this.ratio, this.download_addr, this.has_watermark, this.play_addr_lowbr, this.bit_rate, this.new_download_addr, this.duration, this.download_suffix_logo_addr, this.has_download_suffix_logo_addr, this.play_addr_265, this.is_h265, this.play_addr_h264, this.ui_alike_download_addr, this.caption_download_addr, this.cdn_url_expired, super.buildUnknownFields());
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (((i30 + i10) * 37) + this.bit_rate.hashCode()) * 37;
        if (this.new_download_addr != null) {
            i11 = this.new_download_addr.hashCode();
        } else {
            i11 = 0;
        }
        int i31 = (hashCode2 + i11) * 37;
        ...
        if (this.cdn_url_expired != null) {
            i21 = this.cdn_url_expired.hashCode();
        }
        int i40 = i39 + i21;
        this.hashCode = i40;
        return i40;
