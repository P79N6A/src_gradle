...
public final class UserShopCategoryV2 extends Message<UserShopCategoryV2, Builder> {
    @Keep
    ...
    public static final class Builder extends Message.Builder<UserShopCategoryV2, Builder> {
        public Long count;
        public Long id;
        public String name;

        public final UserShopCategoryV2 build() {
            return new UserShopCategoryV2(this.id, this.name, this.count, super.buildUnknownFields());
        }
    ...
    static final class ProtoAdapter_UserShopCategoryV2 extends ProtoAdapter<UserShopCategoryV2> {
        ...
        public final int encodedSize(UserShopCategoryV2 userShopCategoryV2) {
            return ProtoAdapter.INT64.encodedSizeWithTag(1, userShopCategoryV2.id) + ProtoAdapter.STRING.encodedSizeWithTag(2, userShopCategoryV2.name) + ProtoAdapter.INT64.encodedSizeWithTag(3, userShopCategoryV2.count) + userShopCategoryV2.unknownFields().size();
        }
        ...
        public final void encode(ProtoWriter protoWriter, UserShopCategoryV2 userShopCategoryV2) throws IOException {
            ProtoAdapter.INT64.encodeWithTag(protoWriter, 1, userShopCategoryV2.id);
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(userShopCategoryV2.unknownFields()) || !Internal.equals(this.id, userShopCategoryV2.id) || !Internal.equals(this.name, userShopCategoryV2.name) || !Internal.equals(this.count, userShopCategoryV2.count)) {
            return false;
        }
        return true;
    }
