...
public final class PoiFrontendTypeStructV2 extends Message<PoiFrontendTypeStructV2, Builder> {
    @Keep
    ...
    public static final class Builder extends Message.Builder<PoiFrontendTypeStructV2, Builder> {
        public String code;
        public String desc;
        public String name;
