...
public final class aweme_v2_feed_response extends Message<aweme_v2_feed_response, Builder> {
    ...
    @WireField(adapter = "com.ss.ugc.aweme.proto.AwemeStructV2#ADAPTER", label = WireField.Label.REPEATED, tag = 13)
