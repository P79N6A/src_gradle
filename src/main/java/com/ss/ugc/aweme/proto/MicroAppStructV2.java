...
public final class MicroAppStructV2 extends Message<MicroAppStructV2, Builder> {
    ...
    public static final class Builder extends Message.Builder<MicroAppStructV2, Builder> {
        ...
        public final MicroAppStructV2 build() {
            MicroAppStructV2 microAppStructV2 = new MicroAppStructV2(this.app_id, this.app_name, this.icon, this.orientation, this.schema, this.state, this.summary, this.type, this.description, this.title, this.card, super.buildUnknownFields());
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(microAppStructV2.unknownFields()) || !Internal.equals(this.app_id, microAppStructV2.app_id) || !Internal.equals(this.app_name, microAppStructV2.app_name) || !Internal.equals(this.icon, microAppStructV2.icon) || !Internal.equals(this.orientation, microAppStructV2.orientation) || !Internal.equals(this.schema, microAppStructV2.schema) || !Internal.equals(this.state, microAppStructV2.state) || !Internal.equals(this.summary, microAppStructV2.summary) || !Internal.equals(this.type, microAppStructV2.type) || !Internal.equals(this.description, microAppStructV2.description) || !Internal.equals(this.title, microAppStructV2.title) || !Internal.equals(this.card, microAppStructV2.card)) {
            return false;
        }
        return true;
    }

    public MicroAppStructV2(String str, String str2, String str3, Integer num, String str4, Integer num2, String str5, Integer num3, String str6, String str7, MicroAppCardStructV2 microAppCardStructV2) {
        this(str, str2, str3, num, str4, num2, str5, num3, str6, str7, microAppCardStructV2, ByteString.EMPTY);
    }

    public MicroAppStructV2(String str, String str2, String str3, Integer num, String str4, Integer num2, String str5, Integer num3, String str6, String str7, MicroAppCardStructV2 microAppCardStructV2, ByteString byteString) {
