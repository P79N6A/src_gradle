...
public final class LongVideoStructV2 extends Message<LongVideoStructV2, Builder> {
    ...
    public LongVideoStructV2(VideoStructV2 videoStructV2, Integer num, Double d2, VideoControlV2 videoControlV2) {
        this(videoStructV2, num, d2, videoControlV2, ByteString.EMPTY);
    }

    public LongVideoStructV2(VideoStructV2 videoStructV2, Integer num, Double d2, VideoControlV2 videoControlV2, ByteString byteString) {
