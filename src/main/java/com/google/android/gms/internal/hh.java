...
public class hh {
    ...
    public static long getLong(ContentResolver contentResolver, String str, long j) {
        ...
        long j2 = 0;
        Long l = (Long) zza(zzbUf, str, (T) 0L);
        if (l != null) {
            return l.longValue();
        }
    ...
    private static <T> T zza(java.util.HashMap<java.lang.String, T> r2, java.lang.String r3, T r4) {
        ...
        L_0x0016:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.hh.zza(java.util.HashMap, java.lang.String, java.lang.Object):java.lang.Object");
    }
    ...
    public static java.lang.String zza(android.content.ContentResolver r9, java.lang.String r10, java.lang.String r11) {
        /*
            java.lang.Class<com.google.android.gms.internal.hh> r11 = com.google.android.gms.internal.hh.class
            monitor-enter(r11)
            zza(r9)     // Catch:{ all -> 0x009f }
            java.lang.Object r0 = zzbUh     // Catch:{ all -> 0x009f }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzbUc     // Catch:{ all -> 0x009f }
            boolean r1 = r1.containsKey(r10)     // Catch:{ all -> 0x009f }
            r2 = 0
            if (r1 == 0) goto L_0x001f
            java.util.HashMap<java.lang.String, java.lang.String> r9 = zzbUc     // Catch:{ all -> 0x009f }
            java.lang.Object r9 = r9.get(r10)     // Catch:{ all -> 0x009f }
        ...
        L_0x001d:
            ...
            return r9
        L_0x001f:
            java.lang.String[] r1 = zzbUj     // Catch:{ all -> 0x009f }
            int r3 = r1.length     // Catch:{ all -> 0x009f }
            r4 = 0
            r5 = 0
        L_0x0024:
            if (r5 >= r3) goto L_0x005a
            r6 = r1[r5]     // Catch:{ all -> 0x009f }
            boolean r6 = r10.startsWith(r6)     // Catch:{ all -> 0x009f }
            if (r6 == 0) goto L_0x0057
            boolean r0 = zzbUi     // Catch:{ all -> 0x009f }
            if (r0 == 0) goto L_0x003a
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzbUc     // Catch:{ all -> 0x009f }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x009f }
            if (r0 == 0) goto L_0x0055
        L_0x003a:
            java.lang.String[] r0 = zzbUj     // Catch:{ all -> 0x009f }
            zzc(r9, r0)     // Catch:{ all -> 0x009f }
            java.util.HashMap<java.lang.String, java.lang.String> r9 = zzbUc     // Catch:{ all -> 0x009f }
            boolean r9 = r9.containsKey(r10)     // Catch:{ all -> 0x009f }
        ...
        L_0x005a:
            ...
            boolean r11 = r9.moveToFirst()     // Catch:{ all -> 0x008e }
            if (r11 != 0) goto L_0x0074
            goto L_0x0090
        L_0x0074:
            java.lang.String r11 = r9.getString(r1)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x0081
            boolean r1 = r11.equals(r2)     // Catch:{ all -> 0x008e }
            if (r1 == 0) goto L_0x0081
            r11 = r2
        L_0x0081:
            zza((java.lang.Object) r0, (java.lang.String) r10, (java.lang.String) r11)     // Catch:{ all -> 0x008e }
        ...
        L_0x008e:
            ...
            goto L_0x0099
        L_0x0090:
            zza((java.lang.Object) r0, (java.lang.String) r10, (java.lang.String) r2)     // Catch:{ all -> 0x008e }
    ...
    public static void zzb(android.content.ContentResolver r8, java.lang.String... r9) {
        ...
        L_0x0004:
            ...
            java.lang.String[] r1 = zzbUj     // Catch:{ all -> 0x0077 }
        ...
        L_0x0044:
            ...
            zzbUj = r9     // Catch:{ all -> 0x0077 }
            int r9 = r1.size()     // Catch:{ all -> 0x0077 }
            java.lang.String[] r9 = new java.lang.String[r9]     // Catch:{ all -> 0x0077 }
            java.lang.Object[] r9 = r1.toArray(r9)     // Catch:{ all -> 0x0077 }
            java.lang.String[] r9 = (java.lang.String[]) r9     // Catch:{ all -> 0x0077 }
        L_0x005e:
            boolean r1 = zzbUi     // Catch:{ all -> 0x0077 }
            if (r1 == 0) goto L_0x0072
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzbUc     // Catch:{ all -> 0x0077 }
        ...
        L_0x006e:
            ...
            goto L_0x0075
        L_0x0072:
            java.lang.String[] r9 = zzbUj     // Catch:{ all -> 0x0077 }
            goto L_0x006e
        L_0x0075:
        ...
        L_0x0077:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.hh.zzb(android.content.ContentResolver, java.lang.String[]):void");
    }
