...
public final class zzbbo implements zzbdo {
    ...
    public zzbbo(Context context, Lock lock, Looper looper, zze zze, Map<Api.zzc<?>, Api.zze> map, zzq zzq, Map<Api<?>, Boolean> map2, Api.zza<? extends zzctj, zzctk> zza, ArrayList<zzbbh> arrayList, zzbco zzbco, boolean z) {
        ...
        for (Map.Entry next2 : map.entrySet()) {
            ...
            zzbbn zzbbn = r1;
            zzbbn zzbbn2 = new zzbbn(context, api, looper, zze2, (zzbbh) hashMap2.get(api), zzq, zza);
    ...
    private final boolean zzpK() {
        ...
        try {
            if (this.zzaCK) {
                if (this.zzaCH) {
                    for (Api.zzc<?> zzb : this.zzaCC.keySet()) {
    ...
    public final void connect() {
        ...
        try {
            if (!this.zzaCK) {
                ...
                this.zzaCO = null;
                this.zzaAN.zzps();
                this.zzaAN.zza((Iterable<? extends GoogleApi<?>>) this.zzaCB.values()).addOnCompleteListener((Executor) new zzbgu(this.zzrO), (OnCompleteListener<TResult>) new zzbbq<TResult>(this));
            }
        } finally {
            this.zzaCv.unlock();
        }
    ...
    public final boolean zza(zzbeh zzbeh) {
        ...
        try {
            ...
            this.zzaAN.zza((Iterable<? extends GoogleApi<?>>) this.zzaCC.values()).addOnCompleteListener((Executor) new zzbgu(this.zzrO), (OnCompleteListener<TResult>) this.zzaCN);
            this.zzaCv.unlock();
            return true;
        } catch (Throwable th) {
            this.zzaCv.unlock();
