...
@GwtCompatible
public interface bd<K, V> {
    Map<K, Collection<V>> asMap();

    void clear();

    boolean containsEntry(@NullableDecl @CompatibleWith Object obj, @NullableDecl @CompatibleWith Object obj2);
    ...
    @CanIgnoreReturnValue
    boolean putAll(bd<? extends K, ? extends V> bdVar);
    ...
    @CanIgnoreReturnValue
    Collection<V> removeAll(@NullableDecl @CompatibleWith Object obj);
