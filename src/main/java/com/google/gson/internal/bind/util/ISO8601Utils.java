...
public class ISO8601Utils {
    ...
    public static java.util.Date parse(java.lang.String r17, java.text.ParsePosition r18) throws java.text.ParseException {
        /*
            ...
            int r3 = r0 + 4
            int r0 = parseInt(r1, r0, r3)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            r4 = 45
            boolean r5 = checkOffset(r1, r3, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            if (r5 == 0) goto L_0x0018
            int r3 = r3 + 1
        L_0x0018:
            int r5 = r3 + 2
            int r3 = parseInt(r1, r3, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            boolean r6 = checkOffset(r1, r5, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            if (r6 == 0) goto L_0x0026
            int r5 = r5 + 1
        L_0x0026:
            int r6 = r5 + 2
            int r5 = parseInt(r1, r5, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            r7 = 84
            boolean r7 = checkOffset(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            r8 = 1
        ...
        L_0x0049:
            ...
            int r6 = r6 + 1
            int r7 = r6 + 2
            int r6 = parseInt(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            r12 = 58
            boolean r13 = checkOffset(r1, r7, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            if (r13 == 0) goto L_0x0061
            int r7 = r7 + 1
        L_0x0061:
            int r13 = r7 + 2
            int r7 = parseInt(r1, r7, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            boolean r12 = checkOffset(r1, r13, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
        ...
        L_0x006f:
            ...
            int r12 = r13 + 2
            int r13 = parseInt(r1, r13, r12)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            r14 = 59
        ...
        L_0x008f:
            r13 = 46
            boolean r13 = checkOffset(r1, r12, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            if (r13 == 0) goto L_0x00b6
            int r12 = r12 + 1
            int r13 = r12 + 1
            int r13 = indexOfNonDigit(r1, r13)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            int r15 = r12 + 3
            ...
            int r16 = parseInt(r1, r12, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            int r15 = r15 - r12
            switch(r15) {
        ...
        L_0x00be:
            ...
            java.util.TimeZone r4 = TIMEZONE_UTC     // Catch:{ IndexOutOfBoundsException -> 0x01ac, NumberFormatException -> 0x01aa, IllegalArgumentException -> 0x01a8 }
            int r13 = r13 + r8
            goto L_0x016f
        L_0x00d0:
