...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public class _lancet {
        ...
        @Insert
        @TargetClass
        static List com_ss_android_ugc_aweme_lancet_GsonLancet_getFieldNames(ReflectiveTypeAdapterFactory reflectiveTypeAdapterFactory, Field field) {
            try {
                return reflectiveTypeAdapterFactory.getFieldNames$___twin___(field);
            } catch (IncompatibleClassChangeError e2) {
                a.a((Throwable) e2);
                return Collections.singletonList(reflectiveTypeAdapterFactory.fieldNamingPolicy.translateName(field));
            }
        }
    }

    private List getFieldNames(Field field) {
        return _lancet.com_ss_android_ugc_aweme_lancet_GsonLancet_getFieldNames(this, field);
    }

    public final List<String> getFieldNames$___twin___(Field field) {
        ...
        while (cls2 != Object.class) {
            ...
            while (i < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    if (boundField != null) {
                        throw new IllegalArgumentException(type + " declares multiple JSON fields named " + r14.name);
                    }
                }
                i++;
                z2 = false;
