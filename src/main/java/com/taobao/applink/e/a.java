...
public class a {
    ...
    private static Map f79175a;

    static {
        HashMap hashMap = new HashMap();
        f79175a = hashMap;
        hashMap.put("jumpShop", TBShopParam.class);
        f79175a.put("jumpDetail", TBDetailParam.class);
        f79175a.put("jumpH5", TBURIParam.class);
        f79175a.put("doAuth", TBAuthParam.class);
        f79175a.put("jumpNav", TBNavParam.class);
    }
