...
public class b implements Handler.Callback {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0050, code lost:
        if (r4.f79153a.f79151d != null) goto L_0x005b;
     */
    ...
    public boolean handleMessage(android.os.Message r5) {
        ...
        L_0x000b:
            ...
            r1.icon = r5
            com.taobao.applink.auth.a r5 = r4.f79153a
            com.taobao.applink.auth.TBAppLinkAuthListener r5 = r5.f79151d
        ...
        L_0x0064:
            com.taobao.applink.auth.a r5 = r4.f79153a
            r1 = 0
            com.taobao.applink.auth.TBAppLinkAuthListener unused = r5.f79151d = r1
        L_0x006a:
            android.app.Application r5 = com.taobao.applink.util.TBAppLinkUtil.getApplication()
            if (r5 == 0) goto L_0x007b
            android.app.Application r5 = com.taobao.applink.util.TBAppLinkUtil.getApplication()
            android.content.ServiceConnection r1 = com.taobao.applink.auth.a.f79148a
            r5.unbindService(r1)
        L_0x007b:
            return r0
        */
