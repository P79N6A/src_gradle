...
public class SessionProtobufHelper {
    private static final ByteString SIGNAL_DEFAULT_BYTE_STRING = ByteString.copyFromUtf8(PushConstants.PUSH_TYPE_NOTIFY);
    ...
    private static int getDeviceIdentifierSize(s.a aVar, String str) {
        return CodedOutputStream.computeEnumSize(1, aVar.protobufIndex) + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(str));
    }
    ...
    private static int getFrameSize(StackTraceElement stackTraceElement, boolean z) {
        ...
        int computeBytesSize = i + CodedOutputStream.computeBytesSize(2, ByteString.copyFromUtf8(stackTraceElement.getClassName() + ClassUtils.PACKAGE_SEPARATOR + stackTraceElement.getMethodName()));
    ...
    private static void writeFrame(CodedOutputStream codedOutputStream, int i, StackTraceElement stackTraceElement, boolean z) throws Exception {
        ...
        codedOutputStream.writeBytes(2, ByteString.copyFromUtf8(stackTraceElement.getClassName() + ClassUtils.PACKAGE_SEPARATOR + stackTraceElement.getMethodName()));
        if (stackTraceElement.getFileName() != null) {
    ...
    public static void writeSessionApp(CodedOutputStream codedOutputStream, String str, String str2, String str3, String str4, String str5, int i, String str6) throws Exception {
        ...
        if (str6 != null) {
            byteString = ByteString.copyFromUtf8(str6);
        } else {
            byteString = null;
        }
        codedOutputStream.writeTag(7, 2);
        codedOutputStream.writeRawVarint32(getSessionAppSize(copyFromUtf8, copyFromUtf82, copyFromUtf83, copyFromUtf84, copyFromUtf85, i, byteString));
        codedOutputStream.writeBytes(1, copyFromUtf8);
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<s.a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        int i4;
        int i5;
        int i6 = 0;
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<s.a, String> map, int i3, String str2, String str3) throws Exception {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            codedOutputStream2.writeEnum(1, ((s.a) next.getKey()).protobufIndex);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f2, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        codedOutputStream2.writeRawVarint32(getSessionEventSize(j, str, trimmedThrowableData, thread, stackTraceElementArr, threadArr, list, 8, map, runningAppProcessInfo, i, copyFromUtf82, byteString, f2, i2, z, j2, j3, byteStringForLog));
        ...
        writeSessionEventDevice(codedOutputStream, f2, i2, z, i, j2, j3);
