...
public class CLSUUID {
    ...
    public CLSUUID(s sVar) {
        ...
        populatePID(bArr);
        String a2 = i.a(sVar.a());
        String a3 = i.a(bArr);
        _clsId = String.format(Locale.US, "%s-%s-%s-%s", new Object[]{a3.substring(0, 12), a3.substring(12, 16), a3.subSequence(16, 20), a2.substring(0, 12)}).toUpperCase(Locale.US);
    }
}
