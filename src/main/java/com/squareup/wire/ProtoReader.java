...
public final class ProtoReader {
    ...
    private int internalReadVarint32() throws IOException {
        ...
        byte b3 = readByte & Byte.MAX_VALUE;
        this.source.require(1);
        this.pos++;
        ...
        if (readByte2 >= 0) {
            ...
            byte b4 = b3 | ((readByte2 & Byte.MAX_VALUE) << 7);
            this.source.require(1);
            this.pos++;
            ...
            if (readByte3 >= 0) {
                ...
                byte b5 = b4 | ((readByte3 & Byte.MAX_VALUE) << 14);
                this.source.require(1);
                this.pos++;
                ...
                if (readByte4 >= 0) {
                    ...
                    byte b6 = b5 | ((readByte4 & Byte.MAX_VALUE) << 21);
                    this.source.require(1);
                    this.pos++;
            ...
            if (internalReadVarint32 != 0) {
                ...
                switch (internalReadVarint32 & 7) {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        throw new ProtocolException("Unexpected field encoding: " + r0);
                }
            } else {
                throw new ProtocolException("Unexpected tag 0");
            }
