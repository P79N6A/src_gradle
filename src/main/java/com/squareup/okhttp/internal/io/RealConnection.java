...
public final class RealConnection implements Connection {
    ...
    private void connectTls(int r6, int r7, com.squareup.okhttp.internal.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x0040:
            ...
            r3.check((java.lang.String) r6, (java.util.List<java.security.cert.Certificate>) r2)     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
        L_0x0085:
        ...
        L_0x0093:
            ...
            okio.Source r6 = okio.Okio.source((java.net.Socket) r6)     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
            okio.BufferedSource r6 = okio.Okio.buffer((okio.Source) r6)     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
            r5.source = r6     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
            java.net.Socket r6 = r5.socket     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
            okio.Sink r6 = okio.Okio.sink((java.net.Socket) r6)     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
            okio.BufferedSink r6 = okio.Okio.buffer((okio.Sink) r6)     // Catch:{ AssertionError -> 0x0111, all -> 0x010f }
