...
public enum h {
    ...
    MOUNT_UNMOUNT_FILESYSTEMS(BaseLoginOrRegisterActivity.o),
    NFC(102),
    ...
    READ_SYNC_STATS(SearchJediMixFeedAdapter.f42516e),
    READ_VOICEMAIL(113),
    ...
    SIGNAL_PERSISTENT_PROCESSES(SearchJediMixFeedAdapter.f42517f),
    STATUS_BAR(129),
    ...
    WRITE_VOICEMAIL(SearchJediMixFeedAdapter.g);
