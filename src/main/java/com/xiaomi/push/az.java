...
public class az {
    ...
    public static java.lang.String a(java.util.Iterator<?> r3, java.lang.String r4) {
        ...
        L_0x003e:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.az.a(java.util.Iterator, java.lang.String):java.lang.String");
    }
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static byte[] m94a(String str) {
        try {
    ...
    public static boolean m95b(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
    ...
    public static boolean m96c(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
