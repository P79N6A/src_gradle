...
public final class u {
    ...
    private static u f79517b;

    /* renamed from: a  reason: collision with root package name */
    public boolean f79518a = true;

    /* renamed from: c  reason: collision with root package name */
    private final p f79519c;

    /* renamed from: d  reason: collision with root package name */
    private final Context f79520d;

    /* renamed from: e  reason: collision with root package name */
    private Map<Integer, Long> f79521e = new HashMap();

    /* renamed from: f  reason: collision with root package name */
    private long f79522f;
    private long g;
    ...
    class a implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Context f79527a;

        /* renamed from: b  reason: collision with root package name */
        private final Runnable f79528b;

        /* renamed from: c  reason: collision with root package name */
        private final long f79529c;

        public final void run() {
            if (!z.a(this.f79527a, "security_info", 30000)) {
                ...
                if (u.this.p != null) {
                    if (u.this.b()) {
                        ...
                        if (this.f79528b != null) {
                            u.this.a(this.f79528b, this.f79529c);
                        }
                        u.this.c(0);
                        z.b(this.f79527a, "security_info");
                ...
                byte[] a3 = z.a((int) SearchJediMixFeedAdapter.f42517f);
    ...
    public final void a(int i2, am amVar, String str, String str2, t tVar, long j2, boolean z) {
        try {
            v vVar = new v(this.f79520d, i2, amVar.g, a.a((Object) amVar), str, str2, tVar, this.f79518a, z);
            a(vVar, true, true, j2);
        } catch (Throwable th) {
            x.a(th);
        }
    ...
    public final void a(int i2, int i3, byte[] bArr, String str, String str2, t tVar, int i4, int i5, boolean z, Map<String, String> map) {
        try {
            v vVar = new v(this.f79520d, i2, i3, bArr, str, str2, tVar, this.f79518a, i4, i5, false, map);
            a(vVar, z, false, 0);
        } catch (Throwable th) {
            x.a(th);
        }
    ...
    public final long a(boolean r12) {
        ...
        L_0x0009:
            r3 = 3
        L_0x000a:
            com.tencent.bugly.proguard.p r4 = r11.f79519c
            ...
            long r8 = r12.f79512e     // Catch:{ Throwable -> 0x003c }
            ...
            r11.f79522f = r0     // Catch:{ Throwable -> 0x0032 }
            goto L_0x0036
        L_0x0032:
            r12 = move-exception
            goto L_0x003e
        ...
        L_0x0041:
            ...
            com.tencent.bugly.proguard.p r12 = r11.f79519c
            r12.a((java.util.List) r4)
            goto L_0x0054
        L_0x004d:
    ...
    public final synchronized void a(int i2, long j2) {
        if (i2 >= 0) {
            this.f79521e.put(Integer.valueOf(i2), Long.valueOf(j2));
            r rVar = new r();
            rVar.f79509b = i2;
            rVar.f79512e = j2;
            rVar.f79510c = "";
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0053, code lost:
        if (r8 == null) goto L_0x0102;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x005b, code lost:
        if (r8.containsKey("S1") == false) goto L_0x0102;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0063, code lost:
        if (r8.containsKey("S2") == false) goto L_0x0102;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0065, code lost:
        r7.m = r9.f79436e - java.lang.System.currentTimeMillis();
        com.tencent.bugly.proguard.x.c("[UploadManager] Time lag of server is: %d", java.lang.Long.valueOf(r7.m));
        r7.p = r8.get("S1");
        com.tencent.bugly.proguard.x.c("[UploadManager] Session ID from server is: %s", r7.p);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0099, code lost:
        if (r7.p.length() <= 0) goto L_0x00f6;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:?, code lost:
        r7.q = java.lang.Long.parseLong(r8.get("S2"));
        com.tencent.bugly.proguard.x.c("[UploadManager] Session expired time from server is: %d(%s)", java.lang.Long.valueOf(r7.q), new java.util.Date(r7.q).toString());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00ce, code lost:
        if (r7.q >= 1000) goto L_0x00e3;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:47:0x0129 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void a(int r8, com.tencent.bugly.proguard.an r9) {
        /*
            r7 = this;
            boolean r0 = r7.f79518a
        ...
        L_0x0033:
            ...
            boolean r3 = r8.containsKey(r3)     // Catch:{ Throwable -> 0x00fe }
            if (r3 == 0) goto L_0x0102
            long r3 = r9.f79436e     // Catch:{ Throwable -> 0x00fe }
        ...
        L_0x0126:
            ...
            android.content.Context r9 = r7.f79520d     // Catch:{ all -> 0x0138 }
    ...
    public final synchronized long a(int i2) {
        ...
        if (i2 >= 0) {
            try {
                Long l2 = this.f79521e.get(Integer.valueOf(i2));
                if (l2 != null) {
                    return l2.longValue();
                }
                List<r> a2 = this.f79519c.a(i2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x00a9, code lost:
        r1 = new com.tencent.bugly.proguard.u.a(r11, r7.f79520d, r12, r15);
        a((java.lang.Runnable) r1, 0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x00ba, code lost:
        a(r12, r13);
        r0 = new com.tencent.bugly.proguard.u.a(r11, r7.f79520d);
    ...
    private void a(java.lang.Runnable r12, boolean r13, boolean r14, long r15) {
        ...
        L_0x0089:
            ...
            android.content.Context r3 = r7.f79520d
            r1 = r8
            r2 = r11
            r4 = r12
            r5 = r15
        ...
        L_0x00ba:
            ...
            android.content.Context r1 = r7.f79520d
            r0.<init>(r1)
