...
public final class b {
    ...
    private AtomicInteger f79328a = new AtomicInteger(0);

    /* renamed from: b  reason: collision with root package name */
    private long f79329b = -1;

    /* renamed from: c  reason: collision with root package name */
    private final Context f79330c;

    /* renamed from: d  reason: collision with root package name */
    private final a f79331d;

    /* renamed from: e  reason: collision with root package name */
    private final w f79332e;

    /* renamed from: f  reason: collision with root package name */
    private final com.tencent.bugly.crashreport.common.strategy.a f79333f;
    ...
    private CrashDetailBean a(a aVar) {
        ...
        try {
            ...
            crashDetailBean.E = this.f79331d.p();
            crashDetailBean.F = this.f79331d.o();
            crashDetailBean.G = this.f79331d.q();
            crashDetailBean.w = z.a(this.f79330c, c.f79348e, (String) null);
            crashDetailBean.f79303b = 3;
            crashDetailBean.f79306e = this.f79331d.h();
            crashDetailBean.f79307f = this.f79331d.j;
            crashDetailBean.g = this.f79331d.w();
            crashDetailBean.m = this.f79331d.g();
            crashDetailBean.n = "ANR_EXCEPTION";
            crashDetailBean.o = aVar.f79327f;
            crashDetailBean.q = aVar.g;
            crashDetailBean.N = new HashMap();
            crashDetailBean.N.put("BUGLY_CR_01", aVar.f79326e);
            int i2 = -1;
            if (crashDetailBean.q != null) {
                i2 = crashDetailBean.q.indexOf("\n");
            }
            if (i2 > 0) {
                str = crashDetailBean.q.substring(0, i2);
            } else {
                str = "GET_FAIL";
            }
            crashDetailBean.p = str;
            crashDetailBean.r = aVar.f79324c;
            if (crashDetailBean.q != null) {
                crashDetailBean.u = z.b(crashDetailBean.q.getBytes());
            }
            crashDetailBean.y = aVar.f79323b;
            crashDetailBean.z = this.f79331d.f79277d;
            crashDetailBean.A = "main(1)";
            crashDetailBean.H = this.f79331d.y();
            crashDetailBean.h = this.f79331d.v();
            crashDetailBean.i = this.f79331d.K();
            crashDetailBean.v = aVar.f79325d;
            crashDetailBean.K = this.f79331d.n;
            crashDetailBean.L = this.f79331d.f79274a;
            crashDetailBean.M = this.f79331d.a();
            crashDetailBean.O = this.f79331d.H();
            crashDetailBean.P = this.f79331d.I();
            crashDetailBean.Q = this.f79331d.B();
            crashDetailBean.R = this.f79331d.G();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x004d, code lost:
        if (java.lang.Math.abs(r7 - r1.f79329b) >= 10000) goto L_0x0064;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:?, code lost:
        r2 = com.tencent.bugly.proguard.z.a(com.tencent.bugly.crashreport.crash.c.f79349f, false);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x007b, code lost:
        ...
        r5 = (android.app.ActivityManager) r5.getSystemService(com.meizu.cloud.pushsdk.constants.PushConstants.INTENT_ACTIVITY_NAME);
        r6 = 0;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:52:0x0103, code lost:
        if (r1.f79333f.b() != false) goto L_0x0120;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x0120, code lost:
        r5 = new java.io.File(r4.getFilesDir(), "bugly/bugly_trace_" + r7 + ".txt");
        r4 = new com.tencent.bugly.crashreport.crash.anr.a();
        r4.f79324c = r7;
        r4.f79325d = r5.getAbsolutePath();
        r4.f79322a = r15.processName;
        r4.f79327f = r15.shortMsg;
        r4.f79326e = r15.longMsg;
        r4.f79323b = r2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:66:0x017e, code lost:
        ...
        r5[0] = java.lang.Long.valueOf(r4.f79324c);
        r5[1] = r4.f79325d;
        r5[2] = r4.f79322a;
        r5[3] = r4.f79327f;
        r5[4] = r4.f79326e;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:67:0x01a2, code lost:
        if (r4.f79323b != null) goto L_0x01a6;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:71:0x01bb, code lost:
        if (r1.f79333f.b() != false) goto L_0x01d5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:72:0x01bd, code lost:
        ...
        com.tencent.bugly.crashreport.crash.b.a("ANR", com.tencent.bugly.proguard.z.a(), r4.f79322a, null, r4.f79326e, null);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:74:0x01dd, code lost:
        if (r1.f79333f.c().j != false) goto L_0x01e8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:87:0x0235, code lost:
        if (a(r0, r4.f79325d, r4.f79322a) == false) goto L_0x023e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:89:0x023e, code lost:
        com.tencent.bugly.crashreport.crash.b.a("ANR", com.tencent.bugly.proguard.z.a(), r4.f79322a, null, r4.f79326e, r2);
     */
    ...
    public final void a(java.lang.String r17) {
        /*
            ...
            r0 = r17
            monitor-enter(r16)
            java.util.concurrent.atomic.AtomicInteger r2 = r1.f79328a     // Catch:{ all -> 0x02a1 }
            int r2 = r2.get()     // Catch:{ all -> 0x02a1 }
            r3 = 0
            if (r2 == 0) goto L_0x0017
            java.lang.String r0 = "trace started return "
            java.lang.Object[] r2 = new java.lang.Object[r3]     // Catch:{ all -> 0x02a1 }
            com.tencent.bugly.proguard.x.c(r0, r2)     // Catch:{ all -> 0x02a1 }
            monitor-exit(r16)     // Catch:{ all -> 0x02a1 }
            return
        L_0x0017:
            java.util.concurrent.atomic.AtomicInteger r2 = r1.f79328a     // Catch:{ all -> 0x02a1 }
            r4 = 1
            r2.set(r4)     // Catch:{ all -> 0x02a1 }
            monitor-exit(r16)     // Catch:{ all -> 0x02a1 }
            ...
            long r7 = r2.f79320c     // Catch:{ Throwable -> 0x0284 }
            goto L_0x0031
        L_0x0030:
            r7 = r5
        L_0x0031:
        ...
        L_0x0040:
            long r5 = r1.f79329b     // Catch:{ Throwable -> 0x0284 }
            r2 = 0
            long r5 = r7 - r5
        ...
        L_0x005e:
            java.util.concurrent.atomic.AtomicInteger r0 = r1.f79328a
            r0.set(r3)
            return
        L_0x0064:
            r1.f79329b = r7     // Catch:{ Throwable -> 0x0284 }
            java.util.concurrent.atomic.AtomicInteger r2 = r1.f79328a     // Catch:{ Throwable -> 0x0284 }
            r2.set(r4)     // Catch:{ Throwable -> 0x0284 }
            int r2 = com.tencent.bugly.crashreport.crash.c.f79349f     // Catch:{ Throwable -> 0x0275 }
            ...
            goto L_0x026c
        L_0x007b:
            android.content.Context r5 = r1.f79330c     // Catch:{ Throwable -> 0x0284 }
        ...
        L_0x00ef:
            ...
            android.content.Context r4 = r1.f79330c     // Catch:{ Throwable -> 0x0284 }
            com.tencent.bugly.crashreport.common.strategy.a r5 = r1.f79333f     // Catch:{ Throwable -> 0x0284 }
            ...
            r5 = 0
        L_0x010d:
            com.tencent.bugly.crashreport.common.strategy.a r6 = r1.f79333f     // Catch:{ Throwable -> 0x0284 }
        ...
        L_0x017e:
            ...
            long r6 = r4.f79324c     // Catch:{ Throwable -> 0x0284 }
            java.lang.Long r6 = java.lang.Long.valueOf(r6)     // Catch:{ Throwable -> 0x0284 }
            r5[r3] = r6     // Catch:{ Throwable -> 0x0284 }
            java.lang.String r6 = r4.f79325d     // Catch:{ Throwable -> 0x0284 }
            r7 = 1
            r5[r7] = r6     // Catch:{ Throwable -> 0x0284 }
            java.lang.String r6 = r4.f79322a     // Catch:{ Throwable -> 0x0284 }
            r7 = 2
            r5[r7] = r6     // Catch:{ Throwable -> 0x0284 }
            java.lang.String r6 = r4.f79327f     // Catch:{ Throwable -> 0x0284 }
            r7 = 3
            r5[r7] = r6     // Catch:{ Throwable -> 0x0284 }
            r6 = 4
            java.lang.String r8 = r4.f79326e     // Catch:{ Throwable -> 0x0284 }
            r5[r6] = r8     // Catch:{ Throwable -> 0x0284 }
            r6 = 5
            java.util.Map<java.lang.String, java.lang.String> r8 = r4.f79323b     // Catch:{ Throwable -> 0x0284 }
        ...
        L_0x01ac:
            ...
            r5[r6] = r8     // Catch:{ Throwable -> 0x0284 }
            com.tencent.bugly.proguard.x.c(r2, r5)     // Catch:{ Throwable -> 0x0284 }
            com.tencent.bugly.crashreport.common.strategy.a r2 = r1.f79333f     // Catch:{ Throwable -> 0x0284 }
            ...
            java.lang.String r7 = r4.f79322a     // Catch:{ Throwable -> 0x0284 }
            r8 = 0
            java.lang.String r9 = r4.f79326e     // Catch:{ Throwable -> 0x0284 }
            r10 = 0
        ...
        L_0x01fd:
            ...
            long r5 = r2.f79302a     // Catch:{ Throwable -> 0x0284 }
            r8 = 0
        ...
        L_0x021b:
            ...
            java.util.concurrent.atomic.AtomicInteger r5 = r1.f79328a     // Catch:{ Throwable -> 0x0284 }
            r5.set(r7)     // Catch:{ Throwable -> 0x0284 }
            java.lang.String r5 = r4.f79325d     // Catch:{ Throwable -> 0x0284 }
            java.lang.String r6 = r4.f79322a     // Catch:{ Throwable -> 0x0284 }
        ...
        L_0x023e:
            ...
            java.lang.String r10 = r4.f79322a     // Catch:{ Throwable -> 0x0284 }
            r11 = 0
            java.lang.String r12 = r4.f79326e     // Catch:{ Throwable -> 0x0284 }
            r13 = r2
        ...
        L_0x0284:
            r0 = move-exception
            com.tencent.bugly.proguard.x.a(r0)     // Catch:{ all -> 0x0282 }
            ...
            goto L_0x0262
        L_0x029b:
            java.util.concurrent.atomic.AtomicInteger r2 = r1.f79328a
            r2.set(r3)
            throw r0
        L_0x02a1:
            r0 = move-exception
    ...
    /* JADX WARNING: Removed duplicated region for block: B:51:0x0151 A[SYNTHETIC, Splitter:B:51:0x0151] */
    /* JADX WARNING: Removed duplicated region for block: B:57:0x015c A[SYNTHETIC, Splitter:B:57:0x015c] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static boolean a(java.lang.String r9, java.lang.String r10, java.lang.String r11) {
        /*
            ...
            java.util.Map<java.lang.String, java.lang.String[]> r2 = r9.f79321d
        ...
        L_0x0016:
            ...
            r11.<init>(r10)
            r2 = 2
            boolean r3 = r11.exists()     // Catch:{ Exception -> 0x016f }
            if (r3 != 0) goto L_0x0036
            java.io.File r3 = r11.getParentFile()     // Catch:{ Exception -> 0x016f }
            boolean r3 = r3.exists()     // Catch:{ Exception -> 0x016f }
            if (r3 != 0) goto L_0x0033
            java.io.File r3 = r11.getParentFile()     // Catch:{ Exception -> 0x016f }
            r3.mkdirs()     // Catch:{ Exception -> 0x016f }
        L_0x0033:
            r11.createNewFile()     // Catch:{ Exception -> 0x016f }
        L_0x0036:
        ...
        L_0x0044:
            r10 = 0
            java.io.BufferedWriter r3 = new java.io.BufferedWriter     // Catch:{ IOException -> 0x0122 }
            java.io.FileWriter r4 = new java.io.FileWriter     // Catch:{ IOException -> 0x0122 }
            r4.<init>(r11, r1)     // Catch:{ IOException -> 0x0122 }
            r3.<init>(r4)     // Catch:{ IOException -> 0x0122 }
            java.util.Map<java.lang.String, java.lang.String[]> r10 = r9.f79321d     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r11 = "main"
            java.lang.Object r10 = r10.get(r11)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String[] r10 = (java.lang.String[]) r10     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r11 = 3
            if (r10 == 0) goto L_0x008e
            int r4 = r10.length     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            if (r4 < r11) goto L_0x008e
            r4 = r10[r1]     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r5 = r10[r0]     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r10 = r10[r2]     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r7 = "\"main\" tid="
            r6.<init>(r7)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r6.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = " :\n"
            r6.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r6.append(r4)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = "\n"
            r6.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r6.append(r5)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = "\n\n"
            r6.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = r6.toString()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r3.write(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r3.flush()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
        L_0x008e:
            java.util.Map<java.lang.String, java.lang.String[]> r9 = r9.f79321d     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.util.Set r9 = r9.entrySet()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.util.Iterator r9 = r9.iterator()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
        L_0x0098:
            boolean r10 = r9.hasNext()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            if (r10 == 0) goto L_0x0111
            java.lang.Object r10 = r9.next()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.util.Map$Entry r10 = (java.util.Map.Entry) r10     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.Object r4 = r10.getKey()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r5 = "main"
            boolean r4 = r4.equals(r5)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            if (r4 != 0) goto L_0x0098
            java.lang.Object r4 = r10.getValue()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            if (r4 == 0) goto L_0x0098
            java.lang.Object r4 = r10.getValue()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String[] r4 = (java.lang.String[]) r4     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            int r4 = r4.length     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            if (r4 < r11) goto L_0x0098
            java.lang.Object r4 = r10.getValue()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String[] r4 = (java.lang.String[]) r4     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r4 = r4[r1]     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.Object r5 = r10.getValue()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String[] r5 = (java.lang.String[]) r5     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r5 = r5[r0]     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.Object r6 = r10.getValue()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String[] r6 = (java.lang.String[]) r6     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r6 = r6[r2]     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r8 = "\""
            r7.<init>(r8)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.Object r10 = r10.getKey()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = (java.lang.String) r10     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r7.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = "\" tid="
            r7.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r7.append(r6)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = " :\n"
            r7.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r7.append(r4)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = "\n"
            r7.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r7.append(r5)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = "\n\n"
            r7.append(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            java.lang.String r10 = r7.toString()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r3.write(r10)     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            r3.flush()     // Catch:{ IOException -> 0x011c, all -> 0x011a }
            goto L_0x0098
        L_0x0111:
        ...
        L_0x0122:
            r9 = move-exception
        L_0x0123:
            com.tencent.bugly.proguard.x.a(r9)     // Catch:{ all -> 0x011f }
            java.lang.String r11 = "dump trace fail %s"
            java.lang.Object[] r0 = new java.lang.Object[r0]     // Catch:{ all -> 0x011f }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x011f }
            r2.<init>()     // Catch:{ all -> 0x011f }
            java.lang.Class r3 = r9.getClass()     // Catch:{ all -> 0x011f }
            java.lang.String r3 = r3.getName()     // Catch:{ all -> 0x011f }
            r2.append(r3)     // Catch:{ all -> 0x011f }
            java.lang.String r3 = ":"
            r2.append(r3)     // Catch:{ all -> 0x011f }
            java.lang.String r9 = r9.getMessage()     // Catch:{ all -> 0x011f }
            r2.append(r9)     // Catch:{ all -> 0x011f }
            java.lang.String r9 = r2.toString()     // Catch:{ all -> 0x011f }
            r0[r1] = r9     // Catch:{ all -> 0x011f }
            com.tencent.bugly.proguard.x.e(r11, r0)     // Catch:{ all -> 0x011f }
            if (r10 == 0) goto L_0x0159
            r10.close()     // Catch:{ IOException -> 0x0155 }
            goto L_0x0159
        L_0x0155:
            r9 = move-exception
            com.tencent.bugly.proguard.x.a(r9)
