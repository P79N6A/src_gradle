...
public final class b {
    ...
    public static com.tencent.bugly.crashreport.crash.CrashDetailBean a(android.content.Context r6, java.lang.String r7, com.tencent.bugly.crashreport.crash.jni.NativeExceptionHandler r8) {
        ...
        L_0x0085:
            ...
            r7 = r1
        L_0x0087:
            com.google.a.a.a.a.a.a.b(r6)     // Catch:{ all -> 0x0095 }
    ...
    private static CrashDetailBean a(Context context, Map<String, String> map, NativeExceptionHandler nativeExceptionHandler) {
        ...
        try {
            ...
            String str12 = map2.get("nativeLog");
            if (str12 == null || str12.isEmpty()) {
                bArr = null;
            } else {
                bArr = z.a((File) null, str12, "BuglyNativeLog.txt");
            }
            String str13 = map2.get("sendingProcess");
            if (str13 == null) {
                str13 = "unknown";
            }
            if (c2.get("spd") != null) {
            ...
            String str14 = str13;
            String str15 = map2.get("threadName");
            if (str15 == null) {
                str15 = "unknown";
            }
            if (c2.get("et") != null) {
            ...
            String str16 = str15;
            String str17 = map2.get("processName");
            if (str17 == null) {
                str17 = "unknown";
            }
            if (c2.get("ep") != null) {
            ...
            String str18 = map2.get("key-value");
            if (str18 != null) {
            ...
            CrashDetailBean packageCrashDatas = nativeExceptionHandler.packageCrashDatas(str17, str16, (((long) c2.get("ets").intValue()) * 1000) + (((long) c2.get("etms").intValue()) / 1000), str2, str6, a(str11), str, str14, str9, map2.get("sysLogPath"), str4, bArr, hashMap, false);
            if (packageCrashDatas != null) {
                String str19 = map2.get("userId");
                if (str19 != null) {
                    x.c("[Native record info] userId: %s", str19);
                    packageCrashDatas.m = str19;
                }
                String str20 = map2.get("sysLog");
                if (str20 != null) {
                    packageCrashDatas.w = str20;
                }
                String str21 = map2.get("appVersion");
                if (str21 != null) {
                    x.c("[Native record info] appVersion: %s", str21);
                    packageCrashDatas.f79307f = str21;
                }
                String str22 = map2.get("isAppForeground");
                if (str22 != null) {
                    x.c("[Native record info] isAppForeground: %s", str22);
                    packageCrashDatas.M = str22.equalsIgnoreCase("true");
                }
                String str23 = map2.get("launchTime");
                if (str23 != null) {
                    x.c("[Native record info] launchTime: %s", str23);
                    packageCrashDatas.L = Long.parseLong(str23);
                }
