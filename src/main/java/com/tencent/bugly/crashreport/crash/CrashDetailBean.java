...
public class CrashDetailBean implements Parcelable, Comparable<CrashDetailBean> {
    ...
    public long f79302a = -1;

    /* renamed from: b  reason: collision with root package name */
    public int f79303b;

    /* renamed from: c  reason: collision with root package name */
    public String f79304c = UUID.randomUUID().toString();

    /* renamed from: d  reason: collision with root package name */
    public boolean f79305d = false;
    ...
    public CrashDetailBean(Parcel parcel) {
        ...
        this.f79305d = z2;
        this.f79306e = parcel.readString();
        this.f79307f = parcel.readString();
        ...
        this.M = parcel.readByte() != 1 ? false : z5;
        this.N = z.b(parcel);
        this.h = z.a(parcel);
        this.i = z.a(parcel);
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        parcel.writeInt(this.f79303b);
        parcel.writeString(this.f79304c);
        parcel.writeByte(this.f79305d ? (byte) 1 : 0);
        parcel.writeString(this.f79306e);
        parcel.writeString(this.f79307f);
