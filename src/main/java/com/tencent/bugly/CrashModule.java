...
public class CrashModule extends a {
    ...
    private static int f79230c;

    /* renamed from: d  reason: collision with root package name */
    private static boolean f79231d;

    /* renamed from: e  reason: collision with root package name */
    private static CrashModule f79232e = new CrashModule();

    /* renamed from: a  reason: collision with root package name */
    private long f79233a;

    /* renamed from: b  reason: collision with root package name */
    private BuglyStrategy.a f79234b;
    ...
    private synchronized void a(android.content.Context r7, com.tencent.bugly.BuglyStrategy r8) {
        ...
        L_0x0020:
            ...
            com.tencent.bugly.BuglyStrategy$a r7 = r8.getCrashHandleCallback()     // Catch:{ all -> 0x0054 }
            r6.f79234b = r7     // Catch:{ all -> 0x0054 }
    ...
    public synchronized void init(android.content.Context r12, boolean r13, com.tencent.bugly.BuglyStrategy r14) {
        /*
            ...
            boolean r0 = f79231d     // Catch:{ all -> 0x0085 }
        ...
        L_0x0009:
            ...
            int r2 = f79230c     // Catch:{ all -> 0x0085 }
            r3 = 1
            int r2 = r2 + r3
            f79230c = r2     // Catch:{ all -> 0x0085 }
            r4 = 1004(0x3ec, float:1.407E-42)
            r0.a((int) r4, (int) r2)     // Catch:{ all -> 0x0085 }
            f79231d = r3     // Catch:{ all -> 0x0085 }
            com.tencent.bugly.crashreport.CrashReport.setContext(r12)     // Catch:{ all -> 0x0085 }
            r11.a(r12, r14)     // Catch:{ all -> 0x0085 }
            r5 = 1004(0x3ec, float:1.407E-42)
            com.tencent.bugly.BuglyStrategy$a r8 = r11.f79234b     // Catch:{ all -> 0x0085 }
            r9 = 0
            r10 = 0
            r6 = r12
            r7 = r13
        ...
        L_0x0068:
            ...
            int r13 = f79230c     // Catch:{ all -> 0x0085 }
            int r13 = r13 - r3
            f79230c = r13     // Catch:{ all -> 0x0085 }
