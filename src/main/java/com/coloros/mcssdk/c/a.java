...
public final class a {
    ...
    static {
        try {
            h = c("com.coloros.crypto.seed.defalut".getBytes(Charset.defaultCharset()), "AndroidOpenSSL");
        } catch (Exception e2) {
    ...
    private static String a(String str, String str2) {
        ...
        try {
            ...
            com.google.a.a.a.a.a.a.b(e2);
            try {
                bArr = a(c(str.getBytes(Charset.defaultCharset()), "AndroidOpenSSL"), str2.getBytes(Charset.defaultCharset()));
            } catch (Exception e3) {
    ...
    private static byte[] a(byte[] bArr) {
        ...
        try {
            ...
            SecureRandom instance2 = SecureRandom.getInstance("SHA1PRNG", "AndroidOpenSSL");
            d.a("getRawKey exception:" + e2.getMessage());
            secureRandom = instance2;
        }
        secureRandom.setSeed(bArr);
        instance.init(SearchJediMixFeedAdapter.f42517f, secureRandom);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
        r3 = b(c(r3.getBytes(java.nio.charset.Charset.defaultCharset()), "AndroidOpenSSL"), c(r4));
     */
    ...
    private static byte[] c(byte[] bArr, String str) {
        KeyGenerator instance = KeyGenerator.getInstance("AES");
        SecureRandom instance2 = SecureRandom.getInstance("SHA1PRNG", str);
