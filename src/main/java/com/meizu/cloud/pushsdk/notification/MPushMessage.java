...
public class MPushMessage implements Serializable {
    ...
    public static MPushMessage parsePushMessage(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            if (!jSONObject2.isNull(PushConstants.CONTENT)) {
                mPushMessage.setContent(jSONObject2.getString(PushConstants.CONTENT));
            }
            ...
            if (!jSONObject2.isNull(PushConstants.EXTRA)) {
                jSONObject = jSONObject2.getJSONObject(PushConstants.EXTRA);
                if (jSONObject != null) {
