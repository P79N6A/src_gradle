...
public class BitmapUtils {
    ...
    public static android.graphics.Bitmap getBitmapFromSD(java.lang.String r4, int r5, boolean r6) {
        ...
        L_0x0014:
            android.graphics.Bitmap r4 = decodeBitmap((java.io.File) r0, (int) r5, (boolean) r6)     // Catch:{ Exception -> 0x0019 }
            return r4
        L_0x0019:
            return r1
        */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.graphics.Bitmap decodeBitmap(android.content.Context r6, int r7, int r8, int r9) {
        /*
            r0 = 0
        ...
        L_0x000a:
            ...
            android.graphics.BitmapFactory.decodeResource(r6, r7, r1)     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            int r3 = r1.outWidth     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            int r1 = r1.outHeight     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            r4 = 1
        L_0x001e:
            int r5 = r3 / 2
            ...
            goto L_0x0039
        L_0x0027:
            android.graphics.BitmapFactory$Options r8 = new android.graphics.BitmapFactory$Options     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            r8.<init>()     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            r8.inSampleSize = r4     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            r8.inPurgeable = r2     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            android.graphics.Bitmap$Config r9 = android.graphics.Bitmap.Config.RGB_565     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            r8.inPreferredConfig = r9     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            android.graphics.Bitmap r6 = android.graphics.BitmapFactory.decodeResource(r6, r7, r8)     // Catch:{ Exception -> 0x0042, all -> 0x0040 }
            return r6
        L_0x0039:
            int r3 = r3 / 2
            int r1 = r1 / 2
        ...
        L_0x0043:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.common.utility.BitmapUtils.decodeBitmap(android.content.Context, int, int, int):android.graphics.Bitmap");
    }
    ...
    public static android.graphics.Bitmap getBitmapFromSD(java.lang.String r6, int r7, int r8, int r9, android.graphics.Bitmap.Config r10) {
        ...
        L_0x0023:
            android.graphics.Bitmap r6 = decodeBitmap((java.io.File) r1, (int) r7, (int) r8, (android.graphics.Bitmap.Config) r10)     // Catch:{ Exception -> 0x0028 }
            return r6
        L_0x0028:
            return r0
        */
