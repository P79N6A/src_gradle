...
public class ChannelInfo {
    ...
    public static class Builder {
        ...
        public ChannelInfo builder() {
            ChannelInfo channelInfo = new ChannelInfo(this.fpid, this.aid, this.appVersion, this.appkey, this.channelId, this.deviceId, this.installId, this.urls, this.extra);
            return channelInfo;
        }
    ...
    public ChannelInfo(ChannelInfo channelInfo) {
        ...
        if (channelInfo.urls != null) {
            this.urls.addAll(channelInfo.urls);
        }
        if (channelInfo.extra != null) {
            this.extra.putAll(channelInfo.extra);
        }
