...
public final class u implements Executor {
    ...
    public static final Lazy f21413a = LazyKt.lazy(b.INSTANCE);

    /* renamed from: b  reason: collision with root package name */
    public static final a f21414b = new a((byte) 0);

    /* renamed from: c  reason: collision with root package name */
    private final LinkedBlockingQueue<Runnable> f21415c = new LinkedBlockingQueue<>();

    /* renamed from: d  reason: collision with root package name */
    private Runnable f21416d;
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final /* synthetic */ KProperty[] f21417a = {Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(a.class), "THREAD_POOL_EXECUTOR", "getTHREAD_POOL_EXECUTOR()Ljava/util/concurrent/ThreadPoolExecutor;"))};
        ...
        /* renamed from: com.bytedance.jedi.arch.u$a$a  reason: collision with other inner class name */
        static final class C0199a extends LinkedBlockingQueue<Runnable> {
            @NotNull
    ...
    static final class b extends Lambda implements Function0<ThreadPoolExecutor> {
        ...
        public final ThreadPoolExecutor invoke() {
            ...
            ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(max, (a.a() * 2) + 1, 0, TimeUnit.SECONDS, new a.C0199a());
            BlockingQueue<Runnable> queue = threadPoolExecutor.getQueue();
            if (queue != null) {
                ((a.C0199a) queue).setExecutor(threadPoolExecutor);
                return threadPoolExecutor;
            }
    ...
    static final class c implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ u f21418a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Runnable f21419b;

        c(u uVar, Runnable runnable) {
            this.f21418a = uVar;
            this.f21419b = runnable;
        }
    ...
    public final synchronized void a() {
        Runnable poll = this.f21415c.poll();
        if (poll != null) {
            ((ThreadPoolExecutor) f21413a.getValue()).execute(poll);
        } else {
            poll = null;
        }
        this.f21416d = poll;
    ...
    public final synchronized void execute(@NotNull Runnable runnable) {
        ...
        this.f21415c.offer(new c(this, runnable));
