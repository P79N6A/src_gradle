...
public final class MessageBody extends Message<MessageBody, Builder> {
    ...
    public final int hashCode() {
        ...
        int hashCode2 = (((i20 + i8) * 37) + this.ext.hashCode()) * 37;
        if (this.create_time != null) {
            i9 = this.create_time.hashCode();
        } else {
            i9 = 0;
        }
        int i21 = (hashCode2 + i9) * 37;
        ...
        if (this.order_in_conversation != null) {
            i13 = this.order_in_conversation.hashCode();
        }
        int i24 = i23 + i13;
        this.hashCode = i24;
        return i24;
