...
public final class ResponseBody extends Message<ResponseBody, Builder> {
  ...
  ?: SGET   com.ss.android.ugc.aweme.shortvideo.sticker.ar.pixaloop.d.c.f int)*/:
        ...
        public final void encode(ProtoWriter protoWriter, ResponseBody responseBody) throws IOException {
            ...
            ConversationsListResponseBody.ADAPTER.encodeWithTag(protoWriter, c.f69428f, responseBody.conversations_list_body);
            ...
            GetStrangerConversationListResponseBody.ADAPTER.encodeWithTag(protoWriter, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE, responseBody.get_stranger_conversation_body);
            GetStrangerMessagesResponseBody.ADAPTER.encodeWithTag(protoWriter, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_BROADCAST, responseBody.get_stranger_messages_body);
            DeleteStrangerMessageResponseBody.ADAPTER.encodeWithTag(protoWriter, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE_ERROR, responseBody.delete_stranger_message_body);
            ...
            DeleteStrangerAllConversationResponseBody.ADAPTER.encodeWithTag(protoWriter, CrashModule.MODULE_ID, responseBody.delete_stranger_all_conversation_body);
    ...
    public final int hashCode() {
        ...
        if (this.get_group_info_body != null) {
            i31 = this.get_group_info_body.hashCode();
        } else {
            i31 = 0;
        }
        int i81 = (i80 + i31) * 37;
        if (this.set_group_info_body != null) {
            i32 = this.set_group_info_body.hashCode();
        } else {
            i32 = 0;
        }
        int i82 = (i81 + i32) * 37;
        if (this.get_groups_info_body != null) {
            i33 = this.get_groups_info_body.hashCode();
        } else {
            i33 = 0;
        }
        int i83 = (i82 + i33) * 37;
        if (this.get_conversation_core_info_body != null) {
            i34 = this.get_conversation_core_info_body.hashCode();
        } else {
            i34 = 0;
        }
        int i84 = (i83 + i34) * 37;
        if (this.set_conversation_core_info_body != null) {
            i35 = this.set_conversation_core_info_body.hashCode();
        } else {
            i35 = 0;
        }
        int i85 = (i84 + i35) * 37;
        if (this.get_conversation_core_info_list_body != null) {
            i36 = this.get_conversation_core_info_list_body.hashCode();
        } else {
            i36 = 0;
        }
        int i86 = (i85 + i36) * 37;
        if (this.upsert_conversation_core_ext_info_body != null) {
            i37 = this.upsert_conversation_core_ext_info_body.hashCode();
        } else {
            i37 = 0;
        }
        int i87 = (i86 + i37) * 37;
        if (this.delete_conversation_core_ext_info_body != null) {
            i38 = this.delete_conversation_core_ext_info_body.hashCode();
        } else {
            i38 = 0;
        }
        int i88 = (i87 + i38) * 37;
        if (this.get_conversation_setting_info_body != null) {
            i39 = this.get_conversation_setting_info_body.hashCode();
        } else {
            i39 = 0;
        }
        int i89 = (i88 + i39) * 37;
        if (this.set_conversation_setting_info_body != null) {
            i40 = this.set_conversation_setting_info_body.hashCode();
        } else {
            i40 = 0;
        }
        int i90 = (i89 + i40) * 37;
        if (this.upsert_conversation_setting_ext_info_body != null) {
            i41 = this.upsert_conversation_setting_ext_info_body.hashCode();
        } else {
            i41 = 0;
        }
        int i91 = (i90 + i41) * 37;
        if (this.delete_conversation_setting_ext_info_body != null) {
            i42 = this.delete_conversation_setting_ext_info_body.hashCode();
        } else {
            i42 = 0;
        }
        int i92 = (i91 + i42) * 37;
        if (this.get_stranger_conversation_body != null) {
            i43 = this.get_stranger_conversation_body.hashCode();
        } else {
            i43 = 0;
        }
        int i93 = (i92 + i43) * 37;
        if (this.get_stranger_messages_body != null) {
            i44 = this.get_stranger_messages_body.hashCode();
        } else {
            i44 = 0;
        }
        int i94 = (i93 + i44) * 37;
        if (this.delete_stranger_message_body != null) {
            i45 = this.delete_stranger_message_body.hashCode();
        } else {
            i45 = 0;
        }
        int i95 = (i94 + i45) * 37;
        if (this.delete_stranger_conversation_body != null) {
            i46 = this.delete_stranger_conversation_body.hashCode();
        } else {
            i46 = 0;
        }
        int i96 = (i95 + i46) * 37;
        if (this.delete_stranger_all_conversation_body != null) {
            i47 = this.delete_stranger_all_conversation_body.hashCode();
        } else {
            i47 = 0;
        }
        int i97 = (i96 + i47) * 37;
        if (this.mark_stranger_conversation_read_body != null) {
            i48 = this.mark_stranger_conversation_read_body.hashCode();
        } else {
            i48 = 0;
        }
        int i98 = (i97 + i48) * 37;
