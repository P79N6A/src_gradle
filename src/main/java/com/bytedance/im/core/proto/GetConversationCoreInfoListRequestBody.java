...
public final class GetConversationCoreInfoListRequestBody extends Message<GetConversationCoreInfoListRequestBody, Builder> {
    ...
    @WireField(adapter = "com.bytedance.im.core.proto.GetConversationCoreInfoRequestBody#ADAPTER", label = WireField.Label.REPEATED, tag = 1)
    public final List<GetConversationCoreInfoRequestBody> conversation_core_info_list;

    public static final class Builder extends Message.Builder<GetConversationCoreInfoListRequestBody, Builder> {
