...
public final class RequestBody extends Message<RequestBody, Builder> {
  ...
  ?: SGET   com.ss.android.ugc.aweme.shortvideo.sticker.ar.pixaloop.d.c.f int)*/:
        ...
        public final void encode(ProtoWriter protoWriter, RequestBody requestBody) throws IOException {
            ...
            ConversationsListRequestBody.ADAPTER.encodeWithTag(protoWriter, c.f69428f, requestBody.conversations_list_body);
            ...
            GetStrangerConversationListRequestBody.ADAPTER.encodeWithTag(protoWriter, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE, requestBody.get_stranger_conversation_body);
            GetStrangerMessagesRequestBody.ADAPTER.encodeWithTag(protoWriter, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_BROADCAST, requestBody.get_stranger_messages_body);
            DeleteStrangerMessageRequestBody.ADAPTER.encodeWithTag(protoWriter, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE_ERROR, requestBody.delete_stranger_message_body);
            ...
            DeleteStrangerAllConversationRequestBody.ADAPTER.encodeWithTag(protoWriter, CrashModule.MODULE_ID, requestBody.delete_stranger_all_conversation_body);
    ...
    public final int hashCode() {
        ...
        if (this.get_group_info_body != null) {
            i35 = this.get_group_info_body.hashCode();
        } else {
            i35 = 0;
        }
        int i89 = (i88 + i35) * 37;
        if (this.set_group_info_body != null) {
            i36 = this.set_group_info_body.hashCode();
        } else {
            i36 = 0;
        }
        int i90 = (i89 + i36) * 37;
        if (this.get_group_info_list_body != null) {
            i37 = this.get_group_info_list_body.hashCode();
        } else {
            i37 = 0;
        }
        int i91 = (i90 + i37) * 37;
        if (this.get_conversation_core_info_body != null) {
            i38 = this.get_conversation_core_info_body.hashCode();
        } else {
            i38 = 0;
        }
        int i92 = (i91 + i38) * 37;
        if (this.set_conversation_core_info_body != null) {
            i39 = this.set_conversation_core_info_body.hashCode();
        } else {
            i39 = 0;
        }
        int i93 = (i92 + i39) * 37;
        if (this.get_conversation_core_info_list_body != null) {
            i40 = this.get_conversation_core_info_list_body.hashCode();
        } else {
            i40 = 0;
        }
        int i94 = (i93 + i40) * 37;
        if (this.upsert_conversation_core_ext_info_body != null) {
            i41 = this.upsert_conversation_core_ext_info_body.hashCode();
        } else {
            i41 = 0;
        }
        int i95 = (i94 + i41) * 37;
        if (this.delete_conversation_core_ext_info_body != null) {
            i42 = this.delete_conversation_core_ext_info_body.hashCode();
        } else {
            i42 = 0;
        }
        int i96 = (i95 + i42) * 37;
        if (this.get_conversation_setting_info_body != null) {
            i43 = this.get_conversation_setting_info_body.hashCode();
        } else {
            i43 = 0;
        }
        int i97 = (i96 + i43) * 37;
        if (this.set_conversation_setting_info_body != null) {
            i44 = this.set_conversation_setting_info_body.hashCode();
        } else {
            i44 = 0;
        }
        int i98 = (i97 + i44) * 37;
        if (this.upsert_conversation_setting_ext_info_body != null) {
            i45 = this.upsert_conversation_setting_ext_info_body.hashCode();
        } else {
            i45 = 0;
        }
        int i99 = (i98 + i45) * 37;
        if (this.delete_conversation_setting_ext_info_body != null) {
            i46 = this.delete_conversation_setting_ext_info_body.hashCode();
        } else {
            i46 = 0;
        }
        int i100 = (i99 + i46) * 37;
        if (this.get_stranger_conversation_body != null) {
            i47 = this.get_stranger_conversation_body.hashCode();
        } else {
            i47 = 0;
        }
        int i101 = (i100 + i47) * 37;
        if (this.get_stranger_messages_body != null) {
            i48 = this.get_stranger_messages_body.hashCode();
        } else {
            i48 = 0;
        }
        int i102 = (i101 + i48) * 37;
        if (this.delete_stranger_message_body != null) {
            i49 = this.delete_stranger_message_body.hashCode();
        } else {
            i49 = 0;
        }
        int i103 = (i102 + i49) * 37;
        if (this.delete_stranger_conversation_body != null) {
            i50 = this.delete_stranger_conversation_body.hashCode();
        } else {
            i50 = 0;
        }
        int i104 = (i103 + i50) * 37;
        if (this.delete_stranger_all_conversation_body != null) {
            i51 = this.delete_stranger_all_conversation_body.hashCode();
        } else {
            i51 = 0;
        }
        int i105 = (i104 + i51) * 37;
        if (this.mark_stranger_conversation_read_body != null) {
            i52 = this.mark_stranger_conversation_read_body.hashCode();
        } else {
            i52 = 0;
        }
