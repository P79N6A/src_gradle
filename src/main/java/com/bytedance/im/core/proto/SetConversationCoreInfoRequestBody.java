...
public final class SetConversationCoreInfoRequestBody extends Message<SetConversationCoreInfoRequestBody, Builder> {
    ...
    public static final Boolean DEFAULT_IS_DESC_SET = Boolean.FALSE;
    public static final Boolean DEFAULT_IS_ICON_SET = Boolean.FALSE;
    public static final Boolean DEFAULT_IS_NAME_SET = Boolean.FALSE;
    public static final Boolean DEFAULT_IS_NOTICE_SET = Boolean.FALSE;
