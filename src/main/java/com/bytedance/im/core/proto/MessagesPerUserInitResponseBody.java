...
public final class MessagesPerUserInitResponseBody extends Message<MessagesPerUserInitResponseBody, Builder> {
    ...
    @WireField(adapter = "com.bytedance.im.core.proto.ConversationInfo#ADAPTER", label = WireField.Label.REPEATED, tag = 2)
    ...
    public static final class Builder extends Message.Builder<MessagesPerUserInitResponseBody, Builder> {
