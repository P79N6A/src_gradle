...
public final class SetConversationSettingInfoRequestBody extends Message<SetConversationSettingInfoRequestBody, Builder> {
    ...
    public static final Boolean DEFAULT_SET_FAVORITE = Boolean.FALSE;
    public static final Boolean DEFAULT_SET_MUTE = Boolean.FALSE;
    public static final Boolean DEFAULT_SET_STICK_ON_TOP = Boolean.FALSE;
