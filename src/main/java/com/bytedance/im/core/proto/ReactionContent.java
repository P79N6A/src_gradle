...
public final class ReactionContent extends Message<ReactionContent, Builder> {
    ...
    public static final class Builder extends Message.Builder<ReactionContent, Builder> {
        public Integer id;
        public String name;
        ...
        public final ReactionContent build() {
            ReactionContent reactionContent = new ReactionContent(this.id, this.name, this.status, this.target_message_id, this.target_client_message_id, super.buildUnknownFields());
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(reactionContent.unknownFields()) || !Internal.equals(this.id, reactionContent.id) || !Internal.equals(this.name, reactionContent.name) || !Internal.equals(this.status, reactionContent.status) || !Internal.equals(this.target_message_id, reactionContent.target_message_id) || !Internal.equals(this.target_client_message_id, reactionContent.target_client_message_id)) {
            return false;
        }
        return true;
    }
