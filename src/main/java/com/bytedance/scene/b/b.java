...
public class b {
    ...
    public void b() {
        /*
            r4 = this;
            monitor-enter(r4)
            boolean r0 = r4.f22076a     // Catch:{ all -> 0x003e }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r4)     // Catch:{ all -> 0x003e }
            return
        L_0x0007:
            r0 = 1
            r4.f22076a = r0     // Catch:{ all -> 0x003e }
            r4.f22079d = r0     // Catch:{ all -> 0x003e }
            com.bytedance.scene.b.b$a r0 = r4.f22077b     // Catch:{ all -> 0x003e }
            java.lang.Object r1 = r4.f22078c     // Catch:{ all -> 0x003e }
            monitor-exit(r4)     // Catch:{ all -> 0x003e }
            r2 = 0
        ...
        L_0x0028:
            monitor-enter(r4)
            r4.f22079d = r2     // Catch:{ all -> 0x0030 }
        ...
        L_0x0033:
            monitor-enter(r4)
            r4.f22079d = r2     // Catch:{ all -> 0x003b }
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.scene.b.b.b():void");
    }

    public final void a(a aVar) {
        synchronized (this) {
            c();
            if (this.f22077b != aVar) {
                this.f22077b = aVar;
                if (this.f22076a) {
                    aVar.a();
                }
