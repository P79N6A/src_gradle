...
public class APSService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        try {
            return this.f5572a.onBind(intent);
        } catch (Throwable th) {
            ce.a(th, "APSService", "onBind");
            return null;
        }
    }
    ...
    public void onCreate(android.content.Context r8) {
        /*
            r7 = this;
            boolean r0 = com.loc.ck.c(r8)     // Catch:{ Throwable -> 0x0033 }
            if (r0 == 0) goto L_0x0029
            com.loc.dh r2 = com.loc.ce.b()     // Catch:{ Throwable -> 0x0033 }
            java.lang.String r0 = "AY29tLmFtYXAuYXBpLmxvY2F0aW9uLkFQU1NlcnZpY2VXcmFwcGVy"
            java.lang.String r3 = com.loc.di.c((java.lang.String) r0)     // Catch:{ Throwable -> 0x0033 }
            java.lang.Class<com.loc.cr> r4 = com.loc.cr.class
            r0 = 1
            ...
            r1 = r8
            r6 = r0
            java.lang.Object r0 = com.loc.t.a(r1, r2, r3, r4, r5, r6)     // Catch:{ Throwable -> 0x0033 }
            com.amap.api.location.APSServiceBase r0 = (com.amap.api.location.APSServiceBase) r0     // Catch:{ Throwable -> 0x0033 }
        L_0x0026:
            r7.f5572a = r0     // Catch:{ Throwable -> 0x0033 }
            goto L_0x0033
        L_0x0029:
            com.amap.api.location.APSServiceBase r0 = r7.f5572a     // Catch:{ Throwable -> 0x0033 }
            if (r0 != 0) goto L_0x0033
            com.loc.cr r0 = new com.loc.cr     // Catch:{ Throwable -> 0x0033 }
            r0.<init>(r8)     // Catch:{ Throwable -> 0x0033 }
            goto L_0x0026
        L_0x0033:
            com.amap.api.location.APSServiceBase r0 = r7.f5572a     // Catch:{ Throwable -> 0x0044 }
            if (r0 != 0) goto L_0x003e
            com.loc.cr r0 = new com.loc.cr     // Catch:{ Throwable -> 0x0044 }
            r0.<init>(r8)     // Catch:{ Throwable -> 0x0044 }
            r7.f5572a = r0     // Catch:{ Throwable -> 0x0044 }
        L_0x003e:
            com.amap.api.location.APSServiceBase r8 = r7.f5572a     // Catch:{ Throwable -> 0x0044 }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0052, code lost:
        com.loc.ce.a(r0, "APSService", "onStartCommand");
     */
    ...
    public int onStartCommand(android.content.Intent r5, int r6, int r7) {
        /*
            ...
            r4.f5574c = r2     // Catch:{ Throwable -> 0x004a }
            int r0 = r4.f5573b     // Catch:{ Throwable -> 0x004a }
            int r0 = r0 + r2
            r4.f5573b = r0     // Catch:{ Throwable -> 0x004a }
            goto L_0x004a
        L_0x0029:
            r3 = 2
        ...
        L_0x003d:
            ...
            r4.f5574c = r1     // Catch:{ Throwable -> 0x004a }
            goto L_0x004a
        L_0x0047:
            r4.stopForeground(r1)     // Catch:{ Throwable -> 0x004a }
        L_0x004a:
            com.amap.api.location.APSServiceBase r0 = r4.f5572a     // Catch:{ Throwable -> 0x0051 }
