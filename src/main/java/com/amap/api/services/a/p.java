...
public class p {
    ...
    private static String[] f6873a = {"010", "021", "022", "023", "1852", "1853"};
    ...
    private static List<Photo> F(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            photo.setTitle(a(optJSONObject, PushConstants.TITLE));
    ...
    public static boolean n(String str) {
        if (str == null || str.equals("") || str.equals("[]") || str.equals(PushConstants.PUSH_TYPE_NOTIFY) || !str.equals(PushConstants.PUSH_TYPE_THROUGH_MESSAGE)) {
            return false;
        }
        return true;
    }
    ...
    public static BusLineItem j(JSONObject jSONObject) throws JSONException {
        ...
        h.setFirstBusTime(j.c(a(jSONObject, "start_time")));
        h.setLastBusTime(j.c(a(jSONObject, "end_time")));
    ...
    public static RouteBusLineItem t(JSONObject jSONObject) throws JSONException {
        ...
        routeBusLineItem.setFirstBusTime(j.c(a(jSONObject, "start_time")));
        routeBusLineItem.setLastBusTime(j.c(a(jSONObject, "end_time")));
    ...
    private static PoiItemExtension e(JSONObject jSONObject, String str) throws JSONException {
        ...
        if (jSONObject.has(str)) {
            JSONObject optJSONObject = jSONObject.optJSONObject(str);
            if (optJSONObject != null) {
                str2 = a(optJSONObject, a.f54804f);
    ...
    public static java.util.ArrayList<com.amap.api.services.nearby.NearbyInfo> a(org.json.JSONObject r16, boolean r17) throws org.json.JSONException {
        ...
        L_0x0086:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.services.a.p.a(org.json.JSONObject, boolean):java.util.ArrayList");
    }
