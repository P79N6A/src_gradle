...
public final class cw implements Closeable {
    ...
    static final Pattern f6763a = Pattern.compile("[a-z0-9_-]{1,120}");

    /* renamed from: b  reason: collision with root package name */
    static ThreadPoolExecutor f6764b;
    private static final ThreadFactory q = new ThreadFactory() {

        /* renamed from: a  reason: collision with root package name */
        private final AtomicInteger f6769a = new AtomicInteger(1);

        public final Thread newThread(Runnable runnable) {
            return new Thread(runnable, "disklrucache#" + this.f6769a.getAndIncrement());
        }
    };
    ...
    private final File f6767e;

    /* renamed from: f  reason: collision with root package name */
    private final File f6768f;
    private final int g;
    private long h;
    /* access modifiers changed from: private */
    public final int i;
    ...
    public final class a {
        ...
        class C0047a extends FilterOutputStream {
            public void close() {
                try {
                    ...
                    boolean unused2 = a.this.f6774d = true;
                }
            }
        ...
        public final java.io.OutputStream a(int r4) throws java.io.IOException {
            /*
                ...
                com.amap.api.services.a.cw r0 = com.amap.api.services.a.cw.this
                monitor-enter(r0)
                com.amap.api.services.a.cw$c r1 = r3.f6772b     // Catch:{ all -> 0x0050 }
                com.amap.api.services.a.cw$a r1 = r1.f6786e     // Catch:{ all -> 0x0050 }
                if (r1 != r3) goto L_0x004a
                com.amap.api.services.a.cw$c r1 = r3.f6772b     // Catch:{ all -> 0x0050 }
                boolean r1 = r1.f6785d     // Catch:{ all -> 0x0050 }
                if (r1 != 0) goto L_0x0022
                boolean[] r1 = r3.f6773c     // Catch:{ all -> 0x0050 }
                r2 = 1
            ...
            L_0x002e:
                ...
                java.io.File r1 = r1.f6765c     // Catch:{ all -> 0x0050 }
    ...
    public final class b implements Closeable {
        ...
        public final void close() {
            for (InputStream a2 : this.f6780d) {
                cz.a((Closeable) a2);
            }
        }
    ...
    final class c {
        ...
        public void a(String[] strArr) throws IOException {
            if (strArr.length == cw.this.i) {
                ...
                while (i < strArr.length) {
                    try {
                        this.f6784c[i] = Long.parseLong(strArr[i]);
                        i++;
        ...
        public final File b(int i) {
            File f2 = cw.this.f6765c;
            return new File(f2, this.f6783b + ClassUtils.PACKAGE_SEPARATOR + i + ".tmp");
        }

        public final File a(int i) {
            File f2 = cw.this.f6765c;
            return new File(f2, this.f6783b + ClassUtils.PACKAGE_SEPARATOR + i);
        }

        private c(String str) {
            this.f6783b = str;
            this.f6784c = new long[cw.this.i];
        }
    }
    ...
    static {
        ...
        f6764b = threadPoolExecutor;
    }

    public static ThreadPoolExecutor a() {
        try {
            if (f6764b == null || f6764b.isShutdown()) {
    ...
    private void g() throws IOException {
        ...
        while (it2.hasNext()) {
            ...
            if (next.f6786e == null) {
                while (i2 < this.i) {
                    this.j += next.f6784c[i2];
                    i2++;
                }
            } else {
                a unused = next.f6786e = null;
                while (i2 < this.i) {
                    a(next.a(i2));
                    a(next.b(i2));
                    i2++;
    ...
    private void f() throws java.io.IOException {
        /*
            ...
            java.io.File r2 = r8.f6766d
            r1.<init>(r2)
            java.nio.charset.Charset r2 = com.amap.api.services.a.cz.f6794a
            r0.<init>(r1, r2)
        ...
        L_0x0053:
            ...
            goto L_0x0053
        L_0x005d:
            java.util.LinkedHashMap<java.lang.String, com.amap.api.services.a.cw$c> r2 = r8.m     // Catch:{ all -> 0x009b }
    ...
    public synchronized void h() throws IOException {
        ...
        BufferedWriter bufferedWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.f6767e), cz.f6794a));
        try {
            ...
            for (c next : this.m.values()) {
                if (next.f6786e != null) {
                    bufferedWriter.write("DIRTY " + next.f6783b + 10);
                } else {
                    bufferedWriter.write("CLEAN " + next.f6783b + next.a() + 10);
                }
            }
            bufferedWriter.close();
            if (this.f6766d.exists()) {
                a(this.f6766d, this.f6768f, true);
            }
            a(this.f6767e, this.f6766d, false);
            this.f6768f.delete();
            this.k = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(this.f6766d, true), cz.f6794a));
        } catch (Throwable th) {
            bufferedWriter.close();
            throw th;
        }
    ...
    private void d(String str) throws IOException {
        ...
        if (indexOf != -1) {
            ...
            if (indexOf2 != -1 && indexOf == 5 && str.startsWith("CLEAN")) {
                ...
                boolean unused = cVar.f6785d = true;
                a unused2 = cVar.f6786e = null;
                cVar.a(split);
            } else if (indexOf2 == -1 && indexOf == 5 && str.startsWith("DIRTY")) {
                a unused3 = cVar.f6786e = new a(cVar);
    ...
    public final synchronized boolean c(java.lang.String r8) throws java.io.IOException {
        /*
            r7 = this;
            monitor-enter(r7)
            r7.j()     // Catch:{ all -> 0x008f }
            r7.e((java.lang.String) r8)     // Catch:{ all -> 0x008f }
            java.util.LinkedHashMap<java.lang.String, com.amap.api.services.a.cw$c> r0 = r7.m     // Catch:{ all -> 0x008f }
            java.lang.Object r0 = r0.get(r8)     // Catch:{ all -> 0x008f }
            com.amap.api.services.a.cw$c r0 = (com.amap.api.services.a.cw.c) r0     // Catch:{ all -> 0x008f }
            r1 = 0
            if (r0 == 0) goto L_0x008d
            com.amap.api.services.a.cw$a r2 = r0.f6786e     // Catch:{ all -> 0x008f }
        ...
        L_0x0042:
            ...
            long[] r4 = r0.f6784c     // Catch:{ all -> 0x008f }
            r5 = r4[r1]     // Catch:{ all -> 0x008f }
            r4 = 0
            long r2 = r2 - r5
            r7.j = r2     // Catch:{ all -> 0x008f }
            long[] r2 = r0.f6784c     // Catch:{ all -> 0x008f }
            r3 = 0
        ...
        L_0x0059:
            ...
            boolean r8 = r7.i()     // Catch:{ all -> 0x008f }
            if (r8 == 0) goto L_0x008b
            java.util.concurrent.ThreadPoolExecutor r8 = a()     // Catch:{ all -> 0x008f }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0061, code lost:
        r3 = new com.amap.api.services.a.cw.b(r11, r12, com.amap.api.services.a.cw.c.e(r0), r8, com.amap.api.services.a.cw.c.b(r0), null);
     */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized com.amap.api.services.a.cw.b a(java.lang.String r12) throws java.io.IOException {
        /*
            r11 = this;
            monitor-enter(r11)
            r11.j()     // Catch:{ all -> 0x0086 }
            r11.e((java.lang.String) r12)     // Catch:{ all -> 0x0086 }
            java.util.LinkedHashMap<java.lang.String, com.amap.api.services.a.cw$c> r0 = r11.m     // Catch:{ all -> 0x0086 }
            java.lang.Object r0 = r0.get(r12)     // Catch:{ all -> 0x0086 }
            com.amap.api.services.a.cw$c r0 = (com.amap.api.services.a.cw.c) r0     // Catch:{ all -> 0x0086 }
            r1 = 0
            if (r0 != 0) goto L_0x0014
            monitor-exit(r11)
            return r1
        L_0x0014:
            boolean r2 = r0.f6785d     // Catch:{ all -> 0x0086 }
        ...
        L_0x0034:
            ...
            boolean r1 = r11.i()     // Catch:{ all -> 0x0086 }
            if (r1 == 0) goto L_0x0061
            java.util.concurrent.ThreadPoolExecutor r1 = a()     // Catch:{ all -> 0x0086 }
            java.util.concurrent.Callable<java.lang.Void> r2 = r11.r     // Catch:{ all -> 0x0086 }
            r1.submit(r2)     // Catch:{ all -> 0x0086 }
        L_0x0061:
            com.amap.api.services.a.cw$b r1 = new com.amap.api.services.a.cw$b     // Catch:{ all -> 0x0086 }
            long r6 = r0.f6787f     // Catch:{ all -> 0x0086 }
            long[] r9 = r0.f6784c     // Catch:{ all -> 0x0086 }
            r10 = 0
            r3 = r1
            r4 = r11
            r5 = r12
        ...
        L_0x0074:
            ...
            r12 = r8[r2]     // Catch:{ all -> 0x0086 }
            com.amap.api.services.a.cz.a((java.io.Closeable) r12)     // Catch:{ all -> 0x0086 }
            int r2 = r2 + 1
            goto L_0x0074
        L_0x0084:
            monitor-exit(r11)
    ...
    private synchronized com.amap.api.services.a.cw.a a(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            r5 = this;
            monitor-enter(r5)
            r5.j()     // Catch:{ all -> 0x005e }
            r5.e((java.lang.String) r6)     // Catch:{ all -> 0x005e }
            java.util.LinkedHashMap<java.lang.String, com.amap.api.services.a.cw$c> r0 = r5.m     // Catch:{ all -> 0x005e }
            java.lang.Object r0 = r0.get(r6)     // Catch:{ all -> 0x005e }
            com.amap.api.services.a.cw$c r0 = (com.amap.api.services.a.cw.c) r0     // Catch:{ all -> 0x005e }
            r1 = -1
            r3 = 0
            int r4 = (r7 > r1 ? 1 : (r7 == r1 ? 0 : -1))
            if (r4 == 0) goto L_0x0022
            if (r0 == 0) goto L_0x0020
            long r1 = r0.f6787f     // Catch:{ all -> 0x005e }
        ...
        L_0x0022:
            ...
            com.amap.api.services.a.cw$c r0 = new com.amap.api.services.a.cw$c     // Catch:{ all -> 0x005e }
            r0.<init>(r6)     // Catch:{ all -> 0x005e }
            java.util.LinkedHashMap<java.lang.String, com.amap.api.services.a.cw$c> r7 = r5.m     // Catch:{ all -> 0x005e }
            r7.put(r6, r0)     // Catch:{ all -> 0x005e }
            goto L_0x0037
        L_0x002f:
            com.amap.api.services.a.cw$a r7 = r0.f6786e     // Catch:{ all -> 0x005e }
            if (r7 == 0) goto L_0x0037
            monitor-exit(r5)
            return r3
        L_0x0037:
            com.amap.api.services.a.cw$a r7 = new com.amap.api.services.a.cw$a     // Catch:{ all -> 0x005e }
            r7.<init>(r0)     // Catch:{ all -> 0x005e }
            com.amap.api.services.a.cw.a unused = r0.f6786e = r7     // Catch:{ all -> 0x005e }
    ...
    public synchronized void a(com.amap.api.services.a.cw.a r10, boolean r11) throws java.io.IOException {
        /*
            r9 = this;
            monitor-enter(r9)
            com.amap.api.services.a.cw$c r0 = r10.f6772b     // Catch:{ all -> 0x010a }
            com.amap.api.services.a.cw$a r1 = r0.f6786e     // Catch:{ all -> 0x010a }
            if (r1 != r10) goto L_0x0104
            r1 = 0
            if (r11 == 0) goto L_0x004a
            boolean r2 = r0.f6785d     // Catch:{ all -> 0x010a }
            if (r2 != 0) goto L_0x004a
            r2 = 0
        L_0x0015:
            int r3 = r9.i     // Catch:{ all -> 0x010a }
            if (r2 >= r3) goto L_0x004a
            boolean[] r3 = r10.f6773c     // Catch:{ all -> 0x010a }
        ...
        L_0x004a:
            ...
            long[] r10 = r0.f6784c     // Catch:{ all -> 0x010a }
        ...
        L_0x007f:
            ...
            r10 = 0
            com.amap.api.services.a.cw.a unused = r0.f6786e = r10     // Catch:{ all -> 0x010a }
            boolean r10 = r0.f6785d     // Catch:{ all -> 0x010a }
            r10 = r10 | r11
            r2 = 10
            if (r10 == 0) goto L_0x00c3
            boolean unused = r0.f6785d = r1     // Catch:{ all -> 0x010a }
            ...
            java.lang.String r3 = r0.f6783b     // Catch:{ all -> 0x010a }
            ...
            long unused = r0.f6787f = r10     // Catch:{ all -> 0x010a }
            goto L_0x00e6
        L_0x00c3:
            java.util.LinkedHashMap<java.lang.String, com.amap.api.services.a.cw$c> r10 = r9.m     // Catch:{ all -> 0x010a }
            java.lang.String r11 = r0.f6783b     // Catch:{ all -> 0x010a }
            r10.remove(r11)     // Catch:{ all -> 0x010a }
            java.io.Writer r10 = r9.k     // Catch:{ all -> 0x010a }
            java.lang.StringBuilder r11 = new java.lang.StringBuilder     // Catch:{ all -> 0x010a }
            java.lang.String r1 = "REMOVE "
            r11.<init>(r1)     // Catch:{ all -> 0x010a }
            java.lang.String r0 = r0.f6783b     // Catch:{ all -> 0x010a }
        ...
        L_0x00e6:
            ...
            boolean r10 = r9.i()     // Catch:{ all -> 0x010a }
            if (r10 == 0) goto L_0x0102
        L_0x00f9:
            java.util.concurrent.ThreadPoolExecutor r10 = a()     // Catch:{ all -> 0x010a }
    ...
    private cw(File file, int i2, int i3, long j2) {
        this.f6765c = file;
        this.g = i2;
        this.f6766d = new File(file, "journal");
        this.f6767e = new File(file, "journal.tmp");
        this.f6768f = new File(file, "journal.bkp");
        this.i = i3;
        this.h = j2;
    }
    ...
    public static cw a(File file, int i2, int i3, long j2) throws IOException {
        if (j2 <= 0) {
            ...
            if (cwVar.f6766d.exists()) {
                try {
                    cwVar.f();
                    cwVar.g();
                    cwVar.k = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(cwVar.f6766d, true), cz.f6794a));
                    return cwVar;
                } catch (Throwable unused) {
                    cwVar.d();
                }
