...
public final class a {
    ...
    public Activity f5541d;

    /* renamed from: com.alipay.sdk.k.a$a  reason: collision with other inner class name */
    public class C0042a extends AlertDialog {
        ...
        public final void onCreate(Bundle bundle) {
            ...
            layoutParams2.setMargins(a((Context) a.this.f5541d, 17.0f), a((Context) a.this.f5541d, 10.0f), a((Context) a.this.f5541d, 8.0f), a((Context) a.this.f5541d, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(a(context, a.f5538b));
            ...
            if (TextUtils.isEmpty(a.this.f5540c)) {
                str = "正在加载";
            } else {
                str = a.this.f5540c;
            }
        ...
        protected C0042a(Context context) {
            super(context);
        }
        ...
        private static android.graphics.drawable.Drawable a(android.content.Context r3, java.lang.String r4) {
            /*
                ...
                byte[] r4 = com.alipay.sdk.d.a.a((java.lang.String) r4)     // Catch:{ Throwable -> 0x003b, all -> 0x0033 }
            ...
            L_0x0041:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alipay.sdk.k.a.C0042a.a(android.content.Context, java.lang.String):android.graphics.drawable.Drawable");
        }
    }

    public final void a() {
        if (this.f5541d != null) {
            this.f5541d.runOnUiThread(new b(this));
        }
    }

    public final void b() {
        if (this.f5541d != null) {
            this.f5541d.runOnUiThread(new c(this));
        }
    }

    public a(Activity activity, String str) {
        this.f5541d = activity;
        this.f5540c = str;
    }
}
