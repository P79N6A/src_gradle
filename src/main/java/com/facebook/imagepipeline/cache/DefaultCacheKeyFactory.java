...
public class DefaultCacheKeyFactory implements CacheKeyFactory {
    ...
    public CacheKey getBitmapCacheKey(ImageRequest imageRequest, Object obj) {
        c cVar = new c(getCacheKeySourceUri(imageRequest.getSourceUri()).toString(), imageRequest.getResizeOptions(), imageRequest.getRotationOptions(), imageRequest.getImageDecodeOptions(), null, null, obj);
        return cVar;
    }
    ...
    public CacheKey getPostprocessedBitmapCacheKey(ImageRequest imageRequest, Object obj) {
        ...
        c cVar = new c(getCacheKeySourceUri(imageRequest.getSourceUri()).toString(), imageRequest.getResizeOptions(), imageRequest.getRotationOptions(), imageRequest.getImageDecodeOptions(), cacheKey, str, obj);
        return cVar;
    }
