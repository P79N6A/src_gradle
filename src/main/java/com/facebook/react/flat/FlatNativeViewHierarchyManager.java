...
public final class FlatNativeViewHierarchyManager extends NativeViewHierarchyManager implements ViewResolver {
    ...
    /* access modifiers changed from: package-private */
    public final void updateMountState(int i, @Nullable DrawCommand[] drawCommandArr, @Nullable AttachDetachListener[] attachDetachListenerArr, @Nullable NodeRegion[] nodeRegionArr) {
    ...
    /* access modifiers changed from: package-private */
    public final void updateClippingMountState(int i, @Nullable DrawCommand[] drawCommandArr, SparseIntArray sparseIntArray, float[] fArr, float[] fArr2, @Nullable AttachDetachListener[] attachDetachListenerArr, @Nullable NodeRegion[] nodeRegionArr, float[] fArr3, float[] fArr4, boolean z) {
