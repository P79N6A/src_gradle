...
public final class RCTViewManager extends FlatViewManager {
    ...
    public final void setHitSlop(FlatViewGroup flatViewGroup, @Nullable ReadableMap readableMap) {
        if (readableMap == null) {
    ...
    public final void receiveCommand(FlatViewGroup flatViewGroup, int i, @Nullable ReadableArray readableArray) {
        switch (i) {
            case 1:
