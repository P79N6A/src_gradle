...
public class JSTouchDispatcher {
    ...
    private void dispatchCancelEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        a.a(!this.mChildIsHandlingNativeGesture, "Expected to not have already sent a cancel for this gesture");
        ((EventDispatcher) a.b(eventDispatcher)).dispatchEvent(TouchEvent.obtain(this.mTargetTag, TouchEventType.CANCEL, motionEvent, this.mGestureStartTime, this.mTargetCoordinates[0], this.mTargetCoordinates[1], this.mTouchEventCoalescingKeyHelper));
    }
