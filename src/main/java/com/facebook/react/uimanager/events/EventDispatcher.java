...
public class EventDispatcher implements LifecycleEventListener {
    ...
    class ScheduleDispatchFrameCallback extends ChoreographerCompat.FrameCallback {
        ...
        public void doFrame(long j) {
            ...
            a.a("ScheduleDispatchFrameCallback");
            try {
    ...
    public void dispatchEvent(Event event) {
        com.facebook.infer.annotation.a.a(event.isInitialized(), "Dispatched event hasn't been initialized");
