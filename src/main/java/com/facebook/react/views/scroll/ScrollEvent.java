...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    private void init(int i, ScrollEventType scrollEventType, int i2, int i3, float f2, float f3, int i4, int i5, int i6, int i7) {
        super.init(i);
        this.mScrollEventType = scrollEventType;
        this.mScrollX = i2;
        this.mScrollY = i3;
        this.mXVelocity = (double) f2;
        this.mYVelocity = (double) f3;
    ...
    public static ScrollEvent obtain(int i, ScrollEventType scrollEventType, int i2, int i3, float f2, float f3, int i4, int i5, int i6, int i7) {
        ...
        scrollEvent.init(i, scrollEventType, i2, i3, f2, f3, i4, i5, i6, i7);
        return scrollEvent;
    }
}
