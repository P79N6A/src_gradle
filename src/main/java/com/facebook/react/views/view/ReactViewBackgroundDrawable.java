...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    public float getFullBorderWidth() {
        if (this.mBorderWidth == null || a.a(this.mBorderWidth.getRaw(8))) {
            return 0.0f;
        }
    ...
    public boolean hasRoundedBorders() {
        ...
        if (this.mBorderCornerRadii != null) {
            for (float f2 : this.mBorderCornerRadii) {
                if (!a.a(f2) && f2 > 0.0f) {
                    return true;
                }
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0072, code lost:
        if (com.facebook.yoga.a.a(r4) == false) goto L_0x0074;
     */
    ...
    private void updatePath() {
        ...
        if (this.mNeedUpdatePathForBorderRadius) {
            ...
            if (this.mBorderWidth != null) {
                f2 = this.mBorderWidth.get(8) / 2.0f;
            } else {
                f2 = 0.0f;
            }
            float f9 = borderRadiusOrDefaultTo + f2;
            float f10 = borderRadiusOrDefaultTo2 + f2;
            float f11 = f8 + f2;
            float f12 = f7 + f2;
    ...
    private int getBorderColor(int i) {
        ...
        if (this.mBorderRGB != null) {
            f2 = this.mBorderRGB.get(i);
        } else {
            f2 = 0.0f;
        }
        if (this.mBorderAlpha != null) {
            f3 = this.mBorderAlpha.get(i);
        } else {
            f3 = 255.0f;
        }
    ...
    private int getBorderWidth(int i) {
        ...
        float f2 = this.mBorderWidth.get(i);
        if (a.a(f2)) {
            return -1;
        }
    ...
    public void getOutline(Outline outline) {
        ...
        } else if ((a.a(this.mBorderRadius) || this.mBorderRadius <= 0.0f) && this.mBorderCornerRadii == null) {
    ...
    public float getBorderRadiusOrDefaultTo(float f2, BorderRadiusLocation borderRadiusLocation) {
        ...
        float f3 = this.mBorderCornerRadii[borderRadiusLocation.ordinal()];
        if (a.a(f3)) {
            return f2;
        }
        return f3;
