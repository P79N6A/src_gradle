...
public class ReactViewGroup extends ViewGroup implements ReactHitSlopView, ReactInterceptingViewGroup, ReactClippingViewGroup, ReactPointerEventsView, ReactZIndexedViewGroup {
    ...
    public View getChildAtWithSubviewClippingEnabled(int i) {
        return ((View[]) a.b(this.mAllChildren))[i];
    }
    ...
    private int indexOfChildInAllChildren(View view) {
        ...
        View[] viewArr = (View[]) a.b(this.mAllChildren);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:78:0x013b, code lost:
        if (com.facebook.yoga.a.a(r10) == false) goto L_0x010d;
     */
    ...
    private void dispatchOverflowDraw(android.graphics.Canvas r19) {
        ...
        L_0x00a3:
            ...
            boolean r11 = com.facebook.yoga.a.a(r7)
            if (r11 == 0) goto L_0x00dc
            goto L_0x00de
        L_0x00dc:
            r17 = r7
        L_0x00de:
            boolean r7 = com.facebook.yoga.a.a(r6)
            if (r7 == 0) goto L_0x00e5
            r6 = r12
        L_0x00e5:
            boolean r7 = com.facebook.yoga.a.a(r8)
            if (r7 == 0) goto L_0x00ec
            r8 = r13
        L_0x00ec:
            boolean r7 = com.facebook.yoga.a.a(r10)
        ...
        L_0x011d:
            ...
            r10 = r8
        L_0x0120:
            boolean r8 = com.facebook.yoga.a.a(r11)
            if (r8 != 0) goto L_0x0127
            goto L_0x0129
        L_0x0127:
            r11 = r17
        L_0x0129:
            boolean r8 = com.facebook.yoga.a.a(r6)
            if (r8 != 0) goto L_0x0130
            r12 = r6
        L_0x0130:
            boolean r6 = com.facebook.yoga.a.a(r7)
            if (r6 != 0) goto L_0x0137
            r13 = r7
        L_0x0137:
            boolean r6 = com.facebook.yoga.a.a(r10)
    ...
    public void setBorderRadius(float f2, int i) {
        int i2;
        ReactViewBackgroundDrawable orCreateReactViewBackground = getOrCreateReactViewBackground();
        orCreateReactViewBackground.setRadius(f2, i);
        if (11 < Build.VERSION.SDK_INT && Build.VERSION.SDK_INT < 18) {
            if (orCreateReactViewBackground.hasRoundedBorders()) {
                i2 = 1;
            } else {
    ...
    private void updateSubviewClipStatus(Rect rect, int i, int i2) {
        boolean z;
        View view = ((View[]) a.b(this.mAllChildren))[i];
        sHelperRect.set(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
