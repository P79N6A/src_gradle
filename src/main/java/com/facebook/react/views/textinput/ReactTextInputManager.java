...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    private static void checkPasswordType(ReactEditText reactEditText) {
        if ((reactEditText.getStagedInputType() & 12290) != 0 && (reactEditText.getStagedInputType() & SearchJediMixFeedAdapter.f42517f) != 0) {
            updateStagedInputTypeFlag(reactEditText, SearchJediMixFeedAdapter.f42517f, 16);
        }
    }
    ...
    public void setFontSize(ReactEditText reactEditText, float f2) {
        reactEditText.setTextSize(0, (float) ((int) Math.ceil((double) PixelUtil.toPixelFromSP(f2))));
    }
    ...
    public void setBorderColor(ReactEditText reactEditText, int i, Integer num) {
        ...
        reactEditText.setBorderColor(SPACING_TYPES[i], f2, f3);
    }
}
