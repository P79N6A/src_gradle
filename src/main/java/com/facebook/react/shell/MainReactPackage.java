...
public class MainReactPackage extends LazyReactPackage {
    ...
    public List<ModuleSpec> getNativeModules(final ReactApplicationContext reactApplicationContext) {
        return Arrays.asList(new ModuleSpec[]{ModuleSpec.nativeModuleSpec(AccessibilityInfoModule.class, new a<NativeModule>() {
            ...
            public NativeModule get() {
                ...
                if (MainReactPackage.this.mConfig != null) {
                    imagePipelineConfig = MainReactPackage.this.mConfig.getFrescoConfig();
                } else {
