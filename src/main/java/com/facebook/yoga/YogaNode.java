...
public class YogaNode implements Cloneable {
    ...
    private native void jni_YGNodeCalculateLayout(long j, float f2, float f3);
    ...
    private native void jni_YGNodeStyleSetAspectRatio(long j, float f2);

    private native void jni_YGNodeStyleSetBorder(long j, int i, float f2);

    private native void jni_YGNodeStyleSetDirection(long j, int i);

    private native void jni_YGNodeStyleSetDisplay(long j, int i);

    private native void jni_YGNodeStyleSetFlex(long j, float f2);

    private native void jni_YGNodeStyleSetFlexBasis(long j, float f2);

    private native void jni_YGNodeStyleSetFlexBasisAuto(long j);

    private native void jni_YGNodeStyleSetFlexBasisPercent(long j, float f2);

    private native void jni_YGNodeStyleSetFlexDirection(long j, int i);

    private native void jni_YGNodeStyleSetFlexGrow(long j, float f2);

    private native void jni_YGNodeStyleSetFlexShrink(long j, float f2);

    private native void jni_YGNodeStyleSetFlexWrap(long j, int i);

    private native void jni_YGNodeStyleSetHeight(long j, float f2);

    private native void jni_YGNodeStyleSetHeightAuto(long j);

    private native void jni_YGNodeStyleSetHeightPercent(long j, float f2);

    private native void jni_YGNodeStyleSetJustifyContent(long j, int i);

    private native void jni_YGNodeStyleSetMargin(long j, int i, float f2);

    private native void jni_YGNodeStyleSetMarginAuto(long j, int i);

    private native void jni_YGNodeStyleSetMarginPercent(long j, int i, float f2);

    private native void jni_YGNodeStyleSetMaxHeight(long j, float f2);

    private native void jni_YGNodeStyleSetMaxHeightPercent(long j, float f2);

    private native void jni_YGNodeStyleSetMaxWidth(long j, float f2);

    private native void jni_YGNodeStyleSetMaxWidthPercent(long j, float f2);

    private native void jni_YGNodeStyleSetMinHeight(long j, float f2);

    private native void jni_YGNodeStyleSetMinHeightPercent(long j, float f2);

    private native void jni_YGNodeStyleSetMinWidth(long j, float f2);

    private native void jni_YGNodeStyleSetMinWidthPercent(long j, float f2);

    private native void jni_YGNodeStyleSetOverflow(long j, int i);

    private native void jni_YGNodeStyleSetPadding(long j, int i, float f2);

    private native void jni_YGNodeStyleSetPaddingPercent(long j, int i, float f2);

    private native void jni_YGNodeStyleSetPosition(long j, int i, float f2);

    private native void jni_YGNodeStyleSetPositionPercent(long j, int i, float f2);

    private native void jni_YGNodeStyleSetPositionType(long j, int i);

    private native void jni_YGNodeStyleSetWidth(long j, float f2);

    private native void jni_YGNodeStyleSetWidthAuto(long j);

    private native void jni_YGNodeStyleSetWidthPercent(long j, float f2);
