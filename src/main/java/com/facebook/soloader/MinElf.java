        ...
        if (getu32(fileChannel2, allocate, 0) == 1179403647) {
            ...
            while (true) {
                if (j19 >= j2) {
                    j3 = 0;
                    break;
                } else if (getu32(fileChannel2, allocate, j18 + 0) != 2) {
                    j18 += (long) i;
                    j19++;
                } else if (z2) {
            ...
            if (j3 != 0) {
                ...
                while (true) {
                    ...
                    if (j4 == 1) {
                        ...
                        if (z) {
                            j5 = j3;
                            j15 = getu32(fileChannel2, allocate, j21 + 4);
                        } else {
                            j5 = j3;
                            j15 = get64(fileChannel2, allocate, j21 + 8);
                        }
                        j22 = j15;
                    } else {
                        j5 = j3;
                    ...
                    if (j4 != 0) {
                        ...
                        while (true) {
                            ...
                            if (getu32(fileChannel2, allocate, j + j20) == 1) {
                                if (z) {
                                    j12 = getu32(fileChannel2, allocate, j + 8);
                                } else {
                                    j12 = get64(fileChannel2, allocate, j + j23);
                                }
                                if (z) {
                                    j11 = j2;
                        ...
                        if (j7 != 0) {
                            ...
                            while (true) {
                                if (z) {
                                    j8 = getu32(fileChannel2, allocate, j5 + j24);
                                } else {
                                    j8 = get64(fileChannel2, allocate, j5 + j24);
                                }
                                if (j8 == 1) {
                                    if (z) {
                                        j10 = getu32(fileChannel2, allocate, j5 + 4);
                                    } else {
                                        j10 = get64(fileChannel2, allocate, j5 + 8);
                                    }
                                    strArr[i4] = getSz(fileChannel2, allocate, j10 + j7);
