...
public final class GlideBuilder {
    ...
    @NonNull
    public final GlideBuilder setArrayPool(@Nullable ArrayPool arrayPool2) {
        this.arrayPool = arrayPool2;
        return this;
    }

    @NonNull
    public final GlideBuilder setBitmapPool(@Nullable BitmapPool bitmapPool2) {
        this.bitmapPool = bitmapPool2;
        return this;
    }

    @NonNull
    public final GlideBuilder setConnectivityMonitorFactory(@Nullable ConnectivityMonitorFactory connectivityMonitorFactory2) {
    ...
    public final GlideBuilder setEngine(Engine engine2) {
        this.engine = engine2;
        return this;
    }
    ...
    @NonNull
    public final GlideBuilder setMemoryCache(@Nullable MemoryCache memoryCache2) {
        this.memoryCache = memoryCache2;
        return this;
    }

    @NonNull
    public final GlideBuilder setMemorySizeCalculator(@Nullable MemorySizeCalculator memorySizeCalculator2) {
        this.memorySizeCalculator = memorySizeCalculator2;
        return this;
    }

    /* access modifiers changed from: package-private */
    public final void setRequestManagerFactory(@Nullable RequestManagerRetriever.RequestManagerFactory requestManagerFactory2) {
    ...
    /* access modifiers changed from: package-private */
    @NonNull
    public final Glide build(@NonNull Context context) {
