...
public class ResourceExtractor {
    ...
    class ExtractTask extends AsyncTask<Void, Void, Void> {
                ...
                try {
                    for (String str2 : ResourceExtractor.this.mAssetsToExtract) {
                        ...
                        if (file.length() == 0) {
                            ...
                            extractResourceHelper(ContextUtils.getApplicationContext().getAssets().open(str2), file, bArr);
                    ...
                    try {
                        Log.w("cr.base", "Exception unpacking required pak asset: %s", e2.getMessage());
                        ResourceExtractor.this.deleteFiles();
                    } finally {
                        str = "WalkAssets";
                        TraceEvent.end(str);
        ...
        public void onPostExecute(Void voidR) {
            ...
            try {
                ...
                str = "ResourceExtractor.ExtractTask.onPostExecute";
                TraceEvent.end(str);
            }
        }
        ...
        private void extractResourceHelper(java.io.InputStream r6, java.io.File r7, byte[] r8) throws java.io.IOException {
            /*
                ...
                com.ttnet.org.chromium.base.Log.i(r0, r2, r3)     // Catch:{ all -> 0x0031 }
            L_0x0013:
            ...
            L_0x0047:
                throw r7
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.ResourceExtractor.ExtractTask.extractResourceHelper(java.io.InputStream, java.io.File, byte[]):void");
        }
    }
    ...
    private static String[] detectFilesToExtract() {
        ...
        for (String startsWith : BuildConfig.COMPRESSED_LOCALES) {
            if (startsWith.startsWith(updatedLanguageForChromium)) {
                arrayList.add(startsWith + ".pak");
            }
        }
