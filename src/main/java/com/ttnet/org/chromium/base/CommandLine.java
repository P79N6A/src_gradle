...
public abstract class CommandLine {
    ...
    private static void setInstance(CommandLine commandLine) {
        ...
        if (andSet != null && andSet.isNativeImplementation()) {
            nativeReset();
        }
    }
    ...
    private static char[] readUtf8FileFully(java.lang.String r6, int r7) {
        ...
        L_0x004e:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.CommandLine.readUtf8FileFully(java.lang.String, int):char[]");
    }
}
