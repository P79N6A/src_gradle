...
public class SysUtils {
    ...
    private static boolean detectLowEndDevice() {
        ...
        if (amountOfPhysicalMemoryKB <= 0 || amountOfPhysicalMemoryKB / 1024 > 512) {
            return false;
        }
        return true;
    }
    ...
    private static int amountOfPhysicalMemoryKB() {
        ...
        L_0x0053:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.SysUtils.amountOfPhysicalMemoryKB():int");
    }
