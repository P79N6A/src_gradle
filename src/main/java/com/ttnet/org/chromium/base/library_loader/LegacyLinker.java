...
public class LegacyLinker extends Linker {
    ...
    public void finishLibraryLoad() {
        ...
        L_0x004f:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.library_loader.LegacyLinker.finishLibraryLoad():void");
    }
        ...
        if (bundle != null && this.mLoadedLibraries != null) {
            ...
            for (Map.Entry entry : createLibInfoMapFromBundle.entrySet()) {
                ...
                if (!nativeUseSharedRelro(str, (Linker.LibInfo) entry.getValue())) {
                    Log.w("LibraryLoader", "Could not use shared RELRO section for " + str, new Object[0]);
                }
            }
            if (!this.mInBrowserProcess) {
            ...
            if (!this.mLoadedLibraries.containsKey(str5)) {
                ...
                if (!z || ((!this.mInBrowserProcess || !this.mBrowserUsesSharedRelro) && !this.mWaitForSharedRelros)) {
                    ...
                    if (j > this.mBaseLoadAddress + 201326592) {
                        String str6 = "Load address outside reservation, for: " + str5;
                ...
                if (str4 != null) {
                    if (!nativeLoadLibraryInZipFile(str4, str5, j, libInfo)) {
                        String str7 = "Unable to load library: " + str5 + ", in: " + str4;
                    ...
                    String str8 = "Unable to load library: " + str5;
                ...
                if (NativeLibraries.sEnableLinkerTests) {
                    ...
                    Log.i("LibraryLoader", String.format(Locale.US, "%s: %s %x", new Object[]{str3, str5, Long.valueOf(libInfo.mLoadAddress)}), new Object[0]);
                }
                if (this.mInBrowserProcess && !nativeCreateSharedRelro(str4, this.mCurrentLoadAddress, libInfo)) {
                    Log.w("LibraryLoader", String.format(Locale.US, "Could not create shared RELRO for %s at %x", new Object[]{str5, Long.valueOf(this.mCurrentLoadAddress)}), new Object[0]);
                }
