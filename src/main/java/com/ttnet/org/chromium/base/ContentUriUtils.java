...
public abstract class ContentUriUtils {
    ...
    private static android.content.res.AssetFileDescriptor getAssetFileDescriptor(android.content.Context r8, java.lang.String r9) {
        ...
        L_0x004a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base.ContentUriUtils.getAssetFileDescriptor(android.content.Context, java.lang.String):android.content.res.AssetFileDescriptor");
    }
                ...
                try {
                    if (cursor.getCount() > 0) {
                        ...
                        if (hasVirtualFlag(cursor)) {
                            ...
                            if (streamTypes != null && streamTypes.length > 0) {
                                if (MimeTypeMap.getSingleton().getExtensionFromMimeType(streamTypes[0]) != null) {
                                    string = string + ClassUtils.PACKAGE_SEPARATOR + r7;
                                }
                            }
                        }
                        StreamUtil.closeQuietly(cursor);
