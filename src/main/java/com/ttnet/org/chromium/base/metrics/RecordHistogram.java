...
public class RecordHistogram {
    ...
    public static void recordCount1000Histogram(String str, int i) {
        recordCustomCountHistogram(str, i, 1, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE, 50);
    }
    ...
    public static void recordMemoryKBHistogram(String str, int i) {
        recordCustomCountHistogram(str, i, PushConstants.PUSHSERVICE_INFO_SENDMESSAGE_BY_NOTIFICATIONSERVICE, 500000, 50);
    }
    ...
    public static void recordPercentageHistogram(String str, int i) {
        if (!sIsDisabledForTests) {
            long cachedHistogramKey = getCachedHistogramKey(str);
            long nativeRecordEnumeratedHistogram = nativeRecordEnumeratedHistogram(str, cachedHistogramKey, i, BaseLoginOrRegisterActivity.o);
