...
public final class CronetWebsocketConnection extends TTWebsocketConnection {
            ...
            try {
                ...
                if (this.mParams != null) {
                    for (Map.Entry next : this.mParams.entrySet()) {
                        nativeAddGetParam(this.mWebsocketAdapter, (String) next.getKey(), (String) next.getValue());
                    }
                }
                if (this.mHeaders != null) {
                    for (Map.Entry next2 : this.mHeaders.entrySet()) {
                        nativeAddHeader(this.mWebsocketAdapter, (String) next2.getKey(), (String) next2.getValue());
                    }
                }
    ...
    private void onConnectionStateChanged(final int i, final String str) {
        String str2 = TAG;
        Log.v(str2, "onConnectionStateChanged: state = " + i + ", url = " + str);
        this.mState.set(i);
        postTaskToExecutor(new Runnable() {
            public void run() {
                try {
    ...
    private void onConnectionError(final int i, final String str, final String str2) {
        String str3 = TAG;
        Log.e(str3, "onConnectionError: " + str2, new Object[0]);
        this.mState.set(i);
        postTaskToExecutor(new Runnable() {
            public void run() {
                try {
