...
public final class JavaUrlRequest extends UrlRequestBase {
    ...
    final class AsyncUrlRequestCallback {
        ...
        public final void execute(CheckedRunnable checkedRunnable) {
            try {
                ...
                JavaUrlRequest.this.enterErrorState(new CronetExceptionImpl("Exception posting task to executor", e2));
            }
        }
        ...
        /* access modifiers changed from: package-private */
        public final void sendStatus(final VersionSafeCallbacks.UrlRequestStatusListener urlRequestStatusListener, final int i) {
            this.mUserExecutor.execute(new Runnable() {
                public void run() {
    ...
    final class OutputStreamDataSink extends UploadDataSink {
        ...
        public final void executeOnUploadExecutor(CheckedRunnable checkedRunnable) {
            try {
                ...
                JavaUrlRequest.this.enterUploadErrorState(e2);
            }
        }
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            synchronized (SeriaizingExecutor.this.mTaskQueue) {
                                ...
                                peekFirst = SeriaizingExecutor.this.mTaskQueue.peekFirst();
                            }
                            if (peekFirst != null) {
                                SeriaizingExecutor.this.runTask(peekFirst);
                            }
                        } catch (Throwable th) {
                            synchronized (SeriaizingExecutor.this.mTaskQueue) {
                                SeriaizingExecutor.this.mTaskQueue.removeFirst();
                                Runnable peekFirst2 = SeriaizingExecutor.this.mTaskQueue.peekFirst();
                                if (peekFirst2 != null) {
                                    SeriaizingExecutor.this.runTask(peekFirst2);
                                }
                                throw th;
                            }
                        }
        ...
        this.mExecutor.execute(errorSetting(new CheckedRunnable() {
            public void run() throws Exception {
                if (JavaUrlRequest.this.mState.get() != State.CANCELLED) {
                    ...
                    HttpURLConnection andSet = JavaUrlRequest.this.mCurrentUrlConnection.getAndSet(httpURLConnection);
                    if (andSet != null) {
                        andSet.disconnect();
                    }
                    boolean z = false;
                    ...
                    for (Map.Entry next : JavaUrlRequest.this.mRequestHeaders.entrySet()) {
    ...
    private void fireDisconnect() {
        final HttpURLConnection andSet = this.mCurrentUrlConnection.getAndSet(null);
        if (andSet != null) {
    ...
    public final void fireGetHeaders() {
        ...
        this.mExecutor.execute(errorSetting(new CheckedRunnable() {
            public void run() throws Exception {
                HttpURLConnection httpURLConnection = JavaUrlRequest.this.mCurrentUrlConnection.get();
