...
public class bu {
    ...
    public static byte[] a(byte[] r5) throws java.io.IOException {
        ...
        L_0x001e:
            ...
            int r4 = f80538a     // Catch:{ all -> 0x003c }
            int r4 = r4 + r0
            f80538a = r4     // Catch:{ all -> 0x003c }
        ...
        L_0x0046:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.umeng.analytics.pro.bu.a(byte[]):byte[]");
    }
