...
public class an extends y {
    ...
    private Context f80369b;

    /* renamed from: c  reason: collision with root package name */
    private String f80370c;
    ...
    public String f() {
        try {
            if (!TextUtils.isEmpty(a("ro.yunos.version", "")) && this.f80369b != null) {
                SharedPreferences a2 = ba.a(this.f80369b);
                if (a2 != null) {
                    String string = a2.getString("yosuid", "");
                    if (!TextUtils.isEmpty(string)) {
                        return string;
                    }
                    this.f80371d = b("23346339");
                    if (!(TextUtils.isEmpty(this.f80371d) || this.f80369b == null || a2 == null)) {
                        SharedPreferences.Editor edit = a2.edit();
                        if (edit != null) {
                            edit.putString("yosuid", this.f80371d).commit();
                        }
                    }
                    return this.f80371d;
                }
    ...
    private java.lang.String b(java.lang.String r7) {
        /*
            ...
            r6.f80371d = r7
            java.lang.String r7 = r6.f80371d
        ...
        L_0x0015:
            ...
            java.lang.String r7 = a(r7, r0)
            r6.f80370c = r7
            java.lang.String r7 = r6.f80370c
            boolean r7 = android.text.TextUtils.isEmpty(r7)
        ...
        L_0x0031:
            ...
            com.umeng.analytics.pro.an$1 r1 = new com.umeng.analytics.pro.an$1     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
        ...
        L_0x00c8:
            ...
            r6.f80371d = r7     // Catch:{ Exception -> 0x00ce, all -> 0x00d0 }
        L_0x00ce:
            r7 = r1
            goto L_0x00e2
        L_0x00d0:
