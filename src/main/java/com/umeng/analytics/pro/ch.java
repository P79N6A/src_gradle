...
public final class ch {
    ...
    private static final Comparator f80578a = new a();
    ...
    static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return ch.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return ch.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return ch.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return ch.a((byte[]) obj, (byte[]) obj2);
            }
            return ch.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int a(Set set, Set set2) {
        ...
        TreeSet treeSet = new TreeSet(f80578a);
        treeSet.addAll(set);
        TreeSet treeSet2 = new TreeSet(f80578a);
        treeSet2.addAll(set2);
        Iterator it2 = treeSet.iterator();
        Iterator it3 = treeSet2.iterator();
        while (it2.hasNext() && it3.hasNext()) {
            int compare = f80578a.compare(it2.next(), it3.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int compare = f80578a.compare(list.get(i), list2.get(i));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        TreeMap treeMap = new TreeMap(f80578a);
        treeMap.putAll(map);
        Iterator it2 = treeMap.entrySet().iterator();
        TreeMap treeMap2 = new TreeMap(f80578a);
        treeMap2.putAll(map2);
        Iterator it3 = treeMap2.entrySet().iterator();
        while (it2.hasNext() && it3.hasNext()) {
            Map.Entry entry = (Map.Entry) it2.next();
            Map.Entry entry2 = (Map.Entry) it3.next();
            int compare = f80578a.compare(entry.getKey(), entry2.getKey());
            if (compare != 0) {
                return compare;
            }
            int compare2 = f80578a.compare(entry.getValue(), entry2.getValue());
            if (compare2 != 0) {
                return compare2;
            }
        }
