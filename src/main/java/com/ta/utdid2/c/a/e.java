...
public class e {
    ...
    public static final int[] m22a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                if (name.equals("float")) {
                    d2 = new Float(xmlPullParser.getAttributeValue(null, "value"));
                } else if (name.equals("double")) {
                    d2 = new Double(xmlPullParser.getAttributeValue(null, "value"));
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final HashMap m21a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
