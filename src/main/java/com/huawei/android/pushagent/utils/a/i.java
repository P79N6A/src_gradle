...
public class i implements X509TrustManager {
    ...
    public i(android.content.Context r6) throws java.lang.Exception {
        /*
            ...
            java.lang.String r3 = com.huawei.android.pushagent.utils.a.d.b()     // Catch:{ all -> 0x0059 }
            java.lang.String r0 = com.huawei.android.pushagent.utils.a.a.f.b((android.content.Context) r0, (java.lang.String) r3)     // Catch:{ all -> 0x0059 }
        ...
        L_0x0034:
            ...
            r5.f25173a = r0     // Catch:{ all -> 0x0059 }
        ...
        L_0x0064:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.android.pushagent.utils.a.i.<init>(android.content.Context):void");
    }

    public void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        e.a("PushLogSC2815", "check ClientTrusted");
        this.f25173a.checkClientTrusted(x509CertificateArr, str);
    }

    public void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        e.a("PushLogSC2815", "check ServerTrusted");
        this.f25173a.checkServerTrusted(x509CertificateArr, str);
    }

    public X509Certificate[] getAcceptedIssuers() {
        return this.f25173a.getAcceptedIssuers();
    }
}
