...
public class a implements Serializable {
    ...
    private boolean a(JSONObject jSONObject) {
        try {
            ...
            if (jSONObject2.has("autoClear")) {
                this.f25206f = jSONObject2.getInt("autoClear");
            } else {
                this.f25206f = 0;
            }
            if (!PushConstants.EXTRA_APPLICATION_PENDING_INTENT.equals(this.p)) {
                if (!"cosa".equals(this.p)) {
                    ...
                    } else if (PushConstants.WEB_URL.equals(this.p)) {
                        if (jSONObject2.has(PushConstants.WEB_URL)) {
                            this.C = jSONObject2.getString(PushConstants.WEB_URL);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0127, code lost:
        com.huawei.android.pushagent.utils.a.e.a(r8, r1);
     */
    ...
    private boolean b(org.json.JSONObject r8) {
        /*
            ...
            com.huawei.android.pushagent.utils.a.e.a(r1, r2)     // Catch:{ JSONException -> 0x01ad }
        ...
        L_0x00f8:
            int[] r2 = com.huawei.android.pushselfshow.b.a.AnonymousClass1.f25207a     // Catch:{ JSONException -> 0x01ad }
        ...
        L_0x0127:
            com.huawei.android.pushagent.utils.a.e.a(r8, r1)     // Catch:{ JSONException -> 0x01ad }
            goto L_0x01aa
        L_0x012c:
        ...
        L_0x01ad:
            ...
            com.huawei.android.pushagent.utils.a.e.b(r1, r8)
            return r0
        */
    ...
    public String a() {
        e.a("PushSelfShowLog", "msgId =" + this.m);
        return this.m;
    }
    ...
    public boolean b() {
        ...
        L_0x0021:
            ...
            com.huawei.android.pushagent.utils.a.e.a(r1, r2)     // Catch:{ Exception -> 0x01c1 }
            return r0
        L_0x003d:
            ...
            r7.f25201a = r2     // Catch:{ Exception -> 0x01c1 }
            ...
            java.lang.String r5 = r7.f25201a     // Catch:{ Exception -> 0x01c1 }
            r4.append(r5)     // Catch:{ Exception -> 0x01c1 }
            java.lang.String r4 = r4.toString()     // Catch:{ Exception -> 0x01c1 }
            com.huawei.android.pushagent.utils.a.e.a(r2, r4)     // Catch:{ Exception -> 0x01c1 }
        L_0x0062:
            ...
            com.huawei.android.pushagent.utils.a.e.b(r1, r2)     // Catch:{ Exception -> 0x01c1 }
            return r0
        L_0x0072:
    ...
    public byte[] c() {
        ...
        try {
            ...
            jSONObject4.put("autoClear", this.f25206f);
            jSONObject4.put(NotifyType.SOUND, this.f25202b);
            jSONObject4.put("r", this.f25203c);
            jSONObject4.put("smsC", this.f25204d);
            jSONObject4.put("mmsUrl", this.f25205e);
            jSONObject4.put(PushConstants.WEB_URL, this.C);
            ...
            jSONObject3.put(PushConstants.CONTENT, this.q);
            ...
            jSONObject.put("group", this.f25201a);
