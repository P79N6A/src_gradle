...
public class ConfigManager {
    ...
    public static final Version SDK_VERSION = new Version(1, 2, 6);

    /* renamed from: a  reason: collision with root package name */
    private static final ConfigManager f4905a = new ConfigManager();
    ...
    public void init(int i) {
        String str;
        this.f4906b = Environment.values()[i];
        ...
        if (POSTFIX_OF_SECURITY_JPG_USER_SET == null) {
            ...
            str = POSTFIX_OF_SECURITY_JPG_USER_SET;
        }
