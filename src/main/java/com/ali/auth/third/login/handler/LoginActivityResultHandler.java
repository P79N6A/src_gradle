...
public class LoginActivityResultHandler extends BaseActivityResultHandler {
    ...
    public void a(Activity activity, String str, LoginCallback loginCallback) {
        ...
        if (loginCallback != null) {
            loginCallback.onSuccess(a.f5012b.getSession());
    ...
    private void a(Intent intent, LoginCallback loginCallback) {
        ...
        if (weakReference == null || weakReference.get() == null || intent == null) {
            KernelContext.executorService.postUITask(new d(this, weakReference, loginCallback));
            return;
        }
        new LoginByIVTokenTask((Activity) weakReference.get(), new a(this, weakReference, loginCallback)).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[]{intent.getStringExtra("token"), intent.getStringExtra("scene"), intent.getStringExtra("aliusersdk_h5querystring")});
    }
    ...
    public void onCallbackContext(int i, int i2, Intent intent, Activity activity, Map<Class<?>, Object> map, WebView webView) {
        ...
        if (i == RequestCode.OPEN_H5_LOGIN && loginCallback != null) {
            if (i2 == ResultCode.SUCCESS.code) {
                ...
                if (i2 != ResultCode.IGNORE.code) {
                    if (i2 != ResultCode.CHECK.code) {
                        a(activity, "E_H5_CANCEL_FAILURE", loginCallback, 10003);
                    }
                }
                return;
            }
            ...
            if (i2 != -1 || intent == null) {
                if (i2 == 0) {
                    a(activity, "E_TB_LOGIN_CANCEL", loginCallback, 10004);
                } else {
                    ...
                    a(activity, "E_TB_LOGIN_FAILURE", loginCallback, 10005);
                }
            }
        ...
        if (i == RequestCode.OPEN_H5_LOGIN) {
            ...
            if (i == RequestCode.OPEN_H5_UNBIND) {
                if (i2 == ResultCode.SUCCESS.code) {
                    ...
                    a((Activity) baseWebViewActivity, "E_H5_UNBIND_FAILURE", loginCallback, 10003);
                }
                CallbackContext.loginCallback = null;
            }
            return;
