        ...
        static class Proxy implements ParcelableNetworkListener {
            ...
            public byte getListenerState() throws RemoteException {
                ...
                try {
                    ...
                    this.f1480a.transact(5, obtain, obtain2, 0);
            ...
            public void onDataReceived(DefaultProgressEvent defaultProgressEvent) throws RemoteException {
                ...
                try {
                    ...
                    this.f1480a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onFinished(DefaultFinishEvent defaultFinishEvent) throws RemoteException {
                ...
                try {
                    ...
                    this.f1480a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onInputStreamGet(ParcelableInputStream parcelableInputStream) throws RemoteException {
                ...
                try {
                    ...
                    this.f1480a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public boolean onResponseCode(int i, ParcelableHeader parcelableHeader) throws RemoteException {
                ...
                try {
                    ...
                    this.f1480a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
