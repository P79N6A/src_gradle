...
public class ParcelableInputStreamImpl extends ParcelableInputStream.Stub {
    ...
    public void close() throws RemoteException {
        if (this.isClosed.compareAndSet(false, true)) {
            this.lock.lock();
            try {
                Iterator it2 = this.byteList.iterator();
                while (it2.hasNext()) {
                    ByteArray byteArray = (ByteArray) it2.next();
                    if (byteArray != EOS) {
                        byteArray.recycle();
                    }
                }
    ...
    public void init(g gVar, int i) {
        ...
        this.seqNo = gVar.f1551e;
        this.rto = gVar.f1550d;
    }
    ...
    public int readBytes(byte[] r6, int r7, int r8) throws android.os.RemoteException {
        ...
        L_0x0018:
            ...
            int r1 = r5.blockIndex     // Catch:{ InterruptedException -> 0x007f }
            java.util.LinkedList<anet.channel.bytes.ByteArray> r2 = r5.byteList     // Catch:{ InterruptedException -> 0x007f }
            int r2 = r2.size()     // Catch:{ InterruptedException -> 0x007f }
            if (r1 != r2) goto L_0x003d
            java.util.concurrent.locks.Condition r1 = r5.newDataArrive     // Catch:{ InterruptedException -> 0x007f }
            int r2 = r5.rto     // Catch:{ InterruptedException -> 0x007f }
            long r2 = (long) r2     // Catch:{ InterruptedException -> 0x007f }
            java.util.concurrent.TimeUnit r4 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ InterruptedException -> 0x007f }
            boolean r1 = r1.await(r2, r4)     // Catch:{ InterruptedException -> 0x007f }
            if (r1 == 0) goto L_0x0032
            goto L_0x003d
        L_0x0032:
            r5.close()     // Catch:{ InterruptedException -> 0x007f }
            java.lang.RuntimeException r6 = new java.lang.RuntimeException     // Catch:{ InterruptedException -> 0x007f }
            java.lang.String r7 = "await timeout."
            r6.<init>(r7)     // Catch:{ InterruptedException -> 0x007f }
            throw r6     // Catch:{ InterruptedException -> 0x007f }
        L_0x003d:
            java.util.LinkedList<anet.channel.bytes.ByteArray> r1 = r5.byteList     // Catch:{ InterruptedException -> 0x007f }
            int r2 = r5.blockIndex     // Catch:{ InterruptedException -> 0x007f }
            java.lang.Object r1 = r1.get(r2)     // Catch:{ InterruptedException -> 0x007f }
            anet.channel.bytes.ByteArray r1 = (anet.channel.bytes.ByteArray) r1     // Catch:{ InterruptedException -> 0x007f }
            anet.channel.bytes.ByteArray r2 = EOS     // Catch:{ InterruptedException -> 0x007f }
            if (r1 == r2) goto L_0x0090
            int r2 = r1.getDataLength()     // Catch:{ InterruptedException -> 0x007f }
            int r3 = r5.blockOffset     // Catch:{ InterruptedException -> 0x007f }
            int r2 = r2 - r3
            int r3 = r8 - r0
            if (r2 >= r3) goto L_0x006d
            byte[] r1 = r1.getBuffer()     // Catch:{ InterruptedException -> 0x007f }
            int r3 = r5.blockOffset     // Catch:{ InterruptedException -> 0x007f }
            java.lang.System.arraycopy(r1, r3, r6, r0, r2)     // Catch:{ InterruptedException -> 0x007f }
            int r0 = r0 + r2
            r5.recycleCurrentItem()     // Catch:{ InterruptedException -> 0x007f }
            int r1 = r5.blockIndex     // Catch:{ InterruptedException -> 0x007f }
            int r1 = r1 + 1
            r5.blockIndex = r1     // Catch:{ InterruptedException -> 0x007f }
            r1 = 0
            r5.blockOffset = r1     // Catch:{ InterruptedException -> 0x007f }
            goto L_0x0018
        L_0x006d:
            byte[] r1 = r1.getBuffer()     // Catch:{ InterruptedException -> 0x007f }
            int r2 = r5.blockOffset     // Catch:{ InterruptedException -> 0x007f }
            java.lang.System.arraycopy(r1, r2, r6, r0, r3)     // Catch:{ InterruptedException -> 0x007f }
            int r1 = r5.blockOffset     // Catch:{ InterruptedException -> 0x007f }
            int r1 = r1 + r3
            r5.blockOffset = r1     // Catch:{ InterruptedException -> 0x007f }
            int r0 = r0 + r3
            goto L_0x0018
