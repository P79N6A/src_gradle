...
public final class CacheInterceptor implements Interceptor {
    ...
    private static Headers combine(Headers headers, Headers headers2) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(name) || !value.startsWith(PushConstants.PUSH_TYPE_THROUGH_MESSAGE)) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
